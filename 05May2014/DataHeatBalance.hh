...
namespace DataHeatBalance {
	...
	struct ZoneMassConservationData
	{
		...
		ZoneMassConservationData() :
			...
			ZoneMixingSourcesPtr( 0 ),
			ZoneMixingReceivingPtr( 0 ),
			ZoneMixingReceivingFr( 0.0 ),
		...
		ZoneMassConservationData(
			Fstring const & Name,
			int const ZonePtr,
			Real64 InMassFlowRate,
			Real64 ExhMassFlowRate,
			Real64 RetMassFlowRate,
			Real64 MixingMassFlowRate,
			Real64 MixingSourceMassFlowRate,
			int NumSourceZonesMixingObject,
			int NumReceivingZonesMixingObject,
			FArray1D_int ZoneMixingSourcesPtr,
			FArray1D_int ZoneMixingReceivingPtr,
			FArray1D< Real64 > ZoneMixingReceivingFr,
			bool IsOnlySourceZone,
			int InfiltrationPtr,
			Real64 InfiltrationMassFlowRate,
			int IncludeInfilToZoneMassBal
			) :
			Name( MaxNameLength, Name ),
			ZonePtr( ZonePtr ),
