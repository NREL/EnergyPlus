...
\caption{Built-in Math Functions for Erl \protect \label{table:built-in-math-functions-for-erl}}\\
\toprule 
...
\caption{Built-in Psychrometric Functions for Erl \protect \label{table:built-in-psychrometric-functions-for-erl}}\\
\toprule 
Function Name & Arguments & Description & Units \tabularnewline \midrule
\endhead
