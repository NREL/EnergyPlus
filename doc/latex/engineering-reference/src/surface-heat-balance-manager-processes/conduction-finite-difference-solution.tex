...
\begin{equation}
{QDreport_{i} = QDreport_{i+1}+HeatCap1_{i+1}* \frac{\left(T_{i+1,new}-T_{i+1,old}\right)}{\Delta t}-QSource_{i}+HeatCap2_{i}* \frac{\left(T_{i,new}-T_{i,old}\right)}{\Delta t}}
\end{equation}
