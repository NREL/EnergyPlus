...
\item
  HVAC,Average,Cooling Coil Wetted Area Fraction \protect\hyperlink{section-1}{}
\item
...
\paragraph{\texorpdfstring{Cooling Coil Wetted Area Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Wetted Area Fraction }}\label{cooling-coil-wetted-area-fraction}
...
\item
  HVAC,Sum,Heating Coil Electric Consumption {[}J{]}
\item
  HVAC,Average,Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Heating Coil Air Heating Rate {[}W{]}
\item
  HVAC,Sum,Heating Coil Air Heating Energy {[}J{]}
...
\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction}
...
\item
  HVAC,Average, Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction}
...
\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-1}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-1}
...
\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-2}
...
\paragraph{Field: Gas Burner Efficiency}\label{field-gas-burner-efficiency}
...
\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-3}
...
\begin{itemize}
\item
  HVAC,Average,Cooling Coil Stage 2 Runtime Fraction \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Cooling Coil Dehumidification Mode \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-2}
...
\paragraph{\texorpdfstring{Cooling Coil Stage 2 Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Stage 2 Runtime Fraction }}\label{cooling-coil-stage-2-runtime-fraction}
...
\paragraph{\texorpdfstring{Cooling Coil Dehumidification Mode \protect\hyperlink{section-1}{}}{Cooling Coil Dehumidification Mode }}\label{cooling-coil-dehumidification-mode}
...
\begin{array}{l}{\rm{Gross RatedCapacity}}@{\rm{SpeedLevel}}\left( {\rm{x}} \right) = \\\quad \quad \quad {\rm{CapacityScaleFactor}} \times \\\quad \quad \quad {\rm{ReferenceUnitCapacity}}@{\rm{SpeedLevel}}({\rm{x}})\end{array}
...
\begin{array}{l}{\rm{LoopVolumetricAirFlowRate}}@{\rm{SpeedLevel}}\left( {\rm{x}} \right) = \\\quad \quad \quad {\rm{AirFlowScaleFactor}} \times \\\quad \quad \quad {\rm{ReferenceUnitVolAirFlowRate}}@{\rm{SpeedLevel}}({\rm{x}}) \times \\\quad \quad \quad {\rm{CapacityScaleFactor}}\end{array}
...
\item
  HVAC,Average,Cooling Coil Part Load Ratio \protect\hyperlink{section-1}{}
\item
  HVAC,Average, Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}
\item
...
\item
  HVAC,Average,Cooling Coil Upper Speed Level \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Cooling Coil Neighboring Speed Levels Ratio \protect\hyperlink{section-1}{}
\item
...
\paragraph{\texorpdfstring{Cooling Coil Part Load Ratio \protect\hyperlink{section-1}{}}{Cooling Coil Part Load Ratio }}\label{cooling-coil-part-load-ratio}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-3}
...
\paragraph{\texorpdfstring{Cooling Coil Upper Speed Level \protect\hyperlink{section-1}{}}{Cooling Coil Upper Speed Level }}\label{cooling-coil-upper-speed-level}

The output variable is the average upper speed level, for interpolating performances between two neighboring speed levels.

\paragraph{\texorpdfstring{Cooling Coil Neighboring Speed Levels Ratio \protect\hyperlink{section-1}{}}{Cooling Coil Neighboring Speed Levels Ratio }}\label{cooling-coil-neighboring-speed-levels-ratio}
...
\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-4}
...
\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-5}
...
\paragraph{\texorpdfstring{\(\begin{array}{l}{\rm{LoopVolumetricAirFlowRate}}@{\rm{SpeedLevel}}\left( {\rm{x}} \right) = \\\quad \quad \quad {\rm{AirFlowScaleFactor}} \times \\\quad \quad \quad {\rm{ReferenceUnitVolAirFlowRate}}@{\rm{SpeedLevel}}({\rm{x}}) \times \\\quad {\kern 1pt} {\kern 1pt} \quad \quad {\rm{CapacityScaleFactor}}\end{array}\)}{\textbackslash{}begin\{array\}\{l\}\{\textbackslash{}rm\{LoopVolumetricAirFlowRate\}\}@\{\textbackslash{}rm\{SpeedLevel\}\}\textbackslash{}left( \{\textbackslash{}rm\{x\}\} \textbackslash{}right) = \textbackslash{}\textbackslash{}\textbackslash{}quad \textbackslash{}quad \textbackslash{}quad \{\textbackslash{}rm\{AirFlowScaleFactor\}\} \textbackslash{}times \textbackslash{}\textbackslash{}\textbackslash{}quad \textbackslash{}quad \textbackslash{}quad \{\textbackslash{}rm\{ReferenceUnitVolAirFlowRate\}\}@\{\textbackslash{}rm\{SpeedLevel\}\}(\{\textbackslash{}rm\{x\}\}) \textbackslash{}times \textbackslash{}\textbackslash{}\textbackslash{}quad \{\textbackslash{}kern 1pt\} \{\textbackslash{}kern 1pt\} \textbackslash{}quad \textbackslash{}quad \{\textbackslash{}rm\{CapacityScaleFactor\}\}\textbackslash{}end\{array\}}}\label{beginarraylrmloopvolumetricairflowratermspeedlevelleft-rmx-right-quad-quad-quad-rmairflowscalefactor-times-quad-quad-quad-rmreferenceunitvolairflowratermspeedlevelrmx-times-quad-kern-1pt-kern-1pt-quad-quad-rmcapacityscalefactorendarray}
...
\item
  HVAC,Average,Heating Coil Part Load Ratio \protect\hyperlink{section-1}{}
\item
  HVAC,Average, Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}
\item
...
\item
  HVAC,Average,Heating Coil Upper Speed Level \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Heating Coil Neighboring Speed Levels Ratio \protect\hyperlink{section-1}{}
\item
  HVAC,Average,VSAirtoAirHP Recoverable Waste Heat {[}W{]}
\item
  HVAC,Sum,Heating Coil Electric Energy {[}J{]}
...
\paragraph{\texorpdfstring{Heating Coil Part Load Ratio \protect\hyperlink{section-1}{}}{Heating Coil Part Load Ratio }}\label{heating-coil-part-load-ratio}
...
\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-6}
...
\paragraph{\texorpdfstring{Heating Coil Upper Speed Level \protect\hyperlink{section-1}{}}{Heating Coil Upper Speed Level }}\label{heating-coil-upper-speed-level}

The output variable is the average upper speed level, for interpolating performances between two neighboring speed levels.

\paragraph{\texorpdfstring{Heating Coil Neighboring Speed Levels Ratio \protect\hyperlink{section-1}{}}{Heating Coil Neighboring Speed Levels Ratio }}\label{heating-coil-neighboring-speed-levels-ratio}
...
\item
  HVAC,Average,Water Heater Heat Reclaim Efficiency Modifier Multiplier \protect\hyperlink{section-1}{}
\item
...
Water Heater Part Load Ratio \protect\hyperlink{section-1}{}This output field contains the part load ratio of the desuperheater heating coil for the timestep being reported. This ratio represents the fraction of the timestep that the desuperheater heating coil is operating.
...
\paragraph{\texorpdfstring{Water Heater Heat Reclaim Efficiency Modifier Multiplier \protect\hyperlink{section-1}{}}{Water Heater Heat Reclaim Efficiency Modifier Multiplier }}\label{water-heater-heat-reclaim-efficiency-modifier-multiplier}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-4}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-5}
...
\paragraph{\texorpdfstring{Cooling Coil Part Load Ratio \protect\hyperlink{section-1}{}}{Cooling Coil Part Load Ratio }}\label{cooling-coil-part-load-ratio-1}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-6}
...
\begin{array}{l}GrossRatedCapacity@SpeedLevel\left( x \right) = CapacityScaleFactor\\\quad \quad \quad \quad  \times ReferenceUnitCapacity@SpeedLevel(x)\end{array}

\paragraph{Field: Rated Volumetric Air Flow Rate}\label{field-rated-volumetric-air-flow-rate-1}

This numeric field contains the rated volumetric air flow rate on the load side of the heat pump corresponding to the nominal speed level. This field is autosizable. The value is used to determine an internal scaling factor, and calculate the air flow rates in the parent objects. It is recommended that the ratio of the rated volumetric air flow rate to the rated capacity is the same as the unit performance from the Reference Unit data.

\begin{array}{l}AirFlowScaleFactor = \\\quad \quad \quad \quad \quad \frac{{RatedVolumetricAirFlowRate}}{{ReferenceUnitVolAirFlowRate@NominalSpeedLevel \times CapacityScaleFactor}}\end{array}

And the volumetric air flow rates in the parent objects are calculated as below,

\begin{array}{l}LoopVolumetricAirFlowRate@SpeedLevel\left( x \right) = AirFlowScaleFactor\\\quad \quad \quad  \times ReferenceUnitVolAirFlowRate@SpeedLevel(x)\\\quad \quad \quad  \times CapacityScaleFactor\end{array}
...
\begin{array}{l}LoopVolumetricWaterFlowRate@SpeedLevel\left( x \right) = WaterFlowScaleFactor\\\quad \quad \quad  \times ReferenceUnitVolWaterFlowRate@SpeedLevel(x)\\\quad \quad \quad  \times CapacityScaleFactor\end{array}
...
\begin{array}{l}ActualCapacity@SpeedLevel\left( x \right) = CapacityScaleFactor\\\quad \quad \quad  \times ReferenceUnitCapacity@SpeedLevel(x)\\\quad \quad \quad  \times TotCapTempModFac@SpeedLevel(x)\\\quad \quad \quad  \times TotCapAirFlowModFac@SpeedLevel(x)\\\quad \quad \quad  \times TotCapWaterFlowModFac@SpeedLevel(x)\end{array}
...
Speed \textless{}x\textgreater{} (ref: Performance Curves) that parameterizes the variation of the energy input ratio (EIR) as a function of the both the indoor air wet-bulb and entering water temperatures The EIR is the inverse of the COP. The output of this curve is multiplied by the rated EIR (inverse of rated COP at Speed \textless{}x\textgreater{} from the Reference Unit data) to give the EIR at specific temperature operating conditions (i.e., at an indoor air wet-bulb temperature or entering water temperature different from the rating point temperature). The curve is normalized to have the value of 1.0 at the rating point.
...
\begin{array}{l}ActualEIR@SpeedLevel\left( x \right) = \frac{{1.0}}{{ReferenceUnitCOP@SpeedLevel(x)}}\\\quad \quad \quad  \times EIRTempModFac@SpeedLevel(x)\\\quad \quad \quad  \times EIRAirFlowModFac@SpeedLevel(x)\\\quad \quad \quad  \times EIRWaterFlowModFac@SpeedLevel(x)\end{array}

And, the actual power consumption is calculated:

\begin{array}{l}ActualPower@SpeedLevel\left( x \right) = ActualCapacity@SpeedLevel\left( x \right)\\\quad \quad \quad \quad  \times ActualEIR@SpeedLevel\left( x \right)\end{array}
...
\begin{array}{l}ActualWasteHeat@SpeedLevel\left( x \right) = ActualPower@SpeedLevel\left( x \right)\\\quad \quad \quad \quad  \times WasteHeatFrac@SpeedLevel(x)\\\quad \quad \quad \quad  \times WasteHeatTempModFac@SpeedLevel(x)\end{array}
...
\paragraph{\texorpdfstring{Cooling Coil Part Load Ratio \protect\hyperlink{section-1}{}}{Cooling Coil Part Load Ratio }}\label{cooling-coil-part-load-ratio-2}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-7}
...
\paragraph{\texorpdfstring{Cooling Coil Upper Speed Level \protect\hyperlink{section-1}{}}{Cooling Coil Upper Speed Level }}\label{cooling-coil-upper-speed-level-1}

The output variable is the average upper speed level, for interpolating performances between two neighboring speed levels.

\paragraph{\texorpdfstring{Cooling Coil Neighboring Speed Levels Ratio \protect\hyperlink{section-1}{}}{Cooling Coil Neighboring Speed Levels Ratio }}\label{cooling-coil-neighboring-speed-levels-ratio-1}
...
\paragraph{\texorpdfstring{Heating Coil Part Load Ratio \protect\hyperlink{section-1}{}}{Heating Coil Part Load Ratio }}\label{heating-coil-part-load-ratio-1}

This output variable is the ratio of the part-load capacity to the steady state capacity of the WatertoAirHP coil. For the cycling fan mode, the runtime fraction for the heat pump compressor may be different from the compressor part-load ratio reported here due to the part-load performance of the WatertoAirHP coil (delay at start-up to reach steady-state output). In general, runtime fractions are reported by individual components where appropriate.

\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-7}
...
\begin{array}{l}GrossRatedCapacity@SpeedLevel\left( x \right) = \\\quad \quad \quad \quad CapacityScaleFactor \times ReferenceUnitCapacity@SpeedLevel(x)\end{array}

\paragraph{Field: Rated Volumetric Air Flow Rate}\label{field-rated-volumetric-air-flow-rate-2}

This numeric field contains the rated volumetric air flow rate on the load side of the heat pump corresponding to the nominal speed level. This field is autosizable. The value is used to determine an internal scaling factor, and calculate the air flow rates in the parent objects. It is recommended that the ratio of the rated volumetric air flow rate to the rated capacity is the same as the unit performance from the Reference Unit data.

\begin{array}{l}AirFlowScaleFactor = \\\quad \quad \quad \quad \frac{{RatedVolumetricAirFlowRate}}{{ReferenceUnitVolAirFlowRate@NominalSpeedLevel \times CapacityScaleFactor}}\end{array}

And the volumetric air flow rates in the parent objects are calculated as below,

\begin{array}{l}LoopVolumetricAirFlowRate@SpeedLevel\left( x \right) = \\\quad \quad \quad \quad AirFlowScaleFactor\\\quad \quad \quad \quad  \times ReferenceUnitVolAirFlowRate@SpeedLevel(x)\\\quad \quad \quad \quad  \times CapacityScaleFactor\end{array}
...
\begin{array}{l}ActualCapacity@SpeedLevel\left( x \right) = CapacityScaleFactor\\\quad \quad \quad \quad \quad  \times ReferenceUnitCapacity@SpeedLevel(x)\\\quad \quad \quad \quad \quad  \times TotCapTempModFac@SpeedLevel(x)\\\quad \quad \quad \quad \quad  \times TotCapAirFlowModFac@SpeedLevel(x)\\\quad \quad \quad \quad \quad  \times TotCapWaterFlowModFac@SpeedLevel(x)\end{array}
...
\begin{array}{l}ActualEIR@SpeedLevel\left( x \right) = \frac{{1.0}}{{ReferenceUnitCOP@SpeedLevel(x)}}\\\quad \quad \quad \quad \quad \quad \quad \quad \quad  \times EIRTempModFac@SpeedLevel(x)\\\quad \quad \quad \quad \quad \quad \quad \quad \quad  \times EIRAirFlowModFac@SpeedLevel(x)\\\quad \quad \quad \quad \quad \quad \quad \quad \quad  \times EIRWaterFlowModFac@SpeedLevel(x)\end{array}

And, the actual power consumption is calculated:

\begin{array}{l}ActualPower@SpeedLevel\left( x \right) = ActualCapacity@SpeedLevel\left( x \right)\\\quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad  \times ActualEIR@SpeedLevel\left( x \right)\end{array}
...
\begin{array}{l}ActualWasteHeat@SpeedLevel\left( x \right) = ActualPower@SpeedLevel\left( x \right)\\\quad \quad \quad \quad \quad \quad  \times WasteHeatFrac@SpeedLevel(x)\\\quad \quad \quad \quad \quad \quad  \times WasteHeatTempModFac@SpeedLevel(x)\end{array}
...
\paragraph{\texorpdfstring{Heating Coil Part Load Ratio \protect\hyperlink{section-1}{}}{Heating Coil Part Load Ratio }}\label{heating-coil-part-load-ratio-2}

This output variable is the ratio of the part-load capacity to the steady state capacity of the VSWatertoAirHP coil. For the cycling fan mode, the runtime fraction for the heat pump compressor may be different from the compressor part-load ratio reported here due to the part-load performance of the VSWatertoAirHP coil (delay at start-up to reach steady-state output). In general, runtime fractions are reported by individual components where appropriate.

\paragraph{\texorpdfstring{Heating Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Heating Coil Runtime Fraction }}\label{heating-coil-runtime-fraction-8}
...
\paragraph{\texorpdfstring{Heating Coil Upper Speed Level \protect\hyperlink{section-1}{}}{Heating Coil Upper Speed Level }}\label{heating-coil-upper-speed-level-1}

The output variable is the average upper speed level, for interpolating performances between two neighboring speed levels.

\paragraph{\texorpdfstring{Heating Coil Neighboring Speed Levels Ratio \protect\hyperlink{section-1}{}}{Heating Coil Neighboring Speed Levels Ratio }}\label{heating-coil-neighboring-speed-levels-ratio-1}
...
\begin{itemize}
\item
  HVAC,Average,Cooling Coil Operating Mode Index \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Cooling Coil Total Cooling Rate {[}W{]}
\item
  HVAC,Sum,Cooling Coil Total Cooling Energy {[}J{]}
...
\item
  HVAC,Average,Cooling Coil Ice Thermal Storage End Fraction \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Cooling Coil Condenser Inlet Temperature {[}C{]}
\item
  HVAC,Sum,Cooling Coil Evaporative Condenser Water Volume {[}m3{]}
...
\paragraph{\texorpdfstring{Cooling Coil Operating Mode Index \protect\hyperlink{section-1}{}}{Cooling Coil Operating Mode Index }}\label{cooling-coil-operating-mode-index}
...
\paragraph{\texorpdfstring{Cooling Coil Runtime Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Runtime Fraction }}\label{cooling-coil-runtime-fraction-8}
...
\paragraph{\texorpdfstring{Cooling Coil Ice Thermal Storage End Fraction \protect\hyperlink{section-1}{}}{Cooling Coil Ice Thermal Storage End Fraction }}\label{cooling-coil-ice-thermal-storage-end-fraction}
...
\paragraph{\texorpdfstring{Cooling Coil Evaporative Condenser Water Volume {[}m\(^{3}\){]}}{Cooling Coil Evaporative Condenser Water Volume {[}m\^{}\{3\}{]}}}\label{cooling-coil-evaporative-condenser-water-volume-m3-2}
...
\item
  HVAC, Average, Secondary Coil Sensible Heat Ratio \protect\hyperlink{section-1}{}
\item
  HVAC, Average, Secondary Coil Compressor Part Load Ratio \protect\hyperlink{section-1}{}
\end{itemize}
...
\subsubsection{\texorpdfstring{Secondary Coil Sensible Heat Ratio \protect\hyperlink{section-1}{}}{Secondary Coil Sensible Heat Ratio }}\label{secondary-coil-sensible-heat-ratio}
...
\subsubsection{\texorpdfstring{Secondary Coil Compressor Part Load Ratio \protect\hyperlink{section-1}{}}{Secondary Coil Compressor Part Load Ratio }}\label{secondary-coil-compressor-part-load-ratio}
