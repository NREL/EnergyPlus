...
\begin{itemize}
\item
  HVAC,Average,Chiller Cycling Ratio \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Meter,HeatRejection:EnergyTransfer {[}J{]}
\item
  HVAC,Average,Chiller Part Load Ratio \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller Cycling Ratio \protect\hyperlink{section-1}{}
\item
...
\begin{itemize}
\item
  HVAC,Average,Chiller Capacity Temperature Modifier Multiplier \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller EIR Temperature Modifier Multiplier \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller EIR Part Load Modifier Multiplier \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{Chiller Capacity Temperature Modifier Multiplier \protect\hyperlink{section-1}{}}{Chiller Capacity Temperature Modifier Multiplier }}\label{chiller-capacity-temperature-modifier-multiplier}

This is the output of the curve object Cooling Capacity Function of Temperature Curve.

\paragraph{\texorpdfstring{Chiller EIR Temperature Modifier Multiplier \protect\hyperlink{section-1}{}}{Chiller EIR Temperature Modifier Multiplier }}\label{chiller-eir-temperature-modifier-multiplier}

This is the output of the curve object Electric Input to Cooling Output Ratio Function of Temperature Curve.

\paragraph{\texorpdfstring{Chiller EIR Part Load Modifier Multiplier \protect\hyperlink{section-1}{}}{Chiller EIR Part Load Modifier Multiplier }}\label{chiller-eir-part-load-modifier-multiplier}

This is the output of the curve object Electric Input to Cooling Output Ratio Function of Part Load Curve.

\paragraph{\texorpdfstring{Chiller Part Load Ratio \protect\hyperlink{section-1}{}}{Chiller Part Load Ratio }}\label{chiller-part-load-ratio-1}
...
\paragraph{\texorpdfstring{Chiller Cycling Ratio \protect\hyperlink{section-1}{}}{Chiller Cycling Ratio }}\label{chiller-cycling-ratio-1}
...
\begin{array}{l}CoolElectricPower = \\NomCoolCap \cdot RunFrac \cdot CEIR \cdot CEIRfT({T_{cw,l}},{T_{cond}}) \cdot CEIRfPLR(CPLR)\end{array}
...
\tightlist
\item
  HVAC,Average,Chiller Heater Runtime Fraction \protect\hyperlink{section-1}{}
\end{itemize}
...
\item
  HVAC,Average,Chiller Heater Heating Part Load Ratio \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller Heater Heating Rate {[}W{]}
\item
...
\paragraph{\texorpdfstring{Chiller Heater Runtime Fraction \protect\hyperlink{section-1}{}}{Chiller Heater Runtime Fraction }}\label{chiller-heater-runtime-fraction}
...
The CoolCapfT curve represents the fraction of the cooling capacity of the chiller as it varies with temperature. The curve is normalized so that at design conditions the value of the curve should be 1.0. The curve is usually a biquadratic or bilinear curve with the input variables being the leaving chilled water temperature and the entering condenser water temperature (see \emph{Temperature Curve Input Variable} below). The available cooling capacity is computed as follows:

\begin{array}{l}CoolThermalEnergyInput = AvailCoolCap \cdot RunFrac \cdot TeFIR \cdot \\\quad \quad \quad \quad \quad \quad TeFIRfT\left( {{T_{cw,l}},{T_{cond}}} \right) \cdot TeFIRfPLR(CPLR)\end{array}
...
\paragraph{\texorpdfstring{Chiller Heater Runtime Fraction \protect\hyperlink{section-1}{}}{Chiller Heater Runtime Fraction }}\label{chiller-heater-runtime-fraction-1}
...
\paragraph{\texorpdfstring{Chiller Heater Cooling Part Load Ratio \protect\hyperlink{section-1}{}}{Chiller Heater Cooling Part Load Ratio }}\label{chiller-heater-cooling-part-load-ratio-1}
...
\paragraph{\texorpdfstring{Chiller Heater Heating Part Load Ratio \protect\hyperlink{section-1}{}}{Chiller Heater Heating Part Load Ratio }}\label{chiller-heater-heating-part-load-ratio-1}
...
\begin{array}{l}Bicubic \to Eff = {A_0} + {A_1}\cdot PLR + {A_2}\cdot PL{R^2} + {A_3}\cdot {T_w} + {A_4}{T_w}^2 + {A_5}PLR\cdot {T_w} + {A_6}PL{R^3}\\\quad \quad \quad \quad \quad \quad \quad  + {A_7}\cdot {T_w}^3 + {A_8}\cdot PL{R^2}\cdot {T_w} + {A_9}\cdot PLR\cdot {T_w}^2\end{array}
...
\paragraph{\texorpdfstring{Boiler Part Load Ratio \protect\hyperlink{section-1}{}}{Boiler Part Load Ratio }}\label{boiler-part-load-ratio}
...
\begin{itemize}
\item
  HVAC,Average,Chiller Heater Operation Mode Unit \textless{}x\textgreater{} \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller Heater Part Load Ratio Unit \textless{}x\textgreater{} \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller Heater Cycling Ratio Unit \textless{}x\textgreater{} \protect\hyperlink{section-1}{}
\item
...
\item
  HVAC,Average,Chiller Heater COP Unit \textless{}x\textgreater{} \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller Heater Capacity Temperature Modifier Multiplier Unit \textless{}x\textgreater{} \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller Heater EIR Temperature Modifier Multiplier Unit \textless{}x\textgreater{} \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Chiller Heater EIR Part Load Modifier Multiplier Unit \textless{}x\textgreater{} \protect\hyperlink{section-1}{}
\end{itemize}
...
\toprule 
Mode & Chiller Setpoint & Storage Setpoint \tabularnewline \midrule
\endhead
...
\item
  Zone,Average,Ice Thermal Storage End Fraction\protect\hyperlink{section-1}{}
\item
...
\paragraph{\texorpdfstring{Ice Thermal Storage End Fraction \protect\hyperlink{section-1}{}}{Ice Thermal Storage End Fraction }}\label{ice-thermal-storage-end-fraction}
...
\item
  System, Average, Ice Thermal Storage Change Fraction \protect\hyperlink{section-1}{}
\item
  System, Average, Ice Thermal Storage End Fraction \protect\hyperlink{section-1}{}
\item
...
\item
  System, Average, Ice Thermal Storage On Coil Fraction \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{Ice Thermal Storage Change Fraction \protect\hyperlink{section-1}{}}{Ice Thermal Storage Change Fraction }}\label{ice-thermal-storage-change-fraction}
...
\paragraph{\texorpdfstring{Ice Thermal Storage End Fraction \protect\hyperlink{section-1}{}}{Ice Thermal Storage End Fraction }}\label{ice-thermal-storage-end-fraction-1}

The fraction charge of the ice storage system at the end of the timestep

\paragraph{\texorpdfstring{Ice Thermal Storage On Coil Fraction \protect\hyperlink{section-1}{}}{Ice Thermal Storage On Coil Fraction }}\label{ice-thermal-storage-on-coil-fraction}
