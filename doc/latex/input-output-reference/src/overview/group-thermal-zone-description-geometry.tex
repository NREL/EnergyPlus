...
\paragraph{Starting Corner for the surface}\label{starting-corner-for-the-surface}
...
\paragraph{Starting Corner for the surface}\label{starting-corner-for-the-surface-1}
...
\textbf{Note that the resolution on the surface vertex input is 1 millimeter (.001 meter). Therefore, using vertices that are very close together (\textless{}1 mm) may result in invalid dot product and fatal errors during shading calculations.}
...
4,0,0,H, 0,0,0, A,0,0, A,0,H; ! \textbf{(4 vertices, South Wall)}

4,A,0,H,A,0,0,A,B,0,A,B,H;~ ! \textbf{(4 vertices, East Wall)}

~~~~ \textbf{ignore other walls that are not shown in this figure}

4,C,0,J,A,0,H,A,B,H,C,B,J; ! \textbf{(4 vertices, roof)}

3,C,0,J,0,0,H,A,0,H; ! \textbf{(3 vertices, gable end)}
...
\toprule 
Option & Object/Field or Output Variable & Input File (histributeh with install) \tabularnewline \midrule
\endhead
Build up a window from layers & WindowMaterial:Glazing, WindowMaterial:Gas, WindowMaterial:Shade, WindowMaterial:Screen, WindowMaterial:Blind, Construction & WindowTests.idf \tabularnewline
Add an overhang & Shading:Zone:Detailed & 5ZoneAirCooled.idf \tabularnewline
Add a shading device & WindowMaterial:Shade, WindowMaterial:Screen or WindowMaterial:Blind; WindowProperty:ShadingControl & WindowTests.idf, PurchAirWindowBlind.idf \tabularnewline
Control a shading device & WindowProperty:ShadingControl & PurchAirWindowBlind.idf \tabularnewline
Determine when a shading device is on in a particular timestep & Print the variable~ “Surface Shading Device Is On Time Fraction” & PurchAirWindowBlind.idf \tabularnewline
Control the slat angle of a blind & WindowProperty:ShadingControl & PurchAirWindowBlind.idf \tabularnewline
Add a frame & WindowProperty:FrameAndDivider & PurchAirWithDaylighting.idf \tabularnewline
Add a divider & WindowProperty:FrameAndDivider & PurchAirWithDaylighting.idf \tabularnewline
Allow window to daylight a zone & Daylighting:Controls, Daylighting:DELight:Controls & PurchAirWithDaylighting.idf, DElight-Detailed-Comparison.idf \tabularnewline
Find solar reflected onto window from neighboring buildings & Building/SolarDistribution field – uses “WithReflections” & ReflectiveAdjacentBuilding.idf \tabularnewline
Model switchable glazing (e.g., electrochromic glass) & WindowProperty:ShadingControl & PurchAirWithDaylighting.idf \tabularnewline
Add an interior window & Define two FenestrationSurface:Detailed’s, one for each associated interior wall & PurchAirWithDoubleFacadeDaylighting.idf \tabularnewline
Track how beam solar falls on interior surfaces & Building/Solar Distribution = FullInteriorAndExterior & PurchAirWithDoubleFacadeDaylighting.idf \tabularnewline
Track beam solar transmitted through interior windows & Building/Solar Distribution = FullInteriorAndExterior & PurchAirWithDoubleFacadeDaylighting.idf \tabularnewline
Add a shading device on an interior window & Not allowed & ~ \tabularnewline
Model an airflow window (aka, heat extract window) & WindowProperty:AirflowControl & AirflowWindowsAndBetweenGlassBlinds.idf \tabularnewline
Add a storm window glass layer & WindowProperty:StormWindow & StormWindow.idf \tabularnewline
Add natural ventilation through an open window & Ventilation or AirflowNetwork objects (AirflowNetwork:Multizone:Surface, AirflowNetwork:MultiZone:Component:DetailedOpening, etc.) & AirflowNetwork3zvent.idf \tabularnewline
Add diffusing glass & WindowMaterial:Glazing/Solar Diffusing = Yes & ~ \tabularnewline
Add dirt on window & WindowMaterial:Glazing/Dirt Correction Factor for Solar and Visible Transmittance & ~ \tabularnewline
Import window (and frame/divider if present) from WINDOW program & See “Importing Windows from WINDOW program” & ~ \tabularnewline
Find daylighting through interior windows & See “Double Facades: Daylighting through Interior Windows” & PurchAirWithDoubleFacadeDaylighting.idf \tabularnewline
Determine when condensation occurs & Print the variables “Surface Window Inside Face Glazing Condensation Status,” “Surface Window Inside Face Frame Condensation Status,” “Surface Window Inside Face Divider Condensation Status” & ~ \tabularnewline
\bottomrule
\end{longtable}
...
\begin{itemize}
\item
  Zone,Sum,Surface Inside Face Heat Balance Calculation Iteration Count \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Surface Anisotropic Sky Multiplier \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window BSDF Beam Direction Number \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Surface Window System Solar Transmittance \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window System Solar Absorptance \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window System Solar Reflectance \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Surface Window Glazing Beam to Beam Solar Transmittance\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Glazing Beam to Diffuse Solar Transmittance \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Glazing Diffuse to Diffuse Solar Transmittance\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Model Solver Iteration Count \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Surface Window Inside Face Glazing Condensation Status \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Inside Face Frame Condensation Status \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Inside Face Divider Condensation Status \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Shading Device Is On Time Fraction\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Blind Slat Angle {[}deg{]}
\item
  Zone,Average,Surface Window Blind Beam to Beam Solar Transmittance\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Blind Beam to Diffuse Solar Transmittance\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Blind Diffuse to Diffuse Solar Transmittance\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Blind and Glazing System Beam Solar Transmittance\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Blind and Glazing System Diffuse Solar Transmittance\protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Screen Beam to Beam Solar Transmittance \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Screen Beam to Diffuse Solar Transmittance \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Screen Diffuse to Diffuse Solar Transmittance \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Screen and Glazing System Beam Solar Transmittance \protect\hyperlink{section-1}{}
\item
  Zone,Average,Surface Window Screen and Glazing System Diffuse Solar Transmittance \protect\hyperlink{section-1}{}
\item
  Zone,State,Surface Storm Window On Off Status \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Surface Window Total Absorbed Shortwave Radiation Rate Layer \textless{}x\textgreater{} {[}W{]}
\item
  Zone,Average,Surface Window Front Face Temperature Layer \textless{}x\textgreater{} {[}C{]}
\item
  Zone,Average,Surface Window Back Face Temperature Layer \textless{}x\textgreater{} {[}C{]}
\end{itemize}
...
\subsubsection{}\label{section-000}
...
\subsubsection{For a window with a blind, this transmitted radiation consists of beam radiation that passes between the slats. For a window with a screen, this value consists of direct beam radiation that is transmitted through the screen (gaps between the screen material).}\label{for-a-window-with-a-blind-this-transmitted-radiation-consists-of-beam-radiation-that-passes-between-the-slats.-for-a-window-with-a-screen-this-value-consists-of-direct-beam-radiation-that-is-transmitted-through-the-screen-gaps-between-the-screen-material.}
...
\subsubsection{For a window with a blind, this transmitted radiation consists of diffuse radiation reflected from beam by the slats. For a window with a screen, this value consists of diffuse radiation reflected by the screen material.}\label{for-a-window-with-a-blind-this-transmitted-radiation-consists-of-diffuse-radiation-reflected-from-beam-by-the-slats.-for-a-window-with-a-screen-this-value-consists-of-diffuse-radiation-reflected-by-the-screen-material.}
...
\textbf{\emph{Surface Window Inside Face Other Convection Heat Gain Rate {[}W{]}}}
...
\paragraph{\texorpdfstring{Specify ``Name of Construction with Shading''}{Specify Name of Construction with Shading}}\label{specify-name-of-construction-with-shading}
...
\paragraph{\texorpdfstring{Specify the ``Material Name of the Shading Device''}{Specify the Material Name of the Shading Device}}\label{specify-the-material-name-of-the-shading-device}
