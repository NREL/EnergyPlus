...
\paragraph{Field: Outdoor Temperature Dependent Crankcase Heater Capacity Curve Name}\label{outdoor-temperature-dependent-crankcase-heater-capacity-curve-name-0}

The name of a Curve:* or Table:Lookup object encoding the relationship between
the crankcase heater capacity and the outdoor air temperature. This curve can be
any uni-variate curve or table. If this field is missing or empty, constant
crankcase heater capacity will be assumed.
