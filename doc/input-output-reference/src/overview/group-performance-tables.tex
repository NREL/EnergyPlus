...
\paragraph{\texorpdfstring{Performance Curve Input Variable 1 Value {[]}}{Performance Curve Input Variable 1 Value }}\label{performance-curve-input-variable-1-value}
