...
\paragraph{VRF Heat Pump Cooling COP{[]}}\label{vrf-heat-pump-cooling-cop}
...
\paragraph{VRF Heat Pump Heating COP{[]}}\label{vrf-heat-pump-heating-cop}
...
\paragraph{VRF Heat Pump COP{[]}}\label{vrf-heat-pump-cop}
...
\paragraph{VRF Heat Pump Runtime Fraction {[]}}\label{vrf-heat-pump-runtime-fraction}
...
\paragraph{VRF Heat Pump Cycling Ratio {[]}}\label{vrf-heat-pump-cycling-ratio}
...
\paragraph{VRF Heat Pump Operating Mode {[]}}\label{vrf-heat-pump-operating-mode}
...
\paragraph{VRF Heat Pump Heat Recovery Status Change Multiplier {[]}}\label{vrf-heat-pump-heat-recovery-status-change-multiplier}
