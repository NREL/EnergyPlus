...
\item
  HVAC,Average,VRF Heat Pump Cooling COP \protect\hyperlink{section-1}{}
\item
  HVAC,Average,VRF Heat Pump Heating COP \protect\hyperlink{section-1}{}
\item
  HVAC,Average,VRF Heat Pump COP \protect\hyperlink{section-1}{}
\item
  HVAC,Average,VRF Heat Pump Part Load Ratio \protect\hyperlink{section-1}{}
\item
  HVAC,Average,VRF Heat Pump Runtime Fraction \protect\hyperlink{section-1}{}
\item
  HVAC,Average,VRF Heat Pump Cycling Ratio \protect\hyperlink{section-1}{}
\item
  HVAC,Average,VRF Heat Pump Operating Mode \protect\hyperlink{section-1}{}
\item
...
\tightlist
\item
  HVAC,Average,VRF Heat Pump Heat Recovery Status Change Multiplier \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{VRF Heat Pump Cooling COP\protect\hyperlink{section-1}{}}{VRF Heat Pump Cooling COP}}\label{vrf-heat-pump-cooling-cop}
...
\paragraph{\texorpdfstring{VRF Heat Pump Heating COP\protect\hyperlink{section-1}{}}{VRF Heat Pump Heating COP}}\label{vrf-heat-pump-heating-cop}
...
\paragraph{\texorpdfstring{VRF Heat Pump COP\protect\hyperlink{section-1}{}}{VRF Heat Pump COP}}\label{vrf-heat-pump-cop}
...
\paragraph{\texorpdfstring{VRF Heat Pump Runtime Fraction \protect\hyperlink{section-1}{}}{VRF Heat Pump Runtime Fraction }}\label{vrf-heat-pump-runtime-fraction}
...
\paragraph{\texorpdfstring{VRF Heat Pump Cycling Ratio \protect\hyperlink{section-1}{}}{VRF Heat Pump Cycling Ratio }}\label{vrf-heat-pump-cycling-ratio}
...
\paragraph{\texorpdfstring{VRF Heat Pump Operating Mode \protect\hyperlink{section-1}{}}{VRF Heat Pump Operating Mode }}\label{vrf-heat-pump-operating-mode}
...
\paragraph{\texorpdfstring{VRF Heat Pump Heat Recovery Status Change Multiplier \protect\hyperlink{section-1}{}}{VRF Heat Pump Heat Recovery Status Change Multiplier }}\label{vrf-heat-pump-heat-recovery-status-change-multiplier}
...
\paragraph{VRF Heat Pump Indoor Unit Evaporating Temperature at Cooling Mode {[}C{]}}\label{vrf-heat-pump-indoor-unit-evaporating-temperature-at-cooling-mode-c}
...
\paragraph{VRF Heat Pump Outdoor Unit Condensing Temperature at Cooling Mode {[}C{]}}\label{vrf-heat-pump-outdoor-unit-condensing-temperature-at-cooling-mode-c}
...
\paragraph{VRF Heat Pump Indoor Unit Condensing Temperature at Heating Mode {[}C{]}}\label{vrf-heat-pump-indoor-unit-condensing-temperature-at-heating-mode-c}
...
\paragraph{VRF Heat Pump Outdoor Unit Evaporating Temperature at Heating Mode {[}C{]}}\label{vrf-heat-pump-outdoor-unit-evaporating-temperature-at-heating-mode-c}
...
\paragraph{VRF Heat Pump Compressor Electric Power at Cooling Mode {[}W{]}}\label{vrf-heat-pump-compressor-electric-power-at-cooling-mode-w}
...
\paragraph{VRF Heat Pump Compressor Electric Power at Heating Mode {[}W{]}}\label{vrf-heat-pump-compressor-electric-power-at-heating-mode-w}
