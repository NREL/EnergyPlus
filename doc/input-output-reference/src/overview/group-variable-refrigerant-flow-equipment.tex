...
\paragraph{Field: Minimum Outdoor Unit Inlet Temperature in Cooling Mode}\label{field-minimum-outdoor-unit-inlet-temperature-in-cooling-mode-000}
...
\paragraph{Field: Maximum Outdoor Unit Inlet Temperature in Cooling Mode}\label{field-maximum-outdoor-unit-inlet-temperature-in-cooling-mode-000}
...
\paragraph{Field: Minimum Outdoor Unit Inlet Temperature in Heating Mode}\label{field-minimum-outdoor-unit-inlet-temperature-in-heating-mode-000}
...
\paragraph{Field: Maximum Outdoor Unit Inlet Temperature in Heating Mode}\label{field-maximum-outdoor-unit-inlet-temperature-in-heating-mode-000}
...
\paragraph{Field: Minimum Outdoor Unit Inlet Temperature in Heat Recovery Mode}\label{field-minimum-outdoor-unit-inlet-temperature-in-heat-recovery-mode-000}

This numeric field defines the minimum source inlet temperature allowed for heat recovery operation. For air-cooled equipment outdoor dry-bulb temperature is used. For water-cooled equipment inlet water temperature is used. Below this temperature, heat recovery is disabled. This input must be greater than the larger of the minimum outdoor unit inlet temperature in cooling or heating mode. If this field is left blank, the default value is the higher of the Minimum Outdoor Unit Inlet Temperature in Cooling Mode or Minimum Outdoor Unit Inlet Temperature in Heating Mode inputs. This system may still operate in cooling or heating only mode when source inlet temperatures are below the minimum outdoor unit inlet temperature in heat recovery mode. This input is only used when Heat Pump Waste Heat Recovery is selected as Yes.

\paragraph{Field: Maximum Outdoor Unit Inlet Temperature in Heat Recovery Mode}\label{field-maximum-outdoor-unit-inlet-temperature-in-heat-recovery-mode-000}

This numeric field defines the maximum source inlet temperature allowed for heat recovery operation. For air-cooled equipment outdoor dry-bulb temperature is used. For water-cooled equipment inlet water temperature is used. Above this temperature, heat recovery is disabled. This input must be less than the smaller of the maximum outdoor unit inlet temperature in cooling or heating mode. If this field is left blank, the default value is the lower of the Maximum Outdoor Unit Inlet Temperature in Cooling Mode or Maximum Outdoor Unit Inlet Temperature in Heating Mode inputs.. This system may still operate in cooling or heating only mode when source inlet temperatures are above the maximum outdoor unit inlet temperature in heat recovery mode. This input is only used when Heat Pump Waste Heat Recovery is selected as Yes.
...
AirConditioner:VariableRefrigerantFlow,
    ...
    -5,                   !- Minimum Outdoor Unit Inlet Temperature in Cooling Mode {C}
    43,                   !- Maximum Outdoor Unit Inlet Temperature in Cooling Mode {C}
    ...
    -20,                  !- Minimum Outdoor Unit Inlet Temperature in Heating Mode {C}
    15.5,                 !- Maximum Outdoor Unit Inlet Temperature in Heating Mode {C}
    ...
    ,                     !- Fuel Type
    ,                     !- Minimum Outdoor Unit Inlet Temperature in Heat Recovery Mode (C)
    ,                     !- Maximum Outdoor Unit Inlet Temperature in Heat Recovery Mode (C)
