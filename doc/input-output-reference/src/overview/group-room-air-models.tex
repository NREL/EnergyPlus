...
This object is extensible by repeating the last two fields -- note that you will have to replace ``inner'' semi-colons with commas.  An example of this object corresponding to the figure above is:
...
This object is extensible by repeating the last two fields -- note that you will have to replace ``inner'' semi-colons with commas.  An example of this object, which might be used to elevate temperatures near west windows in the afternoon, is:
