...
\paragraph{\texorpdfstring{Solar Collector Incident Angle Modifier {[]}}{Solar Collector Incident Angle Modifier }}\label{solar-collector-incident-angle-modifier}
...
\paragraph{\texorpdfstring{Solar Collector Efficiency {[]}}{Solar Collector Efficiency }}\label{solar-collector-efficiency}
...
\paragraph{\texorpdfstring{Solar Collector Thermal Efficiency {[]}}{Solar Collector Thermal Efficiency }}\label{solar-collector-thermal-efficiency}
...
\paragraph{\texorpdfstring{Solar Collector Transmittance Absorptance Product {[]}}{Solar Collector Transmittance Absorptance Product }}\label{solar-collector-transmittance-absorptance-product}
...
\paragraph{\texorpdfstring{Generator PVT Fluid Bypass Status {[]}}{Generator PVT Fluid Bypass Status }}\label{generator-pvt-fluid-bypass-status}
...
\paragraph{\texorpdfstring{Solar Collector Heat Exchanger Effectiveness {[]}}{Solar Collector Heat Exchanger Effectiveness }}\label{solar-collector-heat-exchanger-effectiveness}
...
\paragraph{\texorpdfstring{Solar Collector System Efficiency {[]}}{Solar Collector System Efficiency }}\label{solar-collector-system-efficiency}
...
\paragraph{\texorpdfstring{Solar Collector Surface Efficiency {[]}}{Solar Collector Surface Efficiency }}\label{solar-collector-surface-efficiency}
