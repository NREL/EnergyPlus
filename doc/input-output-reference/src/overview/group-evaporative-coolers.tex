...
\paragraph{\texorpdfstring{Evaporative Cooler Stage Effectiveness {[]}}{Evaporative Cooler Stage Effectiveness }}\label{evaporative-cooler-stage-effectiveness}
...
\paragraph{\texorpdfstring{Evaporative Cooler Total Stage Effectiveness {[]}}{Evaporative Cooler Total Stage Effectiveness }}\label{evaporative-cooler-total-stage-effectiveness-1}
...
\paragraph{\texorpdfstring{Evaporative Cooler Total Stage Effectiveness {[]}}{Evaporative Cooler Total Stage Effectiveness }}\label{evaporative-cooler-total-stage-effectiveness-2}
...
\paragraph{\texorpdfstring{Evaporative Cooler Operating Mode Status {[]}}{Evaporative Cooler Operating Mode Status }}\label{evaporative-cooler-operating-mode-status}
...
\paragraph{\texorpdfstring{Evaporative Cooler Part Load Ratio {[]}}{Evaporative Cooler Part Load Ratio }}\label{evaporative-cooler-part-load-ratio}
...
\paragraph{\texorpdfstring{Evaporative Cooler Dewpoint Bound Status {[]}}{Evaporative Cooler Dewpoint Bound Status }}\label{evaporative-cooler-dewpoint-bound-status}
