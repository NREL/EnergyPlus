...
\item
  \hyperref[plantequipmentoperationoutdoordrybulbdifference]{\hyperref[plantequipmentoperationoutdoordrybulb]{PlantEquipmentOperation:OutdoorDryBulb}Difference}
\item
  \hyperref[plantequipmentoperationoutdoorwetbulbdifference]{\hyperref[plantequipmentoperationoutdoorwetbulb]{PlantEquipmentOperation:OutdoorWetBulb}Difference}
\item
  \hyperref[plantequipmentoperationoutdoordewpointdifference]{\hyperref[plantequipmentoperationoutdoordewpoint]{PlantEquipmentOperation:OutdoorDewpoint}Difference}
\item
  \hyperref[plantequipmentoperationuserdefined]{PlantEquipmentOperation:UserDefined}
\end{itemize}
