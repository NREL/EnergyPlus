...
The name of a SpaceHVAC:EquipmentConnections Inlet Node Name that takes a fraction of the airflow from the Zone Equipment Outlet Node.
...
The name of a SpaceHVAC:EquipmentConnections Exhaust Node Name that sends a fraction of the airflow to the Zone Equipment Inlst Node.
