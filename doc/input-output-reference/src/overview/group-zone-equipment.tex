...
\paragraph{Field: Space Sizing Basis}\label{field-seqsplitter-space-sizing-basis}

The basis used to autosize the space output fractions. The choices are: DesignCoolingLoad, DesignHeatingLoad, FloorArea, Volume, and PerimeterLength. The default is DesignCoolingLoad.
...
\paragraph{Field: Space \textless{}x\textgreater{} Output Fraction}\label{field-seqsplitter-space-output-fraction}

Fraction of this zone equipment output or airflow distributed to this space. May be autosized using the Space Sizing Basis. The default is autosize.
