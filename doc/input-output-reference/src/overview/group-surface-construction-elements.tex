...
\paragraph{Field: Two-Dimensional Position of Interior Temperature Calculation}\label{field-two-dimensional-position-of-interior-temperature-calculation}
