...
\paragraph{Field: Thermal Transmittance at Normal Incidence}\label{field-thermal-transmittance-at-normal-incidence}

Long-wave transmittance at normal incidence. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation.

\paragraph{Field: Front Side Thermal Hemispherical Emissivity}\label{field-front-side-thermal-hemispherical-emissivity}

Front-side long-wave emissivity. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation.

\paragraph{Field: Back Side Thermal Hemispherical Emissivity}\label{field-back-side-thermal-hemispherical-emissivity}

Back-side long-wave emissivity. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation.
...
\paragraph{Field: Thermal Transmittance at Normal Incidence}\label{field-thermal-transmittance-at-normal-incidence-1}

Long-wave transmittance at normal incidence. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation.

\paragraph{Field: Thermal Hemispherical Emissivity}\label{field-thermal-hemispherical-emissivity}

Long-wave hemispherical emissivity, assumed the same on both sides of the glass. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation.
...
WindowMaterial:Glazing,
  ...
  0.0000,           !- Thermal Transmittance at Normal Incidence
  0.9000,           !- Front Side Thermal Hemispherical Emissivity
  0.9000,           !- Back Side Thermal Hemispherical Emissivity
  0.0199,           !- Conductivity
...
Effective long-wave emissivity. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. Assumed same on both sides of shade. We can approximate this~ effective emissivity, \(\varepsilon_{eff}\), as follows. Let \(\eta\) be the ``openness'' the shade, i.e.,~ the ratio of the area of openings in the shade to the overall shade area (see Field: Air-Flow Permeability, below). Let the emissivity of the shade material be \(\varepsilon\). Then
...
\paragraph{Field: Slat Thermal Hemispherical Transmittance}\label{field-slat-thermal-hemispherical-transmittance}

The slat Infrared transmittance. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. It is zero for solid metallic, wooden or glass slats, but may be non-zero in some cases (e.g., thin plastic slats).

\paragraph{Field: Front Side Slat Thermal~ Hemispherical Emissivity}\label{field-front-side-slat-thermal-hemispherical-emissivity}

Front-side hemispherical emissivity of the slat. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. Approximately 0.9 for most materials. The most common exception is bare (unpainted) metal slats or slats finished with a metallic paint.

\paragraph{Field: Back Side Slat Thermal~ Hemispherical Emissivity}\label{field-back-side-slat-thermal-hemispherical-emissivity}

Back-side hemispherical emissivity of the slat. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. Approximately 0.9 for most materials. The most common exception is bare (unpainted) metal slats or slats finished with a metallic paint.
...
WindowMaterial:Blind,
   ...
   0.0     , !- Slat Thermal hemispherical transmittance
   0.9     , !- Front Side Slat Thermal hemispherical emissivity
   0.9     , !- Back Side Slat Thermal hemispherical emissivity
...
\paragraph{Field: Shade Material Thermal Transmittance}\label{field-shade-material-thermal-transmittance}

This value is the long-wave transmittance of the shade material and assumed to be the same for front and back sides of the shade. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0 and maximum value is less than 1.0. Default value is 0.05.

\paragraph{Field: Front Side Shade Material Thermal Emissivity}\label{field-front-side-shade-material-thermal-emissivity}

This value is the front side long-wave hemispherical emissivity of shade material. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0 and maximum value is less than 1.0. Default value is 0.91. The front side effective emissivity of the shade layer is calculated using this value and the material openness specified above.

\paragraph{Field: Back Side Shade Material Thermal Emissivity}\label{field-back-side-shade-material-thermal-emissivity}

This value is the back side long-wave hemispherical emissivity of shade material. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0 and maximum value is less than 1.0. Default value is 0.91. The back side effective emissivity of the shade is calculated using this value and the material openness specified above.
...
WindowMaterial:Shade:EquivalentLayer,
    ...
    0.0,           !- Shade Material Thermal Transmittance
    0.84,          !- Front Side Shade Material Thermal Emissivity
    0.84;          !- Back Side Shade Material Thermal Emissivity
\end{lstlisting}
...
\paragraph{Field: Drape Material Thermal Transmittance}\label{field-drape-material-thermal-transmittance}

This value is the long-wave hemispherical transmittance of the fabric material at zero fabric openness fraction.~ Assumed to be the same for front and back sides of the drape fabric material layer. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0 and maximum value is less than 1.0.~ The default value is 0.05.

\paragraph{Field: Front Side Drape Material Thermal Emissivity}\label{field-front-side-drape-material-thermal-emissivity}

This value is the front side long-wave hemispherical emissivity of fabric material at zero shade openness. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0 and maximum value is less than 1.0. the default value is 0.87. The front side effective emissivity of the drape fabric layer is calculated using this value and the fabric openness area fraction specified above.

\paragraph{Field: Back Side Drape Material Thermal Emissivity}\label{field-back-side-drape-material-thermal-emissivity}

This value is the back side long-wave hemispherical emissivity of fabric material at zero fabric openness fraction. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0 and maximum value is less than 1.0. The default value is 0.87. The back side effective emissivity of the drape fabric layer is calculated using this value and the fabric openness area fraction specified above.
...
WindowMaterial:Drape:EquivalentLayer,
  ...
  0.10,               !- Shade Material Thermal Transmittance
  0.90,               !- Front Side Shade Material Thermal Emissivity
  0.80,               !- Back Side Shade Material Thermal Emissivity
...
\paragraph{Field: Slat Thermal Transmittance}\label{field-slat-thermal-transmittance}

This value is the long-wave hemispherical transmittance of the slat material. Assumed to be the same for both sides of the slat. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0, the maximum value is less than 1.0.~ The default value is 0.0.

\paragraph{Field: Front Side Slat Thermal Emissivity}\label{field-front-side-slat-thermal-emissivity}

This value is the front side long-wave hemispherical emissivity of the slat material. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0, the maximum value is less than 1.0. The default value is 0.9.

\paragraph{Field: Back Side Slat Thermal Emissivity}\label{field-back-side-slat-thermal-emissivity}

This value is the back side long-wave hemispherical emissivity of the slat material. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0, the maximum value is less than 1.0.~ The default value is 0.9.
...
WindowMaterial:Blind:EquivalentLayer,
    ...
    0.0,               ! - Slat Thermal Transmittance
    0.90,              ! - Front Side Slat Thermal Emissivity
    0.90,              ! - Back Side Slat Thermal Emissivity
...
\paragraph{Field: Screen Thermal Transmittance}\label{field-screen-thermal-transmittance}

This value is the long-wave hemispherical transmittance of the the screen material. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. Assumed to be the same for both sides of the screen material. The minimum value is 0.0, the maximum value is less than 1.0.~ The default value is 0.02

\paragraph{Field: Screen Thermal Emissivity}\label{field-screen-thermal-emissivity}

This value is the long-wave hemispherical emissivity of the screen material. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. Assumed to be the same for both sides of the screen material. The minimum value is 0.0, the maximum value is less than 1.0. The default value is 0.93.
...
WindowMaterial:Screen:EquivalentLayer,
    ...
    0.0,                   !- Screen Thermal Transmittance
    0.84,                  !- Screen Thermal Emissivity
...
\paragraph{Field: Thermal Transmittance (applies to front and back)}\label{field-thermal-transmittance-applies-to-front-and-back}

This value is the long-wave hemispherical transmittance of the glazing. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. Assumed to be the same for both sides of the glazing. The minimum value is 0.0, the maximum value is less than 1.0.~ The default value is 0.0.

\paragraph{Field: Front Side Thermal Emissivity}\label{field-front-side-thermal-emissivity}

This value is the front side long-wave hemispherical emissivity of the glazing. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0, the maximum value is less than 1.0.~ The default value is 0.84.

\paragraph{Field: Back Side Thermal Emissivity}\label{field-back-side-thermal-emissivity}

This value is the back side long-wave hemispherical emissivity of the glazing. Thermal means the long-wave radiation or sometimes it is also defined as the infrared wave-length range radiation. The minimum value is 0.0, the maximum value is less than 1.0.~ The default value is 0.84.
...
WindowMaterial:Glazing:EquivalentLayer,
    ...
    0.0,                     !- Thermal Transmittance
    0.84,                    !- Front Side Thermal Emissivity
    0.84;                    !- Back Side Thermal Emissivity
\end{lstlisting}
