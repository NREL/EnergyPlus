...
\item
  \hyperref[materialpropertyphasechangehysteresis]{\hyperref[materialpropertyphasechange]{MaterialProperty:PhaseChange}Hysteresis}
\end{itemize}
...
References gas (\hyperref[windowmaterialgas]{WindowMaterial:Gas}) or gas mixture (\hyperref[windowmaterialgasmixture]{\hyperref[windowmaterialgas]{WindowMaterial:Gas}Mixture}) of the gap layer.
