...
the thermal or solar absorptance of a existing material defined in the field ``Reference Material Name''.
...
a constant solar absorptance, or a constant thermal absorptance and a variable solar absorptance.
