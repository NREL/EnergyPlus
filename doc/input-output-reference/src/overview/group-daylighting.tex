...
\caption{Example of a Stepped Lighting Control System with Three Steps \protect \label{table:stepped-lighting-control-example}}\\
\toprule 
Daylight illuminance & Fraction of lights that are on \tabularnewline \midrule
\endhead
...
% table 20
\begin{longtable}[c]{@{}ll@{}}
\caption{Example of a Stepped Lighting Control System with Three Steps \protect \label{table:stepped-lighting-control-example-001}}\\
\toprule 
Daylight illuminance & Fraction of lights that are on \tabularnewline \midrule
\endhead
0-200 & 1.0 \tabularnewline
...
\paragraph{\texorpdfstring{Tubular Daylighting Device Diffuse Visible Transmittance {[]}}{Tubular Daylighting Device Diffuse Visible Transmittance }}\label{tubular-daylighting-device-diffuse-visible-transmittance}
