...
\paragraph{\texorpdfstring{Availability Manager Scheduled On Control Status \protect\hyperlink{section-1}{}}{Availability Manager Scheduled On Control Status }}\label{availability-manager-scheduled-on-control-status}
...
\paragraph{\texorpdfstring{Availability Manager Scheduled Off Control Status \protect\hyperlink{section-1}{}}{Availability Manager Scheduled Off Control Status }}\label{availability-manager-scheduled-off-control-status}
...
The possible inputs are \emph{StayOff}, \emph{CycleOnAny}, \emph{CycleOnControlZone}, \emph{CycleOnAnyZoneFansOnly}. \emph{StayOff} means the availability manager will have no effect air handler on/off will be determined by the fan schedule. \emph{CycleOnAny} means that if any zone served by a system whose AvailabilityManagerAssignmentList references this system availability manager has an air temperature outside the cooling or heating set points the central fan will turn on even though the fan schedule indicates the fan is off. \emph{CycleOnControlZone} means the same thing except the availability manager looks at the temperature in only one zone. \emph{CycleOnAnyZoneFansOnly} is the same as \emph{CycleOnAny} except that only the zone fans are cycled on and the central air handler fan is left off. The default is \emph{StayOff}.
...
\textbf{\emph{Field: Control Zone Name}}

For the option \emph{CycleOnControlZone} this is the name of the control zone.
...
\paragraph{\texorpdfstring{Availability Manager High Temperature Turn Off Control Status \protect\hyperlink{section-1}{}}{Availability Manager High Temperature Turn Off Control Status }}\label{availability-manager-high-temperature-turn-off-control-status}
...
\paragraph{\texorpdfstring{Availability Manager High Temperature Turn On Control Status \protect\hyperlink{section-1}{}}{Availability Manager High Temperature Turn On Control Status }}\label{availability-manager-high-temperature-turn-on-control-status}
...
Availability Manager Low Temperature Turn Off Control Status \protect\hyperlink{section-1}{}
...
\tightlist
\item
  HVAC,Average,Availability Manager Low Temperature Turn On Control Status \protect\hyperlink{section-1}{}
\end{itemize}

\paragraph{\texorpdfstring{Availability Manager Low Temperature Turn On Control Status \protect\hyperlink{section-1}{}}{Availability Manager Low Temperature Turn On Control Status }}\label{availability-manager-low-temperature-turn-on-control-status}
...
\tightlist
\item
  HVAC,Average,Availability Manager Night Ventilation Control Status \protect\hyperlink{section-1}{}
\end{itemize}

\paragraph{\texorpdfstring{Availability Manager Night Ventilation Control Status \protect\hyperlink{section-1}{}}{Availability Manager Night Ventilation Control Status }}\label{availability-manager-night-ventilation-control-status}
...
HVAC,Average,Availability Manager Hybrid Ventilation Control Mode \protect\hyperlink{section-1}{}

HVAC,Average,Availability Manager Hybrid Ventilation Control Status \protect\hyperlink{section-1}{}

\paragraph{\texorpdfstring{Availability Manager Hybrid Ventilation Control Mode \protect\hyperlink{section-1}{}}{Availability Manager Hybrid Ventilation Control Mode }}\label{availability-manager-hybrid-ventilation-control-mode}

This is the hybrid ventilation control mode given in the Ventilation Control Mode Schedule.

\paragraph{\texorpdfstring{Availability Manager Hybrid Ventilation Control Status \protect\hyperlink{section-1}{}}{Availability Manager Hybrid Ventilation Control Status }}\label{availability-manager-hybrid-ventilation-control-status}
