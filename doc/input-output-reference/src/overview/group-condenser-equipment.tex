...
\paragraph{\texorpdfstring{Cooling Tower Fan Cycling Ratio {[]}}{Cooling Tower Fan Cycling Ratio }}\label{cooling-tower-fan-cycling-ratio}

This represents the fraction of a time-step when tower fan is on.

\paragraph{\texorpdfstring{Cooling Tower Bypass Fraction {[]}}{Cooling Tower Bypass Fraction }}\label{cooling-tower-bypass-fraction}
...
\paragraph{\texorpdfstring{Cooling Tower Operating Cells Count {[]}}{Cooling Tower Operating Cells Count }}\label{cooling-tower-operating-cells-count}
...
\paragraph{\texorpdfstring{Cooling Tower Fan Cycling Ratio {[]}}{Cooling Tower Fan Cycling Ratio }}\label{cooling-tower-fan-cycling-ratio-1}

This represents the fraction of a time-step when tower fan is on. The fan can cycle at both speeds.

\paragraph{\texorpdfstring{Cooling Tower Operating Cells Count {[]}}{Cooling Tower Operating Cells Count }}\label{cooling-tower-operating-cells-count-1}

This represents the number of cells operating at each time step.

\paragraph{\texorpdfstring{Cooling Tower Fan Speed Level {[]}}{Cooling Tower Fan Speed Level }}\label{cooling-tower-fan-speed-level}
...
\paragraph{\texorpdfstring{Cooling Tower Operating Cells Count {[]}}{Cooling Tower Operating Cells Count }}\label{cooling-tower-operating-cells-count-2}
...
\paragraph{\texorpdfstring{Cooling Tower Fan Part Load Ratio {[]}}{Cooling Tower Fan Part Load Ratio }}\label{cooling-tower-fan-part-load-ratio}
...
\paragraph{\texorpdfstring{Cooling Tower Air Flow Rate Ratio {[]}}{Cooling Tower Air Flow Rate Ratio }}\label{cooling-tower-air-flow-rate-ratio}
...
\paragraph{\texorpdfstring{Cooling Tower Operating Cells Count {[]}}{Cooling Tower Operating Cells Count }}\label{cooling-tower-operating-cells-count-3}
...
\paragraph{\texorpdfstring{Cooling Tower Bypass Fraction {[]}}{Cooling Tower Bypass Fraction }}\label{cooling-tower-bypass-fraction-1}
...
\paragraph{\texorpdfstring{Fluid Heat Exchanger Effectiveness {[]}}{Fluid Heat Exchanger Effectiveness }}\label{fluid-heat-exchanger-effectiveness}
