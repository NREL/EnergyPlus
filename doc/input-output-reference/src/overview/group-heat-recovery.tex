...
\begin{figure}[htbp]
\centering
\includegraphics{media/image423.svg}
\caption{}
\end{figure}
...
\caption{Typical threshold temperatures \protect \label{table:typical-threshold-temperatures}}\\
\toprule 
Frost Control Type & Heat Exchanger Type & Energy Exchange & Threshold Temperature \tabularnewline \midrule
\endhead
Exhaust Air Recirculation & Plate & Sensible-only & -1.1°C (30°F) \tabularnewline
Sensible + latent & -12.2°C (10°F) \tabularnewline
Rotary & Sensible-only & -12.2°C (10°F) \tabularnewline
Sensible + latent & -12.2°C (10°F) \tabularnewline
Exhaust Only & Plate & Sensible-only & -23.3°C (-10°F) \tabularnewline
Sensible + latent & -1.1°C (30°F) \tabularnewline
Rotary & Sensible-only & -12.2°C (10°F) \tabularnewline
Sensible + latent & -12.2°C (10°F) \tabularnewline
Minimum Exhaust Temperature & Plate & Sensible-only & -23.3°C (-10°F) \tabularnewline
Sensible + latent & 1.7°C (35°F) \tabularnewline
Rotary & Sensible-only & 1.7°C (35°F) \tabularnewline
Sensible + latent & 1.7°C (35°F) \tabularnewline
Preheat ** & Plate & Sensible-only & 1.7°C (35°F) \tabularnewline
Sensible + latent & -1.1°C (30°F) \tabularnewline
Rotary & Sensible-only & -12.2°C (10°F) \tabularnewline
Sensible + latent & -23.3°C (-10°F) \tabularnewline
\bottomrule
\end{longtable}
...
\begin{lstlisting}
       Rate of Defrost Time Fraction Increase \* (T$_{d}$     T$_{t}$)
\end{lstlisting}
...
\paragraph{\texorpdfstring{Heat Exchanger Sensible Effectiveness {[]}}{Heat Exchanger Sensible Effectiveness }}\label{heat-exchanger-sensible-effectiveness}
...
\paragraph{\texorpdfstring{Heat Exchanger Latent Effectiveness {[]}}{Heat Exchanger Latent Effectiveness }}\label{heat-exchanger-latent-effectiveness}
...
\paragraph{\texorpdfstring{Heat Exchanger Defrost Time Fraction {[]}}{Heat Exchanger Defrost Time Fraction }}\label{heat-exchanger-defrost-time-fraction}
