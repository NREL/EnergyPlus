...
\begin{itemize}
\item
  HVAC, Average, Operation Mode {[}{]}
\item
  HVAC, Average, Air Loop Flow Rate {[}kg/s{]}
\item
  HVAC, Average, Condenser Water Flow Rate {[}kg/s{]}
\item
  HVAC, Average, Cooling Coil Total Cooling Rate {[}W{]}
\item
  HVAC, Average, Heating Coil Total Air Heating Rate {[}W{]}
\item
  HVAC, Average, Total Water Heating Rate {[}W{]}
\item
  HVAC, Average, Total Electric Power {[}W{]}
\item
  HVAC, Average, Total Latent Cooling Rate {[}W{]}
\item
  HVAC, Average, Total Source Energy Rate {[}W{]}
 \item
  HVAC, Average, Total Coefficient of Performance (COP) {[}{]}
 \item
  HVAC, Sum, Total Electric Energy {[}J{]}
 \item
  HVAC, Sum, Total Cooling Energy {[}J{]}
  \item
  HVAC, Sum, Total Air Heating Energy {[}J{]}
\item
  HVAC, Sum, Total Water Heating Energy {[}J{]}
 \item
  HVAC, Sum, Total Latent Cooling Energy {[}J{]}
 \item
  HVAC, Sum, Total Source Energy {[}J{]}

\end{itemize}

\paragraph{Operation Mode {[}{]}}\label{Opt-Mod-ASIHP}

This output variable is an integer representing the operation mode in the timestep.

\paragraph{Air Loop Flow Rate {[}kg/s{]}}\label{Out-Air-Loop-Flow-Rate-ASIHP}
The output variable is the air mass flow rate in the indoor air loop, over the timestep being reported. 

\paragraph{Condenser Water Flow Rate {[}kg/s{]}}\label{Out-Cond-water-Flow-ASIHP}
...
\paragraph{Cooling Coil Total Cooling Rate {[}W{]}}\label{Out-Cooling-Coil-Total-Cooling-Rate-ASIHP}
...
\paragraph{Heating Coil Total Air Heating Rate {[}W{]}}\label{Out-Heating-Total-Air-Heating-Rate-ASIHP}
...
\paragraph{Total Water Heating Rate {[}W{]}}\label{Out-Total-Water-Heating-Rate-ASIHP}
...
\paragraph{Total Electric Power {[}W{]}}\label{Out-Total-Electric-Power-ASIHP}
...
\paragraph{Total Latent Cooling Rate {[}W{]}}\label{Out-Total-Latent-Cooling-Rate-ASIHP}
...
\paragraph{Total Source Energy Rate {[}W{]}}\label{Out-Total-Source-Energy-Rate-ASIHP}
...
\paragraph{Total COP {[}{]}}\label{Out-Tot-COP-ASIHP}
...
\paragraph{Total Electric Energy {[}J{]}}\label{Out-Total-Electric-Energy-ASIHP}

The output variable is the electric consumption of the integrated heat pump in joules over the timestep being reported. 


\paragraph{Total Cooling Energy {[}J{]}}\label{Out-Total-Cooling-Energy-ASIHP}
...
\paragraph{Total Air Heating Energy {[}J{]}}\label{Out-Total-Air-Heating-Energy-ASIHP}
...
\paragraph{Total Water Heating Energy{[}J{]}}\label{Out-Total-WH-Energy-ASIHP}
...
\paragraph{Total Latent Cooling Energy {[}J{]}}\label{Out-Total-LatCooling-Energy-ASIHP}
...
\paragraph{Total Source Energy {[}J{]}}\label{Out-Total-Source-Energy-ASIHP}
