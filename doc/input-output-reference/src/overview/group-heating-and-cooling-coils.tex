...
EnergyPlus can model a heat pump water heater (HPWH) consisting of a water heater tank (e.g., \hyperref[waterheatermixed]{\listinline!WaterHeater:Mixed!}), a direct expansion (DX) coil (i.e., an air-to-water DX compression system which includes a water heating coil, air coil, compressor, and water pump), and a fan to provide air flow across the air coil associated with the DX compression system. These objects work together to model a system which heats water using zone air, outdoor air, or a combination of zone and outdoor air as the primary heat source.
...
This alpha field defines a unique user-assigned name for an instance of a heat pump water heater DX coil. Any reference to this coil by another object (e.g., \hyperref[waterheaterheatpumppumpedcondenser]{\listinline!WaterHeater:HeatPump:PumpedCondenser!}) will use this name.
...
EnergyPlus can model a heat pump water heater (HPWH) consisting of a water heater tank (e.g., \hyperref[waterheaterstratified]{\listinline!WaterHeater:Stratified!}), a direct expansion (DX) coil (i.e., an air-to-water DX compression system which includes a water heating coil, air coil, compressor, and water pump), and a fan to provide air flow across the air coil associated with the DX compression system. These objects work together to model a system which heats water using zone air, outdoor air, or a combination of zone and outdoor air as the primary heat source.
...
This alpha field defines a unique user-assigned name for an instance of a heat pump water heater DX coil. Any reference to this coil by another object (e.g., \hyperref[waterheaterheatpumpwrappedcondenser]{\listinline!WaterHeater:HeatPump:WrappedCondenser!}) will use this name.
