...
\begin{itemize}
\item
  HVAC, Average, Integrated Heat Pump Air Loop Flow Rate {[}kg/s{]}
\item
  HVAC, Average, Integrated Heat Pump Condenser Water Flow Rate {[}kg/s{]}
\item
...
\item
  HVAC, Average, Integrated Heat Pump Source Energy Rate {[}W{]}
 \item
...
\item
 ...
 \item
  HVAC, Sum, Integrated Heat Pump Source Energy {[}J{]}

\end{itemize}

\paragraph{Integrated Heat Pump Air Loop Flow Rate {[}kg/s{]}}\label{Out-Air-Loop-Flow-Rate-ASIHP}
The output variable is the air mass flow rate in the indoor air loop, over the timestep being reported. 

\paragraph{Integrated Heat Pump Condenser Water Flow Rate {[}kg/s{]}}\label{Out-Cond-water-Flow-ASIHP}
...
\paragraph{Integrated Heat Pump Source Energy Rate {[}W{]}}\label{Out-Total-Source-Energy-Rate-ASIHP}
...
\paragraph{Integrated Heat Pump Source Energy {[}J{]}}\label{Out-Total-Source-Energy-ASIHP}
