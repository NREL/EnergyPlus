...
\item
  Zone,Sum,Demand Manager Exterior Energy Iteration Count \protect\hyperlink{section-1}{}
\item
  Zone,Sum,Demand Manager Heat Balance Iteration Count \protect\hyperlink{section-1}{}
\item
  Zone,Sum,Demand Manager HVAC Iteration Count \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{Demand Manager Exterior Energy Iteration Count \protect\hyperlink{section-1}{}}{Demand Manager Exterior Energy Iteration Count }}\label{demand-manager-exterior-energy-iteration-count}

The number times that the exterior energy use was resimulated for demand limiting.

\paragraph{\texorpdfstring{Demand Manager Heat Balance Iteration Count \protect\hyperlink{section-1}{}}{Demand Manager Heat Balance Iteration Count }}\label{demand-manager-heat-balance-iteration-count}

The number times that the zone heat balance was resimulated for demand limiting.

\paragraph{\texorpdfstring{Demand Manager HVAC Iteration Count \protect\hyperlink{section-1}{}}{Demand Manager HVAC Iteration Count }}\label{demand-manager-hvac-iteration-count}
