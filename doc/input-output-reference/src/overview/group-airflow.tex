...
\begin{itemize}
\item
  Zone,Sum,Infiltration Sensible Heat Loss Energy {[}J{]}
\item
  Zone,Sum,Infiltration Sensible Heat Gain Energy {[}J{]}
\item
  Zone,Sum,Infiltration Latent Heat Loss Energy {[}J{]}
\item
  Zone,Sum,Infiltration Latent Heat Gain Energy {[}J{]}
\item
  Zone,Sum,Infiltration Total Heat Loss Energy {[}J{]}
\item
  Zone,Sum,Infiltration Total Heat Gain Energy {[}J{]}
\item
  Zone,Average,Infiltration Current Density Volume Flow Rate {[}m3/s{]}
\item
  Zone,Average,Infiltration Standard Density Volume Flow Rate {[}m3/s{]}
\item
  Zone,Sum,Infiltration Current Density Volume {[}m3{]}
\item
  Zone,Sum,Infiltration Standard Density Volume {[}m3{]}
\item
  Zone,Sum,Infiltration Mass {[}kg{]}
\item
  Zone,Sum,Infiltration Mass Flow Rate {[}kg/s{]}
\item
  Zone,Average,Infiltration Air Change Rate {[}ach{]}
\end{itemize}
