...
\item
  HVAC,Average,Earth Tube Upper Boundary Ground Temperature {[}C{]}
\item
  HVAC,Average,Earth Tube Lower Boundary Ground Temperature {[}C{]}
\end{itemize}
...
\paragraph{Earth Tube Undisturbed Ground Temperatures {[}C{]}}\label{earth-tube-undisturbed-node-temperatures}
...
\paragraph{Earth Tube Upper Boundary Ground Temperature {[}C{]}}\label{earth-tube-upper-boundary-temperature}
...
\paragraph{Earth Tube Lower Boundary Ground Temperature {[}C{]}}\label{earth-tube-upper-boundary-temperature}
