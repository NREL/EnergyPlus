...
\paragraph{Field: Flow per Floor Area}\label{field-flow-per-zone-floor-area}
...
With this choice, the method used will be a factor per floor area of the zone or space. (The Flow per Floor Area field should be filled).
...
\paragraph{Field: Flow per Floor Area}\label{field-flow-rate-per-zone-floor-area}
...
\paragraph{Field: Flow per Person}\label{field-flow-rate-per-person}
