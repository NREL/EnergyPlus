...
This element sets up the parameters to simulate each space within a thermal zone of the building.
...
The name of the SpaceList object. Must be unique across SpaceLists.

\paragraph{Field: Space \textless{}\#\textgreater{} Name}\label{field-space-name}

Reference to a Space object. This object is extensible, so additional fields of this type can be added to the end of this object.
