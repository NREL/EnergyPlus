...
The Zone Air Heat Balance Internal Convective Heat Gain Rate is the sum, in watts, of heat transferred to the zone air from all types of internal gains from energyplus objects (e.g., people, lights, devices, appliances, equipment) listed in Table \ref{table:space-or-zone-air-heat-balance-internal-convective-heat-gain-constituents}. This and the following provide results on the load components of the zone air heat balance. This field is not multiplied by zone or group multipliers.
...
\begin{longtable}[c]{@{}lcc@{}}
	...
	Pump:VariableSpeed     &     Pump_VarSpeed    \tabularnewline
	Pump:ConstantSpeed     &     Pump_ConSpeed    \tabularnewline
	Pump:VariableSpeed:Condensate     &     Pump_Cond    \tabularnewline
	HeaderedPumps:VariableSpeed     &     PumpBank_VarSpeed    \tabularnewline
	HeaderedPumps:ConstantSpeed     &     PumpBank_ConSpeed    \tabularnewline
