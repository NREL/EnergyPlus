...
6)~~~~\textbf{GroundFCfactorMethod} -- if this surface is exposed to the ground and using the \textbf{Construction:CfactorUndergroundWall}, then this is the choice. The temperature on the outside of this surface will be the Site:GroundTemperature:FcfactorMethod value for the month.
...
5)~~~\textbf{Ground} -- if this surface is exposed to the ground, then this is the choice. The temperature on the outside of this surface will be the Ground Temperature.

6)~~~\textbf{OtherSideCoefficients} -- if this surface has a custom, user specified temperature or other parameters (See SurfaceProperty:OtherSideCoefficients specification), then this is the choice. The outside boundary condition will be the name of the SurfaceProperty:OtherSideCoefficients specification.

7)~~~\textbf{OtherSideConditionsModel} -- if this surface has a specially-modeled multi-skin component, such as a transpired collector or vented photovoltaic panel, attached to the outside (See SurfaceProperty:OtherSideConditionsModel specification), then this the choice. The outside face environment will be the name of the SurfaceProperty:OtherSideConditionsModelspecification.

8)~~~\textbf{GroundSlabPreprocessorAverage} -- uses the average results from the Slab preprocessor calculations.

9)~~~\textbf{GroundSlabPreprocessorCore} -- uses the core results from the Slab preprocessor calculations.

10)\textbf{GroundSlabPreprocessorPerimeter} -- uses the perimeter results from the Slab preprocessor calculations.

11)\textbf{GroundBasementPreprocessorAverageWall} -- uses the average wall results from the Basement preprocessor calculations.

12)\textbf{GroundBasementPreprocessorAverageFloor} -- uses the average floor results from the Basement preprocessor calculations.

13)\textbf{GroundBasementPreprocessorUpperWall} -- uses the upper wall results from the Basement preprocessor calculations.

14)\textbf{GroundBasementPreprocessorLowerWall} -- uses the lower wall results from the Basement preprocessor calculations.
...
\caption{Window Modeling Options \protect \label{table:window-modeling-options}}\\
\toprule 
Option & Object/Field or Output Variable & Input File (distributed with install) \tabularnewline \midrule
\endhead
...
\subsubsection{\texorpdfstring{Surface Inside Face Heat Balance Calculation Iteration Count \protect\hyperlink{section-1}{}}{Surface Inside Face Heat Balance Calculation Iteration Count }}\label{surface-inside-face-heat-balance-calculation-iteration-count}
...
\subsubsection{\texorpdfstring{Surface Outside Face Sunlit Fraction \protect\hyperlink{section-1}{}}{Surface Outside Face Sunlit Fraction }}\label{surface-outside-face-sunlit-fraction}
...
\subsubsection{\texorpdfstring{Surface Outside Face Beam Solar Incident Angle Cosine Value \protect\hyperlink{section-1}{}}{Surface Outside Face Beam Solar Incident Angle Cosine Value }}\label{surface-outside-face-beam-solar-incident-angle-cosine-value}
...
\subsubsection{\texorpdfstring{Surface Anisotropic Sky Multiplier \protect\hyperlink{section-1}{}}{Surface Anisotropic Sky Multiplier }}\label{surface-anisotropic-sky-multiplier}
...
\subsubsection{\texorpdfstring{Surface Window BSDF Beam Direction Number \protect\hyperlink{section-1}{}}{Surface Window BSDF Beam Direction Number }}\label{surface-window-bsdf-beam-direction-number}
...
\subsubsection{\texorpdfstring{Surface Window System Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window System Solar Transmittance }}\label{surface-window-system-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window System Solar Absorptance \protect\hyperlink{section-1}{}}{Surface Window System Solar Absorptance }}\label{surface-window-system-solar-absorptance}
...
\subsubsection{\texorpdfstring{Surface Window System Solar Reflectance \protect\hyperlink{section-1}{}}{Surface Window System Solar Reflectance }}\label{surface-window-system-solar-reflectance}
...
\subsubsection{\texorpdfstring{Surface Window Glazing Beam to Beam Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Glazing Beam to Beam Solar Transmittance }}\label{surface-window-glazing-beam-to-beam-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Glazing Beam to Diffuse Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Glazing Beam to Diffuse Solar Transmittance }}\label{surface-window-glazing-beam-to-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Glazing Diffuse to Diffuse Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Glazing Diffuse to Diffuse Solar Transmittance }}\label{surface-window-glazing-diffuse-to-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Model Solver Iteration Count \protect\hyperlink{section-1}{}}{Surface Window Model Solver Iteration Count }}\label{surface-window-model-solver-iteration-count}
...
\subsubsection{\texorpdfstring{Surface Window Inside Face Glazing Condensation Status \protect\hyperlink{section-1}{}}{Surface Window Inside Face Glazing Condensation Status }}\label{surface-window-inside-face-glazing-condensation-status}
...
\subsubsection{\texorpdfstring{Surface Window Inside Face Frame Condensation Status \protect\hyperlink{section-1}{}}{Surface Window Inside Face Frame Condensation Status }}\label{surface-window-inside-face-frame-condensation-status}
...
\subsubsection{\texorpdfstring{Surface Window Inside Face Divider Condensation Status \protect\hyperlink{section-1}{}}{Surface Window Inside Face Divider Condensation Status }}\label{surface-window-inside-face-divider-condensation-status}
...
\subsubsection{\texorpdfstring{Surface Shading Device Is On Time Fraction \protect\hyperlink{section-1}{}}{Surface Shading Device Is On Time Fraction }}\label{surface-shading-device-is-on-time-fraction}
...
\subsubsection{\texorpdfstring{Surface Window Blind Beam to Beam Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Blind Beam to Beam Solar Transmittance }}\label{surface-window-blind-beam-to-beam-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Blind Beam to Diffuse Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Blind Beam to Diffuse Solar Transmittance }}\label{surface-window-blind-beam-to-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Blind Diffuse to Diffuse Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Blind Diffuse to Diffuse Solar Transmittance }}\label{surface-window-blind-diffuse-to-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Blind and Glazing System Beam Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Blind and Glazing System Beam Solar Transmittance }}\label{surface-window-blind-and-glazing-system-beam-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Blind and Glazing System Diffuse Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Blind and Glazing System Diffuse Solar Transmittance }}\label{surface-window-blind-and-glazing-system-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Screen Beam to Beam Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Screen Beam to Beam Solar Transmittance }}\label{surface-window-screen-beam-to-beam-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Screen Beam to Diffuse Solar Transmittance\protect\hyperlink{section-1}{}}{Surface Window Screen Beam to Diffuse Solar Transmittance}}\label{surface-window-screen-beam-to-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Screen Diffuse to Diffuse Solar Transmittance\protect\hyperlink{section-1}{}}{Surface Window Screen Diffuse to Diffuse Solar Transmittance}}\label{surface-window-screen-diffuse-to-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Screen and Glazing System Beam Solar Transmittance\protect\hyperlink{section-1}{}}{Surface Window Screen and Glazing System Beam Solar Transmittance}}\label{surface-window-screen-and-glazing-system-beam-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Window Screen and Glazing System Diffuse Solar Transmittance \protect\hyperlink{section-1}{}}{Surface Window Screen and Glazing System Diffuse Solar Transmittance }}\label{surface-window-screen-and-glazing-system-diffuse-solar-transmittance}
...
\subsubsection{\texorpdfstring{Surface Storm Window On Off Status \protect\hyperlink{section-1}{}}{Surface Storm Window On Off Status }}\label{surface-storm-window-on-off-status}
...
\subsection{Thermochomic Window Outputs}\label{thermochomic-window-outputs}
...
\subsubsection{\texorpdfstring{Surface Window Switchable Glazing Switching Factor\protect\hyperlink{section-1}{}}{Surface Window Switchable Glazing Switching Factor}}\label{surface-window-switchable-glazing-switching-factor}
...
\subsubsection{\texorpdfstring{Surface Window Switchable Glazing Visible Transmittance\protect\hyperlink{section-1}{}}{Surface Window Switchable Glazing Visible Transmittance}}\label{surface-window-switchable-glazing-visible-transmittance}
...
\emph{ExteriorScreen}: An insect screen is on the outside of the window. (In the shaded Construction the shadling layer must be a WindowMaterial:Screen.)
...
\textbf{Note: When using method 4, the overall glazing system angular dependent properties, including Tsol, Abs, Rfsol, Rbsol, Tvis, Rfvis, and Rbvis, are not used by EnergyPlus. Therefore, methods 1 and 2 and preferably 3 are recommended.}
