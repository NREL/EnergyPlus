...
This output reports the actual wind direction at the outside face of a surface.  This value may be different from the site wind direction when using OutdoorAir:Node with SurfaceProperty:LocalEnvironment or ZoneProperty:LocalEnvironment. It can also be modified using EMS.
