...
For each Zone, the calculated floor area is the sum of the space floor areas belonging to the zone. If the input for \hyperref[field-floor-area]{Zone Floor Area} differs from the sum of the space floor areas, the zone floor area will take precedence. A warning message will be issued, and the space floor areas will be adjusted proportionately.
