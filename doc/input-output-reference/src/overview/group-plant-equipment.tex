...
For the input field for object HeatPump:AirToWater:FuelFired:Cooling coil, this field will be ``Companion Heaigng Heat Pump Name'' instead.
...
The design supply temperature on the water side in degree [C].

\paragraph{Field: Design Temperature Lift}

The design temperature difference between the outlet water node and the inlet water node, in degree [C].
...
\paragraph{Fuel-fired Absorption HeatPump Load Side Heating Transfer Rate [W]}
