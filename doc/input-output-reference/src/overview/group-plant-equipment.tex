...
This alpha value specifies the type of fuel used in the engine. The fuel type can be NaturalGas, Propane, Diesel, Gasoline, FuelOil1, FuelOil2, OtherFuel1 or OtherFuel2. This field is required.
...
This alpha field determines the type of fuel that the chiller uses. Valid choices are: \textbf{NaturalGas, Propane, Diesel, Gasoline, FuelOil1, FuelOil2, OtherFuel1} or \textbf{OtherFuel2}. The default is \textbf{NaturalGas}.
...
This alpha field determines the type of fuel that the chiller uses. The default is \textbf{NaturalGas}. Valid values are \textbf{NaturalGas}, \textbf{Propane}, \textbf{Diesel}, \textbf{Gasoline}, \textbf{FuelOil1}, \textbf{FuelOil2, OtherFuel1, OtherFuel2}.
...
This required choice field specifies the type of fuel used by the boiler. The fuel type can be \textbf{Electricity, NaturalGas, Propane, FuelOil1, FuelOil2, Coal, Diesel, Gasoline, OtherFuel1} or \textbf{OtherFuel2}.
...
This alpha value specifies the type of fuel used by the boiler. The fuel type can be \textbf{Electricity, NaturalGas, Propane, FuelOil1, FuelOil2, Coal, Diesel, Gasoline, OtherFuel1} or \textbf{OtherFuel2.}
