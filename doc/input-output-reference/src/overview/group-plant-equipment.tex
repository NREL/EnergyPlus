...
\subsubsection{Inputs}\label{}

\paragraph{Field: Name}\label{}
...
Use if the auxiliary components of the chiller use an external cooling loop, otherwise the auxiliary components will add heat to the ambient conditions (i.e., they are air cooled).

\paragraph{Field: Auxiliary Outlet Node Name}\label{field-chiller205-auxiliary-outlet-node-name}

This alpha field is used if the auxiliary equipment uses an external cooling loop, otherwise the oil cooler will add heat to the ambient conditions (i.e., it is air cooled).
...
This is the miminum capacity ratio, under which the chiller cycling occurs.
...
\paragraph{Chiller Heat Rejected to Zone {[}W{]}}\label{chiller-heat-rejected-to-zone}

\paragraph{Oil Cooler Heat {[}W{]}}\label{chiller205-oil-cooler-heat}

Heat generated by the oil cooler, as determined by the performance data.

\paragraph{Oil Cooler Energy {[}J{]}}\label{chiller205-oil-cooler-energy}

Energy used by the oil cooler, as determined by the performance data.

\paragraph{Auxiliary Heat {[}W{]}}\label{chiller205-auxiliary-heat}

Heat generated by the auxiliary equipment, as determined by the performance data.

\paragraph{Auxiliary Energy {[}J{]}}\label{chiller205-auxiliary-energy}
...
\paragraph{Heat Pump Source Side Outlet Temperature {[}°C{]}}\label{plhp_eir_outputs_t_source_out}
