...
\item[$Eff$] is normalized boiler efficiency.
\item[$PLR$] is boiler part-load ratio.
\item[$T_w$] is boiler water temperature in Celcius, this can be either entering or leaving temperature depending on the setting in the previous field.
\end{description}
