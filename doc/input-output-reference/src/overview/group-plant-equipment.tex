...
\paragraph{Heat Pump Electric Energy {[}J{]}}\label{water-to-water-heat-pump-electric-energy-j}
...
\paragraph{Heat Pump Electric Power {[}W{]}}\label{water-to-water-heat-pump-electric-power-w}
...
\paragraph{Heat Pump Electric Power {[}W{]}}\label{water-to-water-heat-pump-electric-power-w-1}

This output variable represents the compressor power required to run the heat pump. The values are calculated for each HVAC system time step being simulated, and the results are averaged for the time step being reported.

\paragraph{Heat Pump Electric Energy {[}J{]}}\label{water-to-water-heat-pump-electric-energy-j-1}
...
\paragraph{Heat Pump Electric Power {[}W{]}}\label{plhp_eir_outputs_power_usage}

This output variable represents the average power usage of this coil during the specified reporting window.

\paragraph{Heat Pump Electric Energy {[}J{]}}\label{plhp_eir_outputs_energy_usage}
