...
\begin{itemize}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Electric Power {[}W{]}
\item
  HVAC,Sum,Plant Loop EIR Heat Pump Electric Energy {[}J{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Load Side Heat Transfer Rate {[}W{]}
\item
  HVAC,Sum,Plant Loop EIR Heat Pump Load Side Heat Transfer Energy {[}J{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Source Side Heat Transfer Rate {[}W{]}
\item
  HVAC,Sum,Plant Loop EIR Heat Pump Source Side Heat Transfer Energy {[}J{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Load Side Inlet Temperature {[}°C{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Load Side Outlet Temperature {[}°C{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Source Side Inlet Temperature {[}°C{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Source Side Outlet Temperature {[}°C{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Load Side Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,Plant Loop EIR Heat Pump Source Side Mass Flow Rate {[}kg/s{]}
\end{itemize}

\paragraph{Plant Loop EIR Heat Pump Electric Power {[}W{]}}\label{plhp_eir_outputs_power_usage}

This output variable represents the average power usage of this coil during the specified reporting window.

\paragraph{Plant Loop EIR Heat Pump Electric Energy {[}J{]}}\label{plhp_eir_outputs_energy_usage}

This output variable represents the summed energy usage of the heat pump over a specified reporting window.

\paragraph{Plant Loop EIR Heat Pump Load Side Heat Transfer Rate {[}W{]}}\label{plhp_eir_outputs_q_load}

This output variable represents the average load side heat transfer during the specified output reporting window.

\paragraph{Plant Loop EIR Heat Pump Load Side Heat Transfer Energy {[}J{]}}\label{plhp_eir_outputs_q_load_sum}

This output variable represents the summed load side heat transfer during the specified output reporting window.

\paragraph{Plant Loop EIR Heat Pump Source Side Heat Transfer Rate {[}W{]}}\label{plhp_eir_outputs_q_source}
...
\paragraph{Plant Loop EIR Heat Pump Source Side Heat Transfer Energy {[}J{]}}\label{plhp_eir_outputs_q_src_sum}

This output variable represents the summed source side heat transfer during the specified output reporting window.

\paragraph{Plant Loop EIR Heat Pump Load Side Inlet Temperature {[}°C{]}}\label{plhp_eir_outputs_t_load_in}

This output variable represents the inlet temperature on the load side connection of this coil.

\paragraph{Plant Loop EIR Heat Pump Load Side Outlet Temperature {[}°C{]}}\label{plhp_eir_outputs_t_load_out}

This output variable represents the outlet temperature on the load side connection of this coil.

\paragraph{Plant Loop EIR Heat Pump Source Side Inlet Temperature {[}°C{]}}\label{plhp_eir_outputs_t_source_in}

This output variable represents the inlet temperature on the source side connection of this coil.

\paragraph{Plant Loop EIR Heat Pump Source Side Outlet Temperature {[}°C{]}}\label{plhp_eir_outputs_t_source_out}

This output variable represents the outlet temperature on the source side connection of this coil.

\paragraph{Plant Loop EIR Heat Pump Load Side Mass Flow Rate {[}kg/s{]}}\label{plhp_eir_outputs_load_flow}

This output variable represents the average load side mass flow rate during the specified reporting window.

\paragraph{Plant Loop EIR Heat Pump Source Side Mass Flow Rate {[}kg/s{]}}\label{plhp_eir_outputs_src_flow}
