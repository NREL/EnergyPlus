...
\paragraph{Field: Control Type}\label{plhp_eir_inputs_control_type}

This optional choice field allows the user to choose between Load and Setpoint control. The default value is Load control.

\paragraph{Field: Flow Mode}\label{plhp_eir_inputs_flow_mode}
...
\paragraph{Field: Minimum Part Load Ratio}\label{plhp_eir_inputs_minimum_part_load_ratio}
...
\paragraph{Field: Minimum Source Inlet Temperature}\label{plhp_eir_inputs_minimum_source_inlet_temperature}
...
\paragraph{Field: Maximum Source Inlet Temperature}\label{plhp_eir_inputs_maximum_source_inlet_temperature}
...
\paragraph{Field: Minimum Supply Water Temperature Curve Name}\label{plhp_eir_inputs_minimum_supply_water_temperature_curve_name}

This optional numeric field specifies the name of a univariate curve or table that defines the minimum supply water temperature.

\paragraph{Field: Maximum Supply Water Temperature Curve Name}\label{plhp_eir_inputs_maximum_supply_water_temperature_curve_name}

This optional field specifies the name of a univariate curve or table that defines the maximum supply water temperature.


Fields specific to the HeatPump:PlantLoop:EIR:Heating object are described here:

\paragraph{Field: Heating To Cooling Capacity Sizing Ratio}\label{plhp_eir_inputs_heating_to_cooling_capacity_sizing_ratio}
...
\paragraph{Field: Heat Pump Sizing Method}\label{plhp_eir_inputs_heat_pump_sizing_method}

This optional choice field specifies whether the heat pump is sized based on the cooling plant, the heating plant load, or the larger of these values. Valid choices are CoolingCapacity, HeatingCapacity or GreaterOfHeatingOrCooling. The default value is CoolingCapacity.

\paragraph{Field: Dry Outdoor Correction Factor Curve Name}\label{plhp_eir_inputs_dry_outdoor_correction_factor_curve_name}
...
\paragraph{Field: Maximum Outdoor Dry Bulb Temperature For Defrost Operation}\label{plhp_eir_inputs_max_oat_for_defrost_operation}
...
\paragraph{Field: Heat Pump Defrost Control}\label{plhp_eir_inputs_heat_pump_defrost_control}

This optional choice field specifies the defrost model as Timed, OnDemand, or TimedEmpirical. The default value is Timed.

\paragraph{Field: Heat Pump Defrost Time Period Fraction}\label{plhp_eir_inputs_heat_pump_defrost_time_period_fraction}
...
\paragraph{Field: Defrost Energy Input Ratio Function of Temperature Curve Name}\label{plhp_eir_inputs_defrost_eir_function_temp_curve_name}
...
The reminaing 3 fields applies only to TimedEmiprical defrost control method.

\paragraph{Field: Timed Empirical Defrost Frequency Curve Name}\label{plhp_eir_inputs_timed_empirical_defrost_frequency_curve_name}
...
\paragraph{Field: Timed Empirical Defrost Heat Load Penalty Curve Name}\label{plhp_eir_inputs_timed_empirical_defrost_heat_load_curve_name}
...
\paragraph{Field: Timed Empirical Defrost Heat Input Energy Fraction Curve Name}\label{plhp_eir_inputs_timed_empirical_defrost_heat_energy_fraction_curve_name}
