...
This optional numeric field specifies the maximum hot-water temperature leaving the chiller-heater in heating mode in Celsius. When the field is blank, the model does not infer an equipment operating limit from the Reference Heating Mode Leaving Condenser Water Temperature. Plant setpoint controls and applicable plant or fluid limits govern the leaving temperature.
