...
The name of a schedule which uses decimal values (0.0 1.0) These values are multiplied by the total (design) air flow rate. This is an alternate method for specifying the minimum outdoor air amount. (The other method is the \textbf{\emph{Minimum Outdoor Air Schedule}} \emph{described above.) Note: This field overrides \textbf{Minimum Outdoor Air Schedule} and \textbf{Minimum Outdoor Air Flowrate.}}
...
\begin{itemize}
\item
  HVAC,Average,Air System Outdoor Air Economizer Status \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Air System Outdoor Air Heat Recovery Bypass Status \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Air System Outdoor Air Heat Recovery Bypass Heating Coil Activity Status \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Air System Outdoor Air Heat Recovery Bypass Minimum Outdoor Air Mixed Air Temperature {[}C{]}
\item
  HVAC,Average,Air System Outdoor Air High Humidity Control Status \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Air System Outdoor Air Flow Fraction \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Air System Outdoor Air Minimum Flow Fraction \protect\hyperlink{section-1}{}
\item
  HVAC,Average,Air System Outdoor Air Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,Air System Mixed Air Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,Air System Outdoor Air Maximum Flow Fraction \protect\hyperlink{section-1}{}
\end{itemize}

\paragraph{\texorpdfstring{Air System Outdoor Air Economizer Status \protect\hyperlink{section-1}{}}{Air System Outdoor Air Economizer Status }}\label{air-system-outdoor-air-economizer-status}
...
\paragraph{\texorpdfstring{Air System Outdoor Air Heat Recovery Bypass Status \protect\hyperlink{section-1}{}}{Air System Outdoor Air Heat Recovery Bypass Status }}\label{air-system-outdoor-air-heat-recovery-bypass-status}

This indicates if the controls have determined if the bypass mode for heat recovery is in effect or not.

\paragraph{\texorpdfstring{Air System Outdoor Air Heat Recovery Bypass Heating Coil Activity Status \protect\hyperlink{section-1}{}}{Air System Outdoor Air Heat Recovery Bypass Heating Coil Activity Status }}\label{air-system-outdoor-air-heat-recovery-bypass-heating-coil-activity-status}
...
\paragraph{\texorpdfstring{Air System Outdoor Air High Humidity Control Status \protect\hyperlink{section-1}{}}{Air System Outdoor Air High Humidity Control Status }}\label{air-system-outdoor-air-high-humidity-control-status}
...
\paragraph{\texorpdfstring{Air System Outdoor Air Flow Fraction \protect\hyperlink{section-1}{}}{Air System Outdoor Air Flow Fraction }}\label{air-system-outdoor-air-flow-fraction}

Reports the average actual outdoor air fraction for the outdoor air controller over the reporting interval.

\paragraph{\texorpdfstring{Air System Outdoor Air Minimum Flow Fraction \protect\hyperlink{section-1}{}}{Air System Outdoor Air Minimum Flow Fraction }}\label{air-system-outdoor-air-minimum-flow-fraction}
...
\paragraph{\texorpdfstring{Air System Outdoor Air Maximum Flow Fraction \protect\hyperlink{section-1}{}}{Air System Outdoor Air Maximum Flow Fraction }}\label{air-system-outdoor-air-maximum-flow-fraction}
