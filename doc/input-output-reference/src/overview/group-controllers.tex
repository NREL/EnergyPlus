...
\paragraph{\texorpdfstring{Air System Outdoor Air Economizer Status {[]}}{Air System Outdoor Air Economizer Status }}\label{air-system-outdoor-air-economizer-status}
...
\paragraph{\texorpdfstring{Air System Outdoor Air Heat Recovery Bypass Status {[]}}{Air System Outdoor Air Heat Recovery Bypass Status }}\label{air-system-outdoor-air-heat-recovery-bypass-status}

This indicates if the controls have determined if the bypass mode for heat recovery is in effect or not.

\paragraph{\texorpdfstring{Air System Outdoor Air Heat Recovery Bypass Heating Coil Activity Status {[]}}{Air System Outdoor Air Heat Recovery Bypass Heating Coil Activity Status }}\label{air-system-outdoor-air-heat-recovery-bypass-heating-coil-activity-status}
...
\paragraph{\texorpdfstring{Air System Outdoor Air High Humidity Control Status {[]}}{Air System Outdoor Air High Humidity Control Status }}\label{air-system-outdoor-air-high-humidity-control-status}
...
\paragraph{\texorpdfstring{Air System Outdoor Air Flow Fraction {[]}}{Air System Outdoor Air Flow Fraction }}\label{air-system-outdoor-air-flow-fraction}

Reports the average actual outdoor air fraction for the outdoor air controller over the reporting interval.

\paragraph{\texorpdfstring{Air System Outdoor Air Minimum Flow Fraction {[]}}{Air System Outdoor Air Minimum Flow Fraction }}\label{air-system-outdoor-air-minimum-flow-fraction}
...
\paragraph{\texorpdfstring{Air System Outdoor Air Maximum Flow Fraction {[]}}{Air System Outdoor Air Maximum Flow Fraction }}\label{air-system-outdoor-air-maximum-flow-fraction}
