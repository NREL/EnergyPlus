...
\caption{Details of Autosizable Objects/Fields \protect \label{table:details-of-autosizable-objectsfields}}\\
\toprule 
Component / Object Name & Autosizable Fields \tabularnewline \midrule
\endhead
...
Coil:Heating:Gas \tabularnewline
 & Nominal Capacity \tabularnewline
...
\caption{Complete list of Objects with autosized Fields \protect \label{table:complete-list-of-objects-with-autosized}}\\
\toprule 
Object Name & Object Name \tabularnewline \midrule
\endhead
...
Coil:Heating:Electric:MultiStage & Coil:Heating:Gas \tabularnewline
...
The minimum zone design cooling volumetric flow rate expressed as a fraction of the zone design cooling volumetric flow rate. . In all cases the maximum flow derived from \emph{Cooling Minimum Air Flow per Zone Floor Area}, \emph{Cooling Minimum Air Flow}, and \emph{Cooling Minimum Air Flow Fraction}~ is used to set a minimum supply air flow rate for the zone for VAV systems. The default is zero. This input is currently used in sizing the fan minimum flow rate. It does not currently affect other component autosizing.
