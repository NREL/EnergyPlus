...
\item
  DX cooling coil (\hyperref[coilcoolingdx]{Coil:Cooling:DX} or \hyperref[coilsystemcoolingdxheatexchangerassisted]{CoilSystem:Cooling:DX:HeatExchangerAssisted})
\item
