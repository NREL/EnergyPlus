...
This alpha field specifies the node name of the outdoor air inlet node. This node name is also specified in an \hyperref[outdoorairnode]{OutdoorAir:Node} or \hyperref[outdoorairnodelist]{\hyperref[outdoorairnode]{OutdoorAir:Node}List} object. If this field is blank, a node name will be created internally.
...
A unique user-assigned name for an instance of a refrigeration chiller. Any reference to this refrigeration chiller by another object (may be listed in a \hyperref[refrigerationcaseandwalkinlist]{\hyperref[refrigerationcase]{Refrigeration:Case}AndWalkInList}, \hyperref[refrigerationsystem]{Refrigeration:System}, \hyperref[refrigerationsecondarysystem]{Refrigeration:SecondarySystem}, or \hyperref[refrigerationcompressorrack]{\hyperref[refrigerationcompressor]{Refrigeration:Compressor}Rack}) will use this name.
...
This alpha field contains the identifying type of heating coil specified in the heat pump. The only valid types are \hyperref[coilheatingwatertoairheatpumpequationfit]{\hyperref[coilheatingwater]{Coil:Heating:Water}ToAirHeatPump:EquationFit} \hyperref[coilheatingwatertoairheatpumpvariablespeedequationfit]{\hyperref[coilheatingwater]{Coil:Heating:Water}ToAirHeat\hyperref[pumpvariablespeed]{Pump:VariableSpeed}EquationFit}..
...
This alpha field contains the identifying type of cooling coil specified in the heat pump. The only valid types are \hyperref[coilcoolingwatertoairheatpumpequationfit]{\hyperref[coilcoolingwater]{Coil:Cooling:Water}ToAirHeatPump:EquationFit} and \hyperref[coilcoolingwatertoairheatpumpvariablespeedequationfit]{\hyperref[coilcoolingwater]{Coil:Cooling:Water}ToAirHeat\hyperref[pumpvariablespeed]{Pump:VariableSpeed}EquationFit}.
...
\item
  \hyperref[outdoorairnodelist]{\hyperref[outdoorairnode]{OutdoorAir:Node}List}
\end{itemize}
