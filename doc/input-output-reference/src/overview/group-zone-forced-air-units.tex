...
The name of the nth air chiller that will be used to meet the zone cooling load.  This field is extensible, so additional fields of this type can be added to the end of this object.
