...
This field specifies the n$^{th}$ spectrum corresponding to the nth wavelength.
...
\subsubsection{Weather Data Related Outputs}\label{outputs-4-008}
...
\paragraph{Site Total Sky Cover {[]}}\label{site-total-sky-cover}

This is the Total Sky cover in tenths of sky. The value ranges from 0 (clear) to 10 (full cover). 

\paragraph{Site Opaque Sky Cover {[]}}\label{site-opaque-sky-cover}
...
\subsubsection{Outputs for local temperature/wind speed calculations}\label{outputs-for-local-temperaturewind-speed-calculations}
...
\paragraph{Zone Outdoor Air Drybulb Temperature {[}C{]}}\label{zone-outdoor-air-drybulb-temperature-c}

The outdoor air dry-bulb temperature calculated at the height above ground of the zone centroid.

\paragraph{Zone Outdoor Air Wetbulb Temperature {[}C{]}}\label{zone-outdoor-air-wetbulb-temperature-c}

The outdoor air wet-bulb temperature calculated at the height above ground of the zone centroid.

\paragraph{Zone Outdoor Air Wind Speed {[}m/s{]}}\label{zone-outdoor-air-wind-speed-ms}

The outdoor wind speed calculated at the height above ground of the zone centroid.

\paragraph{Surface Ext Outdoor Dry Bulb {[}C{]}}\label{surface-ext-outdoor-dry-bulb-c}

The outdoor air dry-bulb temperature calculated at the height above ground of the surface centroid.

\paragraph{Surface Ext Outdoor Wet Bulb {[}C{]}}\label{surface-ext-outdoor-wet-bulb-c}

The outdoor air wet-bulb temperature calculated at the height above ground of the surface centroid.

\paragraph{Surface Ext Wind Speed {[}m/s{]}}\label{surface-ext-wind-speed-ms}

The outdoor wind speed calculated at the height above ground of the surface centroid.

\paragraph{System Node Temperature {[}C{]}}\label{system-node-temperature-c}
