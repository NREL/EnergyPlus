...
This field specifies the name of a schedule that contains outdoor air carbon dioxide level values in units of ppm. One source of monthly average CO\(_{2}\) levels in the atmosphere is available at [NOAA's website](http://www.esrl.noaa.gov/gmd/ccgg/trends/) or via [ftp](ftp://aftp.cmdl.noaa.gov/products/trends/co2/co2_mm_mlo.txt).
