...
\caption{PerfLog Mode Columns} \tabularnewline
\toprule
Run &
Direct Coil &
Radiant Algorithm &
...
\caption{PerfLog Energy Columns} \tabularnewline
\toprule
Run &
Direct Coil &
Radiant Algorithm &
...
3  & False & ScriptF  & MODE02 & 3,097,292 & 746,356 & 212,704 & 52.39  \tabularnewline
4  & False & ScriptF  & MODE03 & 3,097,292 & 746,356 & 212,704 & 52.42  \tabularnewline
5  & False & ScriptF  & MODE04 & 3,097,292 & 746,356 & 212,704 & 51.74  \tabularnewline
6  & False & ScriptF  & MODE05 & 3,098,474 & 743,652 & 213,207 & 32.74  \tabularnewline
...
10 & False & CarrollMRT & MODE02 & 3,243,835 & 492,423 & 265,212 & 53.85  \tabularnewline
11 & False & CarrollMRT & MODE03 & 3,243,835 & 492,423 & 265,212 & 51.21  \tabularnewline
12 & False & CarrollMRT & MODE04 & 3,243,835 & 492,423 & 265,212 & 51.14  \tabularnewline
13 & False & CarrollMRT & MODE05 & 3,244,804 & 490,038 & 265,528 & 32.76  \tabularnewline
\bottomrule
\end{longtable}
}
...
\caption{PerfLog Oscillation Columns} \tabularnewline
\toprule
Run &
Direct Coil &
Radiant Algorithm &
...
\begin{equation}
PLR = \frac{SystemLoad-OutputOff}{OutputFull - OutputOff}
\end{equation}
...
\begin{equation}
SpeedRatio = \frac{SystemLoad-OutputFull_{i-1}}{OutputFull_{i} - OutputFull_{i-1}}
\end{equation}
...
\begin{equation}
SpeedRatio = \frac{DesOutTemp - OutTempFull_{i-1}}{OutTempFull_{i} - OutTempFull_{i-1}}
\end{equation}
...
The increasing mode number roughly corresponds with increased speed. Mode01 to Mode04 are overriding inputs in other parts of the IDF/epJSON file and is equivalent to changing those input directly. Mode05 is changing a convergence parameter previously not available to modified by the user.
