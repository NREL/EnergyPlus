...
The decision on which mode to use is up to the individual modelers, but for these simulations, Run 4 is recommended. Run 4 does not use direct coil solution, uses ScriptF, and Mode03. This simulation time also shows a slight advantages over the other cases. It saves time compared to Mode01 and has relatively less oscillating hours than Mode02. Further, it does not add too much additional overrides, which should be avoided if not adding value. Mode04 to Mode07 for this model were just about the same time as Mode03. Mode02 was avoided because of the substantially larger oscillating hours.
