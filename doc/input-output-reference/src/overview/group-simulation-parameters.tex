...
In general, the higher models---Mode05 to Mode07---significantly save the computation time with both ScriptF and CarrollMRT, taking about one-fifth to one-seventh of the original Normal simulation time. These modes seem to be good choices for faster simulations, but we need to look at other results in the \_perflog.csv file first before coming to that conclusion.
...
\caption{PerfLog Energy Columns\label{table:perflog_mode_columns_energy}} \tabularnewline
\toprule
Run & 
Direct Coil & 
Radiant Algorithm & 
...
\caption{PerfLog Oscillation Columns\label{table:perflog_mode_columns_oscillation}} \tabularnewline
\toprule
Run & 
Direct Coil & 
Radiant Algorithm & 
