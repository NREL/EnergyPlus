...
If yes, space-level heat balance will be calculated and reported during sizing. If no, then only zone-level heat balance will be calculated. This field defaults to No.

\paragraph{Field: Do Space Heat Balance for Simulaiton}\label{field-do-space-heat-balance-simulation}
