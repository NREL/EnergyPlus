...
Details of the \hyperref[metercustom]{Meter:Custom}/\hyperref[metercustomdecrement]{\hyperref[metercustom]{Meter:Custom}Decrement} are shown on the Meter Details file.
