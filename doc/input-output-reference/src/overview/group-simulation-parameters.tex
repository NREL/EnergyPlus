...
\begin{longtable}[c]{p{0.2in}p{0.4in}p{0.5in}p{0.5in}p{0.5in}p{0.4in}p{0.5in}p{0.5in}p{0.5in}p{0.6in}p{0.5in}}
...
1  & FALSE & ScriptF    & NORMAL & 6 & 1 & FALSE & 1  & 0.30 & 0.002 & 178.82 \tabularnewline
2  & FALSE & ScriptF    & MODE01 & 1 & 1 & FALSE & 1  & 0.30 & 0.002 & 61.75  \tabularnewline
3  & FALSE & ScriptF    & MODE02 & 1 & 1 & FALSE & 60 & 0.30 & 0.002 & 30.15  \tabularnewline
4  & FALSE & ScriptF    & MODE03 & 1 & 1 & FALSE & 60 & 0.30 & 0.002 & 31.94  \tabularnewline
5  & FALSE & ScriptF    & MODE04 & 1 & 1 & FALSE & 60 & 0.30 & 0.002 & 29.62  \tabularnewline
6  & FALSE & ScriptF    & MODE05 & 1 & 1 & TRUE  & 60 & 0.30 & 0.002 & 32.01  \tabularnewline
7  & FALSE & ScriptF    & MODE06 & 1 & 1 & TRUE  & 60 & 1.00 & 0.002 & 29.80  \tabularnewline
8  & FALSE & ScriptF    & MODE07 & 1 & 1 & TRUE  & 60 & 1.00 & 0.1   & 29.67  \tabularnewline
9  & TRUE  & ScriptF    & NORMAL & 6 & 1 & FALSE & 1  & 0.30 & 0.002 & 176.87 \tabularnewline
10 & FALSE & CarrollMRT & NORMAL & 6 & 1 & FALSE & 1  & 0.30 & 0.002 & 199.23 \tabularnewline
11 & FALSE & CarrollMRT & MODE01 & 1 & 1 & FALSE & 1  & 0.30 & 0.002 & 61.38  \tabularnewline
12 & FALSE & CarrollMRT & MODE02 & 1 & 1 & False & 60 & 0.30 & 0.002 & 36.59  \tabularnewline
13 & FALSE & CarrollMRT & MODE03 & 1 & 1 & FALSE & 60 & 0.30 & 0.002 & 30.00  \tabularnewline
14 & FALSE & CarrollMRT & MODE04 & 1 & 1 & FALSE & 60 & 0.30 & 0.002 & 29.53  \tabularnewline
15 & FALSE & CarrollMRT & MODE05 & 1 & 1 & TRUE  & 60 & 0.30 & 0.002 & 29.83  \tabularnewline
16 & FALSE & CarrollMRT & MODE06 & 1 & 1 & TRUE  & 60 & 1.00 & 0.002 & 29.50  \tabularnewline
17 & FALSE & CarrollMRT & MODE07 & 1 & 1 & TRUE  & 60 & 1.00 & 0.1   & 30.47  \tabularnewline
...
% This example uses 17 different simulations to arrive at the recommended values for the PerformancePrecisionTradeoffs object, but fewer trials could have been made to reach a similar conclusion. The first run shows the results of no performance precision tradeoffs being applied and is the same as not having the PerformancePrecisionTradeoffs object present. It is a good idea to use this as a first step so that a baseline of the time, errors, and oscillations are available for reference.  Runs 2 through 8 are just stepping through the Override Modes. Run 9 employs the Use Coil Direct Solution option, but the time for the simulation went up, so it was not used anymore.  Runs 10 through 17 repeat the various override modes, but this time with the CarrollMRT radiant exchange algorithm. Mode03, Moded04, and Mode05 only save a few seconds compared to Mode01, which takes about one-third of the time of the baseline Run 1 time. Mode06 saves the most time with both ScriptF and CarrollMRT taking about one-fifth of the original time. Mode06 seems like the natural choice, but we need to look at other results in the \_perflog.csv file first before we come to that conclusion.

This example uses 17 different simulations to arrive at the recommended values for the PerformancePrecisionTradeoffs object, but fewer trials could have been made to reach a similar conclusion. The first run shows the results of no performance precision tradeoffs being applied and is the same as not having the PerformancePrecisionTradeoffs object present. It is a good idea to use this as a first step so that a baseline of the time, errors, and oscillations are available for reference.  Runs 2 through 8 are just stepping through the Override Modes. Run 9 employs the Use Coil Direct Solution option, but the time for the simulation was almost the same, so it was not used anymore.  Runs 10 through 17 repeat the various override modes, but this time with the CarrollMRT radiant exchange algorithm. The biggest savings of the computational time were from Mode01 and Mode02 application. Compared to the Normal mode (Run 1) baseline, applying Mode01 (Run 2) immediately reduced the simulation time to about one-third. Then again, by applying Mode02 (Run 3), it saves about 50\% simulation time compared to Mode02 (Run 2). Mode03 to Mode07 only save a few seconds compared to Mode02, which takes about one-sixth of the time of the baseline Run 1 time. In general, Mode02 to Mode07 significantly saves the computation time with both ScriptF and CarrollMRT taking about one-sixth of the original time. These modes seem like the good choice for faster simulations, but we need to look at other results in the \_perflog.csv file first before we come to that conclusion.

These example simulations each took aobut three minutes or less to try. If your building takes much longer than a few minutes, you might want to temporarily change your run period to just a month or even a week to tune the PerformancePrecisionTradeoffs object inputs. If temporarily shortening the run period is necessary, it is best to pick a month or week that has some cooling and some heating. Just remember to set your run period back to a full year before coming to any conclusions about the building or energy efficiency options being considered for the building.
...
1  & FALSE & ScriptF  & NORMAL &  3,103,447 &	 755,635 &	 213,488 &	178.82 \tabularnewline
2  & FALSE & ScriptF  & MODE01 &  3,095,147 &	 741,358 &	 212,016 &	61.75  \tabularnewline
3  & FALSE & ScriptF  & MODE02 &  3,098,109 &	 753,074 &	 211,243 &	30.15  \tabularnewline
4  & FALSE & ScriptF  & MODE03 &  3,096,331 &	 766,580 &	 211,613 &	31.94  \tabularnewline
5  & FALSE & ScriptF  & MODE04 &  3,096,331 &	 766,580 &	 211,613 &	29.62  \tabularnewline
6  & FALSE & ScriptF  & MODE05 &  3,096,331 &	 766,580 &	 211,613 &	32.01  \tabularnewline
7  & FALSE & ScriptF  & MODE06 &  3,096,331 &	 766,580 &	 211,613 &	29.80  \tabularnewline
8  & FALSE & ScriptF  & MODE07 &  3,097,280 &	 751,021 &	 212,386 &	29.67  \tabularnewline
9  & TRUE  & ScriptF  & NORMAL &  3,103,447 &	 755,635 &	 213,488 &	176.87 \tabularnewline
10 & FALSE & CarrollMRT & NORMAL & 3,256,682& 	 497,760 &	 267,097 &	199.23 \tabularnewline
11 & FALSE & CarrollMRT & MODE01 & 3,246,880& 	 488,583 &	 265,309 &	61.38  \tabularnewline
12 & FALSE & CarrollMRT & MODE02 & 3,249,660& 	 494,925 &	 264,406 &	36.59  \tabularnewline
13 & FALSE & CarrollMRT & MODE03 & 3,250,818& 	 505,725 &	 265,180 &	30.00  \tabularnewline
14 & FALSE & CarrollMRT & MODE04 & 3,250,818& 	 505,725 &	 265,180 &	29.53  \tabularnewline
15 & FALSE & CarrollMRT & MODE05 & 3,250,818& 	 505,725 &	 265,180 &	29.83  \tabularnewline
16 & FALSE & CarrollMRT & MODE06 & 3,250,818& 	 505,725 &	 265,180 &	29.50  \tabularnewline
17 & FALSE & CarrollMRT & MODE07 & 3,250,420& 	 493,351 &	 265,828 &	30.47  \tabularnewline
...
The CarrollMRT options seemed to have a much more significant impact on the natural gas usage, and the total water and the times were similar to the runtimes using ScriptF. So for this example, CarrollMRT doesn’t seem to be a right choice. In this case, the computatoinal times are not very different than the ScriptF instances, but the energy usage is further from the Normal baseline. The electricity usage differences for Runs 2 through 8 are small compared to Run 1 (the normal case), and are less than 0.3\% different. Natural gas usage has a more significant impact of 1.4\% to 1.9\%, and the water usage changes from 0.5\% to 1.1\%. From an energy perspective, these impacts for the ScriptF runs 2 through 8 are probably tolerable. 
...
1  & FALSE & ScriptF    & NORMAL & 2.92	 & 2.75	 & 0.17	 & 46 &	178.82 \tabularnewline
2  & FALSE & ScriptF    & MODE01 & 7.5	 & 2.17	 & 6.17	 & 47 &	61.75  \tabularnewline
3  & FALSE & ScriptF    & MODE02 & 380	 & 277	 & 299	 & 48 &	30.15  \tabularnewline
4  & FALSE & ScriptF    & MODE03 & 158	 & 87	 & 122	 & 50 & 31.94  \tabularnewline
5  & FALSE & ScriptF    & MODE04 & 158	 & 87	 & 122	 & 51 &	29.62  \tabularnewline
6  & FALSE & ScriptF    & MODE05 & 158	 & 87	 & 122	 & 52 &	32.01  \tabularnewline
7  & FALSE & ScriptF    & MODE06 & 158	 & 87	 & 122	 & 53 &	29.8   \tabularnewline
8  & FALSE & ScriptF    & MODE07 & 155	 & 91	 & 122	 & 54 &	29.67  \tabularnewline
9  & TRUE  & ScriptF    & NORMAL & 2.92	 & 2.75	 & 0.17	 & 47 & 176.87 \tabularnewline
10 & FALSE & CarrollMRT & NORMAL & 2.14	 & 1.97	 & 0.17	 & 47 &	199.23 \tabularnewline
11 & FALSE & CarrollMRT & MODE01 & 7.74	 & 0.95	 & 6.08	 & 48 &	61.38  \tabularnewline
12 & FALSE & CarrollMRT & MODE02 & 383	 & 273	 & 316	 & 49 &	36.59  \tabularnewline
13 & FALSE & CarrollMRT & MODE03 & 150	 & 74	 & 108	 & 50 &	30.00  \tabularnewline
14 & FALSE & CarrollMRT & MODE04 & 150	 & 74	 & 108	 & 51 &	29.53  \tabularnewline
15 & FALSE & CarrollMRT & MODE05 & 150	 & 74	 & 108	 & 52 &	29.83  \tabularnewline
16 & FALSE & CarrollMRT & MODE06 & 150	 & 74	 & 108	 & 53 &	29.5   \tabularnewline
17 & FALSE & CarrollMRT & MODE07 & 151	 & 76	 & 113	 & 54 &	30.47  \tabularnewline
...
% The number of hours any zone is oscillating for Run 1 the Normal baseline case using Script F is only 3.48 hours, with almost none of the hours in the dead band and nearly all during occupancy. This changes when considering the other ScriptF cases using Mode01 to Mode06 (Run 2 to Run 7).  For these cases, the oscillating hours increase but are still less than 10 per year, while more than doubling, on an absolute basis, a small change. The change is even more minor when considering the hours with the dead band, which for Run 2 to 6 only increases about an hour. Similar numbers are shown for the CarrollMRT cases for Mode01 to Mode05. The most significant change is Mode06, which for both ScriptF and CarrollMRT raise the oscillating hours to nearly 90. This is a substantial change that does indicate a significant shift in the way the simulation is behaving. It would be easy to eliminate using Mode05 if it wasn’t for the fact that it is also substantially faster than the other modes. No severe errors were reported for any of these simulations, so no column is shown for them, and the column for warnings shows a small increase. After investigating the changes, the change in the count warning messages was not considered important.

The number of hours any zone is oscillating for Run 1 the Normal baseline case using Script F is only 2.92 hours, with almost none of the hours in the dead band and nearly all during occupancy. This changes when considering the other ScriptF cases using Mode01 to Mode07 (Run 2 to Run 8).  For Mode01, the oscillating hours increase but are still less than 8 hours per year, while more than doubling, on an absolute basis, a small change. The change is even more minor when considering the hours with the dead band, which for Run 1 even decreased by a small amount. However, for Mode02 to Mode07, the oscillating hours increase significantly, by more than one order of magnitude to aroudn 155 to 380 hours per year. The numbers are also reflected in the oscillating hours during occupancy and the oscillating hours during dead band.  For the CarrollMRT cases, similar trend can be observed when applying Mode01, and from Mode02 to Mode07.  The most significant change is Mode02, which for both ScriptF and CarrollMRT raise the oscillating hours to about 380. This is a substantial change that does indicate a significant shift in the way the simulation is behaving. The oscillation could be moderately tamed by applying any of the subsequent modes (Modes03 to Modes07), without too much loss in the simulation speed. On the other hand, however, the warnings for all the seventeen cases were not too much different from, all ranging from 46 to 54. No severe errors were reported for any of these simulations, so no column is shown for them, and the column for warnings shows a small increase. After investigating the changes, the change in the count warning messages was not considered important.

The decision on which mode to use is up to the individual modelers, but for these simulations, Run 5 is recommended. Run 5 does not use direct coil solution, uses ScriptF, and Mode04. This simulation time also shows a slight advantages over the other cases. It saves time compared to Mode01 and has relatively less oscillating hours than Mode02. Further, it does not add too much additional overrides, which should be avoided if not adding value. Higher modes such as Mode05 to Mode07 for this model were just about the same time as Mode04. Mode02 was avoided because of the substantially larger oscillating hours.
...
Mode02 & Mode01 plus minimum system timestep length will be 1 hour\tabularnewline
