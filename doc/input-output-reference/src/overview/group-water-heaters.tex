...
\paragraph{\texorpdfstring{Water Heater Cycle On Count {[]}}{Water Heater Cycle On Count }}\label{water-heater-cycle-on-count}

The number of times that the heater turned on in the time period.

\paragraph{\texorpdfstring{Water Heater Runtime Fraction {[]}}{Water Heater Runtime Fraction }}\label{water-heater-runtime-fraction}

The fraction of the time period that the heater was running.

\paragraph{\texorpdfstring{Water Heater Part Load Ratio {[]}}{Water Heater Part Load Ratio }}\label{water-heater-part-load-ratio}
...
\paragraph{\texorpdfstring{Water Heater Cycle On Count {[]}}{Water Heater Cycle On Count }}\label{water-heater-cycle-on-count-1}

The number of times that either Heater 1 or Heater 2 turned on in the time period.

\paragraph{\texorpdfstring{Water Heater Runtime Fraction {[]}}{Water Heater Runtime Fraction }}\label{water-heater-runtime-fraction-1}
...
\paragraph{\texorpdfstring{Water Heater Heater 1 Cycle On Count {[]}}{Water Heater Heater 1 Cycle On Count }}\label{water-heater-heater-1-cycle-on-count}

The number of times that Heater 1 turned on in the time period.

\paragraph{\texorpdfstring{Water Heater Heater 2 Cycle On Count~ {[]}}{Water Heater Heater 2 Cycle On Count~ }}\label{water-heater-heater-2-cycle-on-count}

The number of times that Heater 2 turned on in the time period.

\paragraph{\texorpdfstring{Water Heater Heater 1 Runtime Fraction {[]}}{Water Heater Heater 1 Runtime Fraction }}\label{water-heater-heater-1-runtime-fraction}

The fraction of the time period that Heater 1 was running.

\paragraph{\texorpdfstring{Water Heater Heater 2 Runtime Fraction {[]}}{Water Heater Heater 2 Runtime Fraction }}\label{water-heater-heater-2-runtime-fraction}
