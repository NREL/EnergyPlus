...
The object also defines the sky view factors to the external surface. The sum of all defined view factors including the ground surfaces view factors defined in SurfaceProperty:GroundSurfaces object should not exceed 1.0. If only sky view is defined in this object, the ground view factor to this surface will be 1.0 subtracted the sky view factor and all other defined surface view factors. If ground view factor is defined in SurfaceProperty:GroundSurfaces, the sky view factor to this surface will be 1.0 subtracted the ground surface view factors and all other defined surface view factors. If neither of the sky and ground view factors are explicitly declared in SurfaceProperty:SurroundingSurfaces and SurfaceProperty:GroundSurfaces objects respectively, the sum of the sky and ground view factor would be 1.0 subtracted all other defined surface view factors and the proportion will be set as the same with the global setting.
