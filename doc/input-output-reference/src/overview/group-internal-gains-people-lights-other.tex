...
This field defines targeted LED intensity levels the photosynthetic photon flux density (PPFD) in the unit of \si{\umolperAreaperSecond} for indoor living wall systems. The schedule values can be any positive number representing the targeted PPFD.
...
This field defines nominal total LED power {[}\si{\watt}{]} for an indoor living wall system.
