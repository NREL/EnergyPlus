\section{Group -- Internal Gains (People, Lights, Other internal zone equipment)}\label{group-internal-gains-people-lights-other-internal-zone-equipment}
...
\caption{Metabolic Rates for Various Activities \protect \label{table:metabolic-rates-for-various-activities}}\\
\toprule 
Activity & Activity Level w/Person EnergyPlus Schedule Value & Activity Level W/m2 & met* \tabularnewline \midrule
\endhead
...
Walking (on level surface) \tabularnewline
...
Office Activities \tabularnewline
...
Miscellaneous Occupational Activities \tabularnewline
...
Miscellaneous Leisure Activities \tabularnewline
...
\begin{itemize}
\item
  Zone,Average,People Occupant Count \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Zone People Occupant Count \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Zone Thermal Comfort Fanger Model PMV \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort Fanger Model PPD {[}\%{]}
\item
  Zone,Average,Zone Thermal Comfort Clothing Surface Temperature {[}C{]}
\item
  Zone,Average,Zone Thermal Comfort Pierce Model Effective Temperature PMV \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort Pierce Model Standard Effective Temperature PMV \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort Pierce Model Discomfort Index \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort Pierce Model Thermal Sensation Index \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort KSU Model Thermal Sensation Index \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort ASHRAE 55 Adaptive Model 80\% Acceptability Status \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort ASHRAE 55 Adaptive Model 90\% Acceptability Status \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Zone Thermal Comfort CEN 15251 Adaptive Model Category I Status \protect\hyperlink{section-1}{}
\item
  Zone,Average,Zone Thermal Comfort CEN 15251 Adaptive Model Category II Status \protect\hyperlink{section-1}{}
\item
...
\paragraph{\texorpdfstring{People Occupant Count \protect\hyperlink{section-1}{}}{People Occupant Count }}\label{people-occupant-count}
...
\paragraph{\texorpdfstring{Zone People Occupant Count \protect\hyperlink{section-1}{}}{Zone People Occupant Count }}\label{zone-people-occupant-count}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Fanger Model PMV \protect\hyperlink{section-1}{}}{Zone Thermal Comfort Fanger Model PMV }}\label{zone-thermal-comfort-fanger-model-pmv}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Effective Temperature PMV \protect\hyperlink{section-1}{}}{Zone Thermal Comfort Pierce Model Effective Temperature PMV }}\label{zone-thermal-comfort-pierce-model-effective-temperature-pmv}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Standard Effective Temperature PMV \protect\hyperlink{section-1}{}}{Zone Thermal Comfort Pierce Model Standard Effective Temperature PMV }}\label{zone-thermal-comfort-pierce-model-standard-effective-temperature-pmv}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Discomfort Index \protect\hyperlink{section-1}{}}{Zone Thermal Comfort Pierce Model Discomfort Index }}\label{zone-thermal-comfort-pierce-model-discomfort-index}

This field is the ``discomfort index'' calculated using the the Pierce two-node thermal comfort model.

\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Thermal Sensation Index \protect\hyperlink{section-1}{}}{Zone Thermal Comfort Pierce Model Thermal Sensation Index }}\label{zone-thermal-comfort-pierce-model-thermal-sensation-index}

This field is the ``thermal sensation index'' (PMV) calculated using the Pierce two-node thermal comfort model.

\paragraph{\texorpdfstring{Zone Thermal Comfort KSU Model Thermal Sensation Vote \protect\hyperlink{section-1}{}}{Zone Thermal Comfort KSU Model Thermal Sensation Vote }}\label{zone-thermal-comfort-ksu-model-thermal-sensation-vote}

This field is the ``thermal sensation vote'' (TSV) calculated using the KSU two-node thermal comfort model.

\paragraph{\texorpdfstring{Zone Thermal Comfort ASHRAE 55 Adaptive Model 90\% Acceptability Status \protect\hyperlink{section-1}{}}{Zone Thermal Comfort ASHRAE 55 Adaptive Model 90\% Acceptability Status }}\label{zone-thermal-comfort-ashrae-55-adaptive-model-90-acceptability-status}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort ASHRAE 55 Adaptive Model 80\% Acceptability Status \protect\hyperlink{section-1}{}}{Zone Thermal Comfort ASHRAE 55 Adaptive Model 80\% Acceptability Status }}\label{zone-thermal-comfort-ashrae-55-adaptive-model-80-acceptability-status}
...
\caption{Winter Clothes (1.0 Clo) \protect \label{table:winter-clothes-1.0-clo}}\\
\toprule 
Operative Temperature (C) & Humidity Ratio (kgWater/kgDryAir) \tabularnewline \midrule
\endhead
...
% table 13
\begin{longtable}[c]{@{}ll@{}}
\caption{Summer Clothes (0.5 Clo) \protect \label{table:summer-clothes-0.5-clo}}\\
\toprule 
Operative Temperature (C) & Humidity Ratio (kgWater/kgDryAir) \tabularnewline \midrule
\endhead
...
f\(_{d}\) = 1.0 -- (Return Air Fraction + Fraction Radiant + Fraction Visible)
...
\caption{Approximate values of Return Air Fraction, Fraction Radiant and Fraction Visible for overhead fluorescent lighting for different luminaire configurations. \protect \label{table:approximate-values-of-return-air-fraction}}\\
\toprule 
Fixture No. & Luminaire Feature & Return Air Fraction & Fraction Radiant & Fraction Visible & fconvected \tabularnewline \midrule
\endhead
...
If \textbf{Daylighting:Controls} or \textbf{Daylighting:DELight:Controls} is specified for the zone, this field is used as an on/off flag for dimming controls. If set to 0.0, the lights are not dimmed by the daylighting controls. If set to 1.0, the lights are allowed to be dimmed by the daylighting controls.
...
To compensate for the change in the return air fraction relative to its input value, the program modifies Fraction Radiant and f\(_{\rm{convected}}\) by a scale factor such that
...
\caption{Distribution of Lights to Meters \protect \label{table:distribution-of-lights-to-meters}}\\
\toprule 
Meter Name & Scope & Lights Specfics \tabularnewline \midrule
\endhead
...
\item
  HVAC, Average, Indoor Pool Current Activity Factor \protect\hyperlink{section-1}{}
\item
  HVAC, Average, Indoor Pool Current Cover Factor \protect\hyperlink{section-1}{}
\item
...
\paragraph{\texorpdfstring{Indoor Pool Current Activity Factor \protect\hyperlink{section-1}{}}{Indoor Pool Current Activity Factor }}\label{indoor-pool-current-activity-factor}

This is the current activity factor as defined by the user input schedule.

\paragraph{\texorpdfstring{Indoor Pool Current Cover Factor \protect\hyperlink{section-1}{}}{Indoor Pool Current Cover Factor }}\label{indoor-pool-current-cover-factor}
...
This factor (watts/m\(^{2}\)) is used, along with the Zone Area to determine the maximum equipment level as described in the Design Level field. This value can be negative to denote a loss. The choice from the method field should be ``\textbf{Watts/Area}'' or ``\textbf{Power/Area}''.

\paragraph{Field: Power per Person}\label{field-power-per-person-3}

This factor (watts/person) is used, along with the number of occupants (people) to determine the maximum equipment level as described in the Design Level field. This value can be negative to denote a loss. The choice from the method field should be ``\textbf{Watts/Person}'' or ``\textbf{Power/Person}''.
...
f\(_{d}\) = 1.0 -- (Fraction Latent + Fraction Radiant + Fraction Lost)
...
\item
  Zone,Average,ITE Supply Heat Index \protect\hyperlink{section-1}{}
\item
...
\item
  Zone,Average,Zone ITE Average Supply Heat Index \protect\hyperlink{section-1}{}
\item
...
\paragraph{\texorpdfstring{Zone ITE Average Supply Heat Index \protect\hyperlink{section-1}{}}{Zone ITE Average Supply Heat Index }}\label{zone-ite-average-supply-heat-index}

\paragraph{\texorpdfstring{ITE Supply Heat Index \protect\hyperlink{section-1}{}}{ITE Supply Heat Index }}\label{ite-supply-heat-index}
...
\emph{S\(_{f}\)} \(_{ }\) = Contaminant generic contaminant source strength {[}m\(^{3}\)/s{]}

\emph{G\(_{f}\)} \(_{ }\) = Generic contaminant generation rate {[}m\(^{3}\)/s{]}

\emph{F\(_{G}\)} \(_{ }\) = Fraction value from the source fraction schedule at a given time {[}dimensionless{]}

\emph{R\(_{f}\)} \(_{ }\) = Generic contaminant effective removal rate {[}m\(^{3}\)/s{]}

\emph{F\(_{R}\)} \(_{ }\) = Fraction value from the sink fraction schedule at a given time {[}dimensionless{]}

\emph{C\(_{f}\)} \(_{ }\) = Generic contaminant concentration value at a given previous time step {[}ppm{]}
...
\emph{S\(_{f}\)} \(_{ }\) = Generic contaminant source strength {[}m\(^{3}\)/s{]}

\emph{H\(_{f}\)} \(_{ }\) = Generic contaminant generation rate coefficient {[}m\(^{3}\)/s{]}

\emph{F\(_{G}\)} \(_{ }\) = Fraction value from the source fraction schedule at a given time {[}dimensionless{]}

\emph{n~~~} = Flow power exponent

P\emph{\(_{i}\)} \(_{ }\) = Zone pressure {[}Pa{]}

P\emph{\(_{j}\)} \(_{ }\) = Pressure in an adjacent zone for a interior surface or outdoor for an exterior surface {[}Pa{]}
...
\emph{C\(_{cutoff}\)} = Cutoff concentration at which emission ceases {[}ppm{]}
...
\emph{G\(_{f}\)} \(_{ }\) = Initial generic contaminant generation rate {[}m\(^{3}\)/s{]}
...
\emph{r} = Film density of air {[}kg/m\(^{3}\){]}
...
\subsection{SurfaceContaminantSourceAndSink:Generic:DepositionVelocitySink}\label{surfacecontaminantsourceandsinkgenericdepositionvelocitysink}
...
\emph{n\(_{d}\)} = Deposition velocity {[}m/s{]}

\emph{A\(_{s}\)} = Deposition surface area {[}m\(^{2}\){]}

\emph{m} = Element multiplier {[}dimensionless{]}

\emph{C}\(_{f}\)(\emph{t}) = Concentration of contaminant generic contaminant at the previous time step {[}ppm{]}

F\(_{R}\) = Schedule or control signal value at time \emph{t} {[}-{]}
...
\subsection{ZoneContaminantSourceAndSink:Generic:DepositionRateSink}\label{zonecontaminantsourceandsinkgenericdepositionratesink}
...
% table 16
\begin{longtable}[c]{@{}ll@{}}
\caption{Outdoor Temperature Controlled Baseboard Heat Temperature vs. Capacity \protect \label{table:outdoor-temperature-controlled-baseboard-heat}}\\
\toprule 
Outdoor Dry-bulb(C) & Baseboard Output \tabularnewline \midrule
\endhead
> 10 & 0 \tabularnewline
...
% table 17
\begin{longtable}[c]{p{2.68in}p{1.5in}p{1.81in}}
\caption{Distribution of Equipment to Meters \protect \label{table:distribution-of-equipment-to-meters}}\\
\toprule 
Meter Name & Scope & Equipment Specfics \tabularnewline \midrule
\endhead
