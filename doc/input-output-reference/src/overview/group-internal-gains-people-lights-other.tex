...
\paragraph{\texorpdfstring{People Occupant Count {[]}}{People Occupant Count }}\label{people-occupant-count}
...
\paragraph{\texorpdfstring{Zone People Occupant Count {[]}}{Zone People Occupant Count }}\label{zone-people-occupant-count}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Fanger Model PMV {[]}}{Zone Thermal Comfort Fanger Model PMV }}\label{zone-thermal-comfort-fanger-model-pmv}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Effective Temperature PMV {[]}}{Zone Thermal Comfort Pierce Model Effective Temperature PMV }}\label{zone-thermal-comfort-pierce-model-effective-temperature-pmv}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Standard Effective Temperature PMV {[]}}{Zone Thermal Comfort Pierce Model Standard Effective Temperature PMV }}\label{zone-thermal-comfort-pierce-model-standard-effective-temperature-pmv}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Discomfort Index {[]}}{Zone Thermal Comfort Pierce Model Discomfort Index }}\label{zone-thermal-comfort-pierce-model-discomfort-index}

This field is the ``discomfort index'' calculated using the the Pierce two-node thermal comfort model.

\paragraph{\texorpdfstring{Zone Thermal Comfort Pierce Model Thermal Sensation Index {[]}}{Zone Thermal Comfort Pierce Model Thermal Sensation Index }}\label{zone-thermal-comfort-pierce-model-thermal-sensation-index}

This field is the ``thermal sensation index'' (PMV) calculated using the Pierce two-node thermal comfort model.

\paragraph{\texorpdfstring{Zone Thermal Comfort KSU Model Thermal Sensation Vote {[]}}{Zone Thermal Comfort KSU Model Thermal Sensation Vote }}\label{zone-thermal-comfort-ksu-model-thermal-sensation-vote}

This field is the ``thermal sensation vote'' (TSV) calculated using the KSU two-node thermal comfort model.

\paragraph{\texorpdfstring{Zone Thermal Comfort ASHRAE 55 Adaptive Model 90\% Acceptability Status {[]}}{Zone Thermal Comfort ASHRAE 55 Adaptive Model 90\% Acceptability Status }}\label{zone-thermal-comfort-ashrae-55-adaptive-model-90-acceptability-status}
...
\paragraph{\texorpdfstring{Zone Thermal Comfort ASHRAE 55 Adaptive Model 80\% Acceptability Status {[]}}{Zone Thermal Comfort ASHRAE 55 Adaptive Model 80\% Acceptability Status }}\label{zone-thermal-comfort-ashrae-55-adaptive-model-80-acceptability-status}
...
\paragraph{\texorpdfstring{Indoor Pool Current Activity Factor {[]}}{Indoor Pool Current Activity Factor }}\label{indoor-pool-current-activity-factor}

This is the current activity factor as defined by the user input schedule.

\paragraph{\texorpdfstring{Indoor Pool Current Cover Factor {[]}}{Indoor Pool Current Cover Factor }}\label{indoor-pool-current-cover-factor}
...
\paragraph{\texorpdfstring{Zone ITE Average Supply Heat Index {[]}}{Zone ITE Average Supply Heat Index }}\label{zone-ite-average-supply-heat-index}

\paragraph{\texorpdfstring{ITE Supply Heat Index {[]}}{ITE Supply Heat Index }}\label{ite-supply-heat-index}
