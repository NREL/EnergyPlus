...
\paragraph{\texorpdfstring{Water Use Connections Heat Recovery Effectiveness {[]}}{Water Use Connections Heat Recovery Effectiveness }}\label{water-use-connections-heat-recovery-effectiveness}
