...
If the AirflowNetwork:SimulationControl object is not provided in an input file, the defaul input object will be created by the program internally, as long as follwoing conditions are satisfied:

The number of AirflowNetwork:MultiZone:Zone object >= 1

The number of AirflowNetwork:MultiZone:Surface >= 2

The defaul input object is shown below:
