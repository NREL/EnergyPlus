...
AirflowNetwork:MultiZone:Surface:Crack,
  ...
  ReferenceCrackConditio; !- Reference Crack Conditions
\end{lstlisting}
...
\(C_{u}\) = Equivalent air mass flow coefficient
