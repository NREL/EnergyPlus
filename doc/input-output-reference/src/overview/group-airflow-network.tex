...
\(\mathrm{ELA}\) = Effective leakage area {[}m\(^{2}\){]}
...
\begin{equation}
\frac{1}{{\sqrt f }} = 1.44 + 2*\log \left( {\frac{D}{\varepsilon }} \right) - 2*\log \left( {1 + \frac{{9.3}}{{\operatorname{Re} *\varepsilon /D*\sqrt f }}} \right)
\end{equation}
...
\textbf{The following are reported only when an integrated model of ZoneAirContaminantBalance is used and either Carbon Dioxide Concentration = Yes or Generic Contaminant Concentration = Yes:}
...
ZoneAirContaminantBalance,
  ...
  Outdoor Contaminant Schedule;    !- Outdoor Generic Contaminant Schedule Name
\end{lstlisting}

\begin{itemize}
\item
  HVAC,Average,AFN Zone Outdoor Air Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,AFN Zone Mixing Mass Flow Rate {[}kg/s{]}

\end{itemize}

\textbf{The following are reported only when an integrated model of ZoneAirContaminantBalance is used and Carbon Dioxide Concentration = Yes:}

\begin{itemize}
\item
  HVAC,Average,AFN Zone Outdoor Air CO2 Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,AFN Zone Mixing CO2 Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,AFN Zone Total CO2 Mass Flow Rate {[}kg/s{]}
\end{itemize}

\textbf{The following are reported only when an integrated model of ZoneAirContaminantBalance is used and Generic Contaminant Concentration = Yes:}

\begin{itemize}
\item
  HVAC,Average,AFN Zone Outdoor Air Generic Air Contaminant Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,AFN Zone Mixing Generic Air Contaminant Mass Flow Rate {[}kg/s{]}
\item
  HVAC,Average,AFN Zone Total Generic Air Contaminant Mass Flow Rate {[}kg/s{]}
