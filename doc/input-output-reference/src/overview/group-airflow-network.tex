...
LowRise corresponds to a rectangular building whose height is less than three times the width of the footprint (\emph{w\(_{t}\)} in Figure~\ref{fig:footprint-of-a-rectangular-building-showing}) and is less than three times the length of the footprint (\emph{w\(_{g}\)} in the same figure).

HighRise corresponds to a rectangular building whose height is more than three times the width of the footprint (\emph{w\(_{t}\)} in Figure~\ref{fig:footprint-of-a-rectangular-building-showing}) or is more than three times the length of the footprint (\emph{w\(_{g}\)} in the same figure).
...
Let T\(_{t}\) equal the outdoor air temperature, T\(_{e}\) equal the previous timestep's zone air temperature, T\(_{t}\) equal the Vent Temperature Schedule value, H\(_{e}\) equal the specific enthalpy of zone air from the previous timestep, and H\(_{t}\) equal the specific enthalpy of outdoor air. Then the four allowed choices for Ventilation Control Mode are:
...
\textbf{Temperature}: All of the zone's openable windows and doors are opened if T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} Venting Availability Schedule (see below) allows venting.

\textbf{Enthalpy:} All of the zone's openable windows and doors are opened if H\(_{e}\) \textgreater{} H\(_{t}\) \textbf{and} T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} Venting Availability Schedule allows venting.
...
\textbf{if} T\(_{e}\) - T\(_{t}\) ~\textless{} = ~ {[}Lower Value on Inside/Outside Temperature Difference for Modulating the Venting Open Factor{]}~~\textbf{then}~~Multiplication factor = 1.0

\textbf{if} {[}Lower Value on Inside/Outside Temperature Difference for Modulating the Venting Open Factor{]} \textless{} T\(_{e}\) - T\(_{t}\) \textless{} {[}Upper Value on Inside/Outside Temperature Difference for Modulating the Venting Open Factor{]}~ \textbf{then} Multiplication factor varies linearly from 1.0 to {[}Limit Value on Multiplier for Modulating Venting Open Factor{]}

\textbf{if} T\(_{e}\) - T\(_{t}\)~\textgreater{} = ~ {[}Upper Value on Inside/Outside Temperature Difference for Modulating the Venting Open Factor{]} \textbf{then} Multiplication factor = {[}Limit Value on Multiplier for Modulating Venting Open Factor{]}
...
\textbf{Temperature}: The openable window or door associated with this surface is opened if T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} Venting Availability Schedule (see below) allows venting.

\textbf{Enthalpy:} The openable window or door associated with this surface is opened if H\(_{e}\) \textgreater{} H\(_{t}\) \textbf{and} T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} Venting Availability Schedule allows venting.
...
\textbf{AdjacentTemperature}: This choice is used for an interior surface only. The openable interior window or door associated with this surface is opened if T\(_{e}\) \textgreater{} T\(_{e}\) \textbf{and} T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} Venting Availability Schedule (see below) allows venting, where T\(_{e}\)is the adjacent zone temperature.

\textbf{AdjacentEnthalpy:} This choice is also used for an interior surface only. The interior openable window or door associated with this surface is opened if H\(_{e}\) \textgreater{} H\(_{e}\) \textbf{and} T\(_{e}\) \textgreater{} T\(_{t}\) \textbf{and} Venting Availability Schedule allows venting, where H\(_{e}\)is the adjacent zone specific enthalpy.
...
ρ\(_{o}\) = Air density at the reference air conditions provided by the object AirflowNetwork:MultiZone:ReferenceCrackConditions specified in the field Reference Crack Conditions {[}kg/m\(^{3}\){]}

ν\(_{o}\) = Air kinetic viscosity at the reference air temperature provided by the object AirflowNetwork:MultiZone:ReferenceCrackConditions specified in the field Reference Crack Conditions {[}m\(^{2}\)/s{]}
...
\emph{ELA}~~ = Effective leakage area {[}m\(^{2}\){]}
...
Note: There are two common sets of reference conditions: C\(_{d}\) = 1.0 and DP = 4 Pa, or C\(_{d}\) = 0.6 and DP = 10 Pa
...
Crack flow is assumed when the window or door is closed. In this case, the value of this field is the exponent,* n\emph{, in the crack air flow equation. The valid range for this exponent is 0.5 to 1.0, with the default value being 0.65. Mass Flow Rate = Air Mass Flow Coefficient} (deltaP)\^{}Air Mass Flow Exponent.
...
ρ\(_{o}\) = Air density at air conditions of 20°C, 0 kg/kg and 101325 Pa {[}kg/m\(^{3}\){]}

ν\(_{o}\) = Air kinetic viscosity at an air temperature of 20°C {[}m\(^{2}\)/s{]}
...
C\(_{u}\) = Equivalent air mass flow coefficient
...
Q\(_{r}\) = Maximum airflow rate {[}m\(^{3}\)/s{]}
...
\item
  HVAC,Average,AFN Surface Venting Window or Door Opening Factor \protect\hyperlink{section-1}{}
\item
  HVAC,Average,AFN Surface Venting Window or Door Opening Modulation Multiplier \protect\hyperlink{section-1}{}
\item
  HVAC,Average,AFN Surface Venting Inside Setpoint Temperature {[}C{]}
\item
  HVAC,Average,AFN Surface Venting Availability Status \protect\hyperlink{section-1}{}
\item
...
\begin{itemize}
\item
  HVAC,Average,AFN Surface Venting Window or Door Opening Factor at Previous Time Step \protect\hyperlink{section-1}{}
\item
  HVAC,Average,AFN Surface Opening Elapsed Time {[}min{]}
\item
  HVAC,Average,AFN Surface Closing Elapsed Time {[}min{]}
\item
  HVAC,Average,AFN Surface Opening Status at Previous Time Step \protect\hyperlink{section-1}{}
\item
  HVAC,Average,AFN Surface Opening Status \protect\hyperlink{section-1}{}
\item
  HVAC,Average,AFN Surface Opening Probability Status \protect\hyperlink{section-1}{}
\item
  HVAC,Average,AFN Surface Closing Probability Status \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{AFN Linkage Node 1 to Node 2 Volume Flow Rate {[}m\(^{3}\)/s{]}}{AFN Linkage Node 1 to Node 2 Volume Flow Rate {[}m\^{}\{3\}/s{]}}}\label{afn-linkage-node-1-to-node-2-volume-flow-rate-m3s}
...
\paragraph{\texorpdfstring{AFN Linkage Node 2 to Node 1 Volume Flow Rate {[}m\(^{3}\)/s{]}}{AFN Linkage Node 2 to Node 1 Volume Flow Rate {[}m\^{}\{3\}/s{]}}}\label{afn-linkage-node-2-to-node-1-volume-flow-rate-m3s}
...
\paragraph{\texorpdfstring{AFN Linkage Node 1 to 2 Average Volume Flow Rate {[}m\(^{3}\)/s{]}}{AFN Linkage Node 1 to 2 Average Volume Flow Rate {[}m\^{}\{3\}/s{]}}}\label{afn-linkage-node-1-to-2-average-volume-flow-rate-m3s}
...
\paragraph{\texorpdfstring{AFN Linkage Node 2 to 1 Average Volume Flow Rate {[}m\(^{3}\)/s{]}}{AFN Linkage Node 2 to 1 Average Volume Flow Rate {[}m\^{}\{3\}/s{]}}}\label{afn-linkage-node-2-to-1-average-volume-flow-rate-m3s}
...
\paragraph{\texorpdfstring{AFN Surface Venting Window or Door Opening Factor \protect\hyperlink{section-1}{}}{AFN Surface Venting Window or Door Opening Factor }}\label{afn-surface-venting-window-or-door-opening-factor}
...
\paragraph{\texorpdfstring{AFN Surface Venting Window or Door Opening Modulation Multiplier~ \protect\hyperlink{section-1}{}}{AFN Surface Venting Window or Door Opening Modulation Multiplier~ }}\label{afn-surface-venting-window-or-door-opening-modulation-multiplier}
...
\caption{Value of opening factor multiplier for different venting conditions. \protect \label{table:value-of-opening-factor-multiplier-for}}\\
\toprule 
Is surface in a Zone? & Ventilation Control Mode & Is surface venting? & Value of opening factor multiplier \tabularnewline \midrule
\endhead
...
\paragraph{\texorpdfstring{AFN Surface Venting Availability Status \protect\hyperlink{section-1}{}}{AFN Surface Venting Availability Status }}\label{afn-surface-venting-availability-status}
...
\paragraph{\texorpdfstring{AFN Surface Venting Window or Door Opening Factor at Previous Time Step \protect\hyperlink{section-1}{}}{AFN Surface Venting Window or Door Opening Factor at Previous Time Step }}\label{afn-surface-venting-window-or-door-opening-factor-at-previous-time-step}
...
\paragraph{\texorpdfstring{AFN Surface Opening Status at Previous Time Step \protect\hyperlink{section-1}{}}{AFN Surface Opening Status at Previous Time Step }}\label{afn-surface-opening-status-at-previous-time-step}
...
\paragraph{\texorpdfstring{AFN Surface Opening Status \protect\hyperlink{section-1}{}}{AFN Surface Opening Status }}\label{afn-surface-opening-status}
...
\paragraph{\texorpdfstring{AFN Surface Opening Probability Status \protect\hyperlink{section-1}{}}{AFN Surface Opening Probability Status }}\label{afn-surface-opening-probability-status}
...
\paragraph{\texorpdfstring{AFN Surface Closing Probability Status \protect\hyperlink{section-1}{}}{AFN Surface Closing Probability Status }}\label{afn-surface-closing-probability-status}
