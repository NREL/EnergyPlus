...
\paragraph{\texorpdfstring{AFN Surface Venting Window or Door Opening Factor {[]}}{AFN Surface Venting Window or Door Opening Factor }}\label{afn-surface-venting-window-or-door-opening-factor}
...
\paragraph{\texorpdfstring{AFN Surface Venting Window or Door Opening Modulation Multiplier~ {[]}}{AFN Surface Venting Window or Door Opening Modulation Multiplier~ }}\label{afn-surface-venting-window-or-door-opening-modulation-multiplier}
...
\paragraph{\texorpdfstring{AFN Surface Venting Availability Status {[]}}{AFN Surface Venting Availability Status }}\label{afn-surface-venting-availability-status}
...
\paragraph{\texorpdfstring{AFN Surface Venting Window or Door Opening Factor at Previous Time Step {[]}}{AFN Surface Venting Window or Door Opening Factor at Previous Time Step }}\label{afn-surface-venting-window-or-door-opening-factor-at-previous-time-step}
...
\paragraph{\texorpdfstring{AFN Surface Opening Status at Previous Time Step {[]}}{AFN Surface Opening Status at Previous Time Step }}\label{afn-surface-opening-status-at-previous-time-step}
...
\paragraph{\texorpdfstring{AFN Surface Opening Status {[]}}{AFN Surface Opening Status }}\label{afn-surface-opening-status}
...
\paragraph{\texorpdfstring{AFN Surface Opening Probability Status {[]}}{AFN Surface Opening Probability Status }}\label{afn-surface-opening-probability-status}
...
\paragraph{\texorpdfstring{AFN Surface Closing Probability Status {[]}}{AFN Surface Closing Probability Status }}\label{afn-surface-closing-probability-status}
