...
When an air boundary surface is used (\hyperref[constructionairboundary]{Construction:AirBoundary}), all types of leakage component are allowed except AirflowNetwork:MultiZone:Component:ZoneExhaustFan. Venting controls may not be used with an air boundary surface (it is always fully open).
...
\item
The surface may be an air boundary surface (\hyperref[constructionairboundary]{Construction:AirBoundary}).
\end{itemize}
