...
\paragraph{\texorpdfstring{Zone Ventilated Slab Fan Availability Status {[]}}{Zone Ventilated Slab Fan Availability Status }}\label{zone-ventilated-slab-fan-availability-status}
