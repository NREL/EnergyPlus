\section{\texorpdfstring{Group -- Radiative \textbf{/} Convective Units}{Group -- Radiative / Convective Units}}\label{group-radiative-convective-units}
...
where q is the heat transferred from water to the air in watts; T\(_{g}\) is the average water temperature in degrees C; and T\(_{g}\) is the average air temperature in degrees C. Or the LMTD temperature difference can be used.
...
\item
  HVAC,Average,Zone Ventilated Slab Fan Availability Status \protect\hyperlink{section-1}{}
\end{itemize}
...
\paragraph{\texorpdfstring{Zone Ventilated Slab Fan Availability Status \protect\hyperlink{section-1}{}}{Zone Ventilated Slab Fan Availability Status }}\label{zone-ventilated-slab-fan-availability-status}
