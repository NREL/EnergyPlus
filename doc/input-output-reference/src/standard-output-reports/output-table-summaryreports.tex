...
\item
  Zone Summary includes internal load summary for each zone including area, if conditioned, volume, multipliers, above ground gross wall area, underground gross wall area, window area, design lighting, design people, design plug and process.
\end{itemize}
...
\paragraph{Object Count Summary}\label{object-count-summary}
