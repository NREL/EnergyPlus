...
\item
  Zone Summary includes internal load summary for each zone including area, if conditioned, volume, multipliers, above ground gross wall area, underground gross wall area, window area, design lighting, design people, design plug and process, and temperature capacitance multiplier. 
\end{itemize}
