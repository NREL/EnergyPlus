...
The Heat Emissions Report provides the a summary of the building heat emission to the ambient calculations. This report shows the heat emissions from buildings by surface heat transfer, zone exhaust, zone relief, HVAC relief, HVAC heat rejection, as well as in total. The key used to obtain this report is HeatEmissionsSummary.
