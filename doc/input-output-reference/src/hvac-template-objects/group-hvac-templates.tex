...
\begin{figure}[htbp]
\centering
\includegraphics{media/image605.svg}
\caption{}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{media/image606.svg}
\caption{}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{media/image607.svg}
\caption{}
\end{figure}
...
\subsubsection{Inputs}\label{inputs-10-007}

\paragraph{Field: Zone Name}\label{field-zone-name-9}
...
This numeric field defines the size of the first stage compressor to the total compressor capacity and is used exclusively for calculating crankcase heater energy. If this field and the previous field are left blank, the default value is 0.5. If this field is left blank and the previous field is not blank, the compressors are assumed to be equally sized. When the number of compressors is greater than 2, the 2\(^{d}\) stage compressor and all additional compressors are assumed to be equally sized. This field is only used to calculate crankcase heater power and has no impact on heat pump performance.
...
\subsubsection{Inputs}\label{inputs-17-002}
...
\paragraph{Field: Name}\label{field-name-10-006}
