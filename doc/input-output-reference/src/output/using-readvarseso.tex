...
\caption{ReadVarsESO Command Line Options \protect \label{table:readvarseso-command-line-options}}\\
\toprule 
Option & Description \tabularnewline \midrule
\endhead
...
\caption{"RVI" file contents \protect \label{table:rvi-file-contents}}\\
\toprule 
.rvi line description & Actual .rvi File Contents \tabularnewline \midrule
\endhead
...
% table 43
\begin{longtable}[c]{p{1.5in}p{4.5in}}
\caption{Example ReadVarsESO command lines and results \protect \label{table:example-readvarseso-command-lines-and-results}}\\
\toprule 
Command Line & Description/Result \tabularnewline \midrule
\endhead
