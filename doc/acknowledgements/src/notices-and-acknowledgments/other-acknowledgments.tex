...
The SQLite output module was funded by Building Synergies, LLC and was made possible by inclusion of software code from the SQLite project (\textless{}http://www.sqlite.org/\textgreater{}).
