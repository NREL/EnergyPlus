...
\caption{  SetupOutputVariable Arguments \protect \label{table:setupoutputvariable-arguments}}\\
\toprule 
SetupOutput Variable Arguments & Description \tabularnewline \midrule
\endhead
