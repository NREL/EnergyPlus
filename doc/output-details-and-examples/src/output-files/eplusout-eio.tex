...
This is the adjustment ratio to both inside and outside window film coefficients assuming highly conducted frames are applied given high Nominal U input. The adjustment ratio is applied when the winter-conditions-evaluated conductance for glazing only is lower than the input Nominal U. The adjustment ratio is evaluated as Conductance divided by Conductance (Before Adjusted).
...
\subsection{WindowMaterial:Blind}\label{materialwindowblind}
