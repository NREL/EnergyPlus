...
macro( CREATE_DOC_TARGET SOURCE_FILENAME OUTPUT_FILENAME )
  add_custom_command( OUTPUT ${PROJECT_BINARY_DIR}/pdf/${OUTPUT_FILENAME}.pdf
    COMMAND ${CMAKE_COMMAND} -DXELATEX=${XELATEX} -DINNAME=${SOURCE_FILENAME} -DOUTNAME=${OUTPUT_FILENAME} -DORIGINAL_CMAKE_SOURCE_DIR=${PROJECT_SOURCE_DIR} -DORIGINAL_CMAKE_BINARY_DIR=${PROJECT_BINARY_DIR} -DTEX_INTERACTION=${TEX_INTERACTION} -DDOCS_TESTING=${DOCS_TESTING} -P ${PROJECT_SOURCE_DIR}/cmake/BuildDocumentation.cmake
