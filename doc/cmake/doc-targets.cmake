...
macro( CREATE_DOC_TARGET SOURCE_FILENAME OUTPUT_FILENAME )
  #message("${PROJECT_BINARY_DIR}/doc-pdf/${OUTPUT_FILENAME}.pdf")
  add_custom_command( OUTPUT ${PROJECT_BINARY_DIR}/doc-pdf/${OUTPUT_FILENAME}.pdf
  ...
  add_custom_target( zPDF_${OUTPUT_FILENAME}
    DEPENDS ${PROJECT_BINARY_DIR}/doc-pdf/${OUTPUT_FILENAME}.pdf
    )
