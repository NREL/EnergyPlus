...
\subsubsection{References:}\label{references-005}
...
\quad \qaud \quad \qaud / ((11/6) \cdot C_{air,z} + HA_{oc} + HA_{mx} + HA_{fl} + MCP_{tot})
\end{array}
\end{equation}}
...
\emph{Formulas for EnergyPlus based on the dimensionless parameter} \emph{G}
