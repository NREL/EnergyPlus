...
This auxiliary quadratic equation has always two distinct real roots (\(\lambda_1}\) and \(\lambda_{2}\)) hence the solution of the homogeneous equation is exponential, and the general solutions of the differential equations are given by:
