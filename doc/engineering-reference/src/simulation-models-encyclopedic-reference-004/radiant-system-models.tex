...
The contact resistance is determined using the following relationship:

\begin{equation}
{R_{contact}} = \frac{W ln\frac{W}{\pi D_{out}}}{2 \pi k_{slab}}
\end{equation}

where \(k_{slab}\) is the thermal conductivity of the material in which the tubes are embedded.

Finally, the U-value for this model is calculated using:

\begin{equation}
U = \frac{1}{{R_{conv}} + {R_{tube}} + {R_{contact}}}
\end{equation}
