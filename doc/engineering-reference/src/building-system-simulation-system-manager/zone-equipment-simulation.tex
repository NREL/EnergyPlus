...
\begin{equation}
{h_{node}} = \operatorname{PsyHFnTdbW} {\mathrm{(}}20.0,{W_{oa}}{\mathrm{)}}
\end{equation}
...
where \emph{W\(_{oa}\)} is the humidity of the outside air; \({\mathrm{PsyHFnTdbW}}\) is the EnergyPlus psychrometric function for enthalpy \emph{h}, given temperature and humidity ratio; \emph{p\(_{oa}\)} is the pressure of the outside air; and \emph{Qu} is quality.
