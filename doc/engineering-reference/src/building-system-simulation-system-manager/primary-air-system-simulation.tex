...
where \({W_{oa}}\) is the humidity ratio of the outside air; \({\mathrm{PsyHFnTdbW}}\) is the EnergyPlus psychrometric function for enthalpy \emph{h}, given temperature and humidity ratio; and \emph{Qu} is quality.
