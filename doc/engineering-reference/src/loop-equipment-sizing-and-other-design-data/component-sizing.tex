...
The following calculations are performed to determine the rated cooling power consumption.
...
\begin{equation}
	CoolPowCoeffModFac = CPC1 + CPC2 \left(T_{WB,ratio} \right)+CPC3 \left(T_{S,ratio} \right)+CPC4+CPC5
\end{equation}
...
CPC5 = user input for Cooling Power Consumption Coefficient 5
...
The following calculations are performed to determine the rated total heating capacity.
...
The following calculations are performed to determine the rated heating power consumption.

\begin{equation}
	HeatPowCoeffModFac = HPC1 + HPC2 \left(T_{DB,ratio} \right)+ HPC3 \left(T_{S,ratio} \right)+ HPC4+ HPC5
\end{equation}
