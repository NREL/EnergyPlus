...
\subsubsection{Design Electric Power Consumption}\label{design-elect-pow-consumpt}

The new simple fan model added for version 8.6 can automatically size a Design Electric Power Consumption.  The maximum air flow rate is determined first and then the design electric power is calculated using one of three methods which can be selected by the user. 
