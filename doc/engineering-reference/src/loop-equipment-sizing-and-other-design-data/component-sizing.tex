...
\begin{cases}
\left( {{T_{suploop,exit}} + \Delta {T_{suploop,des}}} \right) - {T_{dmdloop,exit}} & \text{Cooling, Condenser}\\
\left( {{T_{suploop,exit}} - \Delta {T_{suploop,des}}} \right) - {T_{dmdloop,exit}} & \text{Heating, Steam}
\end{cases}
\end{equation}
