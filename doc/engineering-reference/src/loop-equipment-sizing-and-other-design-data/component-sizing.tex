...
\begin{equation}
{\dot Q} = {\dot V_{sup,des}} \cdot \rho \cdot {c_p} \cdot \Delta {T_{suploop,des}}
\end{equation}
...
\begin{equation}
\Delta {T_{looptoloop,des}} = \left( {{T_{suploop,exit}} + \Delta {T_{suploop,des}}} \right) - {T_{dmdloop,exit}} \quad \text{(Cooling, Condenser)}
\end{equation}

\begin{equation}
\Delta {T_{looptoloop,des}} = \left( {{T_{suploop,exit}} - \Delta {T_{suploop,des}}} \right) - {T_{dmdloop,exit}}\quad \text{(Heating, Steam)}
\end{equation}
