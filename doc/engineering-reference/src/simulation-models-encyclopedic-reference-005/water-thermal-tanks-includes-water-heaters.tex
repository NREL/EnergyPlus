...
It will advantageous for the numerical solution to rearrange the nodal differential equation into the form
...
At the end of each sub timestep, the algorithm checks for temperature inversions and instantaneously mixes inverted nodes by calcualting a weighted average of the node temperatures of the inverted nodes. This is done iteratively up the tank until there are no more temperature inversions.
