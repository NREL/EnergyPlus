...
\caption{Variables in Anisotropic Sky Model and Shadowing of Sky Diffuse Radiation \label{table:variables-in-anisotropic-sky-model}}\\
\toprule 
\textbf{Mathematical variable} & \textbf{Description} & \textbf{Units} & \textbf{FORTRAN variable} \tabularnewline \midrule \endhead
$I_{sky}$ & Solar irradiance on surface from sky & W/m\(^{2}\) & - \tabularnewline \midrule
$I_{horizon}$ & Solar irradiance on surface from sky horizon & W/m\(^{2}\) & - \tabularnewline \midrule
$I_{dome}$ & Solar irradiance on surface from sky dome & W/m\(^{2}\) & - \tabularnewline \midrule
$I_{circumsolar}$ & Solar irradiance on surface from circumsolar region & W/m\(^{2}\) & - \tabularnewline \midrule
$I_h$ & Horizontal solar irradiance & W/m\(^{2}\) & - \tabularnewline \midrule
S & Surface tilt & radians & Surface(SurfNum)\%Tilt*DegToRadians \tabularnewline \midrule
a, b & intermediate variables & - & - \tabularnewline \midrule
$F_1$, $F_2$ & Circumsolar and horizon brightening coefficients & - & F1, F2 \tabularnewline \midrule
$\alpha$ & Incidence angle of sun on surface & radians & IncAng \tabularnewline \midrule
Z & Solar zenith angle & radians & ZenithAng \tabularnewline \midrule
$Delta$ & Sky brightness factor & - & Delta \tabularnewline \midrule
$\varepsilon$ & Sky clearness factor & - & Epsilon \tabularnewline \midrule
m & relative optical air mass & - & AirMass \tabularnewline \midrule
$I_o$ & Extraterrestrial solar irradiance & W/m\(^{2}\) & - \tabularnewline \midrule
$I$ & Direct normal solar irradiance & W/m\(^{2}\) & Material\%Thickness \tabularnewline \midrule
$\kappa$ & constant = 1.041 for Z in radians & radians & - \tabularnewline \midrule
$F_{ij}$ & Brightening coefficient factors & - & F11R, F12R, etc. \tabularnewline \midrule
$R_{circumsolar}$ & Shadowing factor for circumsolar radiation & - & SunLitFrac \tabularnewline \midrule
$R_{dome}$ & Shadowing factor for sky dome radiation & - & DifShdgRatioIsoSky \tabularnewline \midrule
$R_{horizon}$ & Shadowing factor for horizon radiation & - & DifShdgRatioHoriz \tabularnewline \midrule
E & Sky radiance & W/m\(^{2}\) & - \tabularnewline \midrule
$\theta$ & Azimuth angle of point in sky & radians & Theta \tabularnewline \midrule
$\varphi$ & Altitude angle of point in sky & radians & Phi \tabularnewline \midrule
$I_i$ & Irradiance on surface from a horizon element & W/m\(^{2}\) & - \tabularnewline \midrule
$I_{ij}$ & Irradiance on surface from a sky dome element & W/m\(^{2}\) & - \tabularnewline \midrule
SF & Sunlit fraction & - & FracIlluminated \tabularnewline \midrule
