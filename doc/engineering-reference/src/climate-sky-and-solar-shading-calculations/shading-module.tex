...
\toprule 
\textbf{Unit of Angle} & \textbf{Equivalent time} \tabularnewline \midrule
\endhead
1 radian & 3.819719 hours \tabularnewline \midrule
1 degree & 4 minutes \tabularnewline \midrule
1 arcmin & 4 seconds \tabularnewline \midrule
...
\toprule 
\textbf{Surface Characteristic} & \textbf{Area Convention} \tabularnewline \midrule
\endhead
receiving surface & positive (A) \tabularnewline \midrule
overlap between shadow and receiving & negative (B  \&  C) \tabularnewline \midrule
...
\emph{BTOTZone} = total beam solar incident on the zone's exterior windows that is transmitted as beam or diffuse.\protect\hyperlink{ux5fftn1}{{[}1{]}}
