...
\begin{equation}
{T_{dp}} = {\mathrm{PsyTdpFnWPb}}\left( {{\omega_{SA}},P} \right)
\end{equation}
...
\({\mathrm{PsyTdpFnWPb}}\) is the EnergyPlus psychrometric function, returns dewpoint temperature given humidity ratio and barometric pressure.
...
\begin{equation}
{T_{dp,SP}} = {\mathrm{PsyTdpFnWPb}}\left( {{\omega_{SP}},P} \right)
\end{equation}
