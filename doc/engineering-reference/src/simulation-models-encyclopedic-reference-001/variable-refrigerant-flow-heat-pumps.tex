...
\paragraph{{Modeling of the outdoor unit (O/U) - Heating Mode}}\label{modeling-of-the-outdoor-unit-ou---heating-mode}
...
\paragraph{Modeling of the indoor unit (I/U) - Part II - Cooling Mode}\label{modeling-of-the-indoor-unit-iu---part-ii---cooling-mode}
...
\paragraph{Modeling of the indoor unit (I/U) - Part II - Heating Mode}\label{modeling-of-the-indoor-unit-iu---part-ii---heating-mode}
