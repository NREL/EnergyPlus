...
% table 55
\begin{longtable}[c]{p{0.5in}p{2.5in}p{0.5in}p{2.5in}}
...
Description & Temperature &  & Temperature &  & Speed & Volume Flow Rate \tabularnewline \midrule
 & Dry Bulb C (F) & Wet Bulb C (F) & Dry Bulb C (F) & Wet Bulb C (F) \tabularnewline \midrule
\endhead
