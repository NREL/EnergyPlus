...
The cooling coil speed level could be actuated by EMS to at run-time. When EMS is used to overwrite the “Unitary System DX Coil Speed Level” values, the speed levels are applied to the EMS values rather than the default controlled speed levels.
