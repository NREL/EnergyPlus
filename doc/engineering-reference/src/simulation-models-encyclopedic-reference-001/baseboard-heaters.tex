...
\begin{equation}
{T_{air,outlet}} = {T_{air,inlet}} + \varepsilon {\frac{{\left( {{T_{water,inlet}} - {T_{air,inlet}}} \right){C_{\min }}}}{{C_{air}}}}
\end{equation}

\begin{equation}
{T_{water,outlet}} = {T_{water,inlet}} - \left( {{T_{air,outlet}} - {T_{air,inlet}}} \right){\frac{{{C_{air}}}}{{C_{water}}}}
\end{equation}
...
\begin{equation}
Energ{y_{electric}} = {\frac{{Heatin{g_{baseboard}}}}{Efficiency}}
\end{equation}
