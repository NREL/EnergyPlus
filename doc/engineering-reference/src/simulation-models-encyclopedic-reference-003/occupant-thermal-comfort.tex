...
The metabolic rate (H/A\(_{u}\)), is a measure of the internal heat production rate of an occupant (H) w/hr. in per unit of ``Dubois'' body surface area (A\(_{u}\)) in units of m\(^{2}\). The DuBois body surface area is given by :
...
Where the Skin Temperature (T\(_{k}\)), the Core Temperature (T\(_{r}\)) and the Sweat Rate are physiological indices. The Skin Wettedness (w) is a rationally derived physiological index defined as the ratio of the actual sweating rate to the maximum rate of sweating that would occur if the skin were completely wet.
...
% table 81
\begin{longtable}[c]{p{1.2in}p{1.2in}p{1.2in}p{1.2in}p{1.2in}}
\caption{  Nomenclature list for Fanger model \protect \label{table:nomenclature-list-for-fanger-model}}\\
\toprule 
Mathematical variable & Description & Units & Range & FORTRAN variable \tabularnewline \midrule
\endhead
A & Dubois body surface area & m & - & BodySurfaceArea \tabularnewline
C & The rate of dry respiratory heat loss & W/m & - & DryRespHeatLoss \tabularnewline
E & The rate of heat loss from the diffusion of water vapor through the skin & W/m & - & EvapHeatLossDiff \tabularnewline
E & The rate of latent respiratory heat loss & W/m & - & LatRespHeatLoss \tabularnewline
E & The rate of heat loss from the evaporation of regulatory sweating at the state of comfort & W/m & - & EvapHeatLossRegComf \tabularnewline
E & Total evaporative heat loss from skin & W/m & ~ & EvapHeatLoss \tabularnewline
f & The ratio of clothed body & - & ~ & CloBodyRat \tabularnewline
f & The fraction of surface effective for radiation ( = 0.72) & - & - & RadSurfEff \tabularnewline
H & Internal heat production rate of an occupant per unit area ( = M – W) & W/m & - & IntHeatProd \tabularnewline
h & Convective heat transfer coefficient & W/m  °C & - & Hc \tabularnewline
L & All the modes of energy loss from body & W/m & - & - \tabularnewline
M & Metabolic rate per unit area & W/m & - & ActLevel \tabularnewline
P & Water vapor pressure in ambient air & Torr & - & VapPress \tabularnewline
PMV & Predicted Mean Vote & - & -4\textbackslash\~{}4 & PMV \tabularnewline
PPD & Predicted Percentage of Dissatisfied & - & 0\textbackslash\~{}100\% & PPD \tabularnewline
Q & The rate of convective heat loss & W/m & - & ConvHeatLoss \tabularnewline
Q & Sensible heat flow from skin & W/m & ~ & DryHeatLoss \tabularnewline
Q & The rate of radiative heat loss & W/m & - & RadHeatLoss \tabularnewline
Q & The rate of respiratory heat loss & W/m & - & RespHeatLoss \tabularnewline
T & Air temperature & °C & - & AirTemp \tabularnewline
T & Clothing surface temperature & °C & - & CloSurfTemp \tabularnewline
T & Clothing surface temperature (Absolute) & °K & - & AbsCloSurfTemp \tabularnewline
T & Mean radiant temperature & °K & - & AbsRadTemp \tabularnewline
W & The rate of heat loss due to the performance of work & W/m & - & WorkEff \tabularnewline
e & The emissivity of clothing-skin surface & - & - & SkinEmiss \tabularnewline
s & The Stefan-Boltzman constant ( = 5.67×10  ) & W/m  K & - & StefanBoltz \tabularnewline
\bottomrule
\end{longtable}
...
% table 82
\begin{longtable}[c]{p{1.2in}p{1.2in}p{1.2in}p{1.2in}p{1.2in}}
\caption{  Nomenclature list for Pierce Two-Node model \protect \label{table:nomenclature-list-for-pierce-two-node-model}}\\
\toprule 
Mathematical variable & Description & Units ~ & Range & FORTRAN variable \tabularnewline \midrule
\endhead
C & Constant for skin blood flow & ~ & ~ & SkinBloodFlowConst \tabularnewline
C & The rate of dry respiratory heat loss & W/m & - & DryRespHeatLoss \tabularnewline
C & Proportionality constant for sweat control & g/m  hr & ~ & SweatContConst \tabularnewline
DISC & Predicted discomfort vote & - & -5\textbackslash\~{}5 & DISC \tabularnewline
E & The rate of heat loss from the diffusion of water vapor through the skin & W/m & - & EvapHeatLossDiff \tabularnewline
E & Maximum evaporative heat loss & W/m & ~ & EvapHeatLossMax \tabularnewline
E & Total evaporative heat loss from skin & W/m & ~ & EvapHeatLoss \tabularnewline
E & The rate of latent respiratory heat loss & W/m & - & LatRespHeatLoss \tabularnewline
E & The rate of heat loss from the evaporation of regulatory sweating & W/m & - & EvapHeatLossRegSweat \tabularnewline
E & The rate of heat loss from the evaporation of regulatory sweating at the state of comfort & W/m & ~ & EvapHeatLossRegComf \tabularnewline
ET* & Effective Temperature & °C & - & ET \tabularnewline
f & The ratio of clothed body & - & ~ & CloBodyRat \tabularnewline
f & The fraction of surface effective for radiation ( = 0.72) & - & - & RadSurfEff \tabularnewline
H & Internal heat production rate of an occupant per unit area ( = M – W) & W/m & - & IntHeatProd \tabularnewline
h & Combined heat transfer coefficient & W/m  °C & ~ & H \tabularnewline
h & Convective heat transfer coefficient & W/m  °C & - & Hc \tabularnewline
h  ’ & Combined evaporative heat transfer coefficient & W/(m  kP  ) & ~ & - \tabularnewline
h & Radiant heat transfer coefficient & W/m  °C & - & Hr \tabularnewline
I & Clothing insulation & m  °C/W & ~ & - \tabularnewline
L & All the modes of energy loss from body & W/m & - & - \tabularnewline
L & All the modes of energy loss from body at ET* & W/m & ~ & - \tabularnewline
L & All the modes of energy loss from body at SET* & W/m & ~ & - \tabularnewline
M & Metabolic rate per unit area & W/m & - & ActLevel \tabularnewline
M & Metabolic heat production due to activity & W/m & ~ & - \tabularnewline
M & Metabolic heat production due to shivering & W/m & ~ & ShivResponse \tabularnewline
P & Water vapor pressure in ambient air & Torr & - & VapPress \tabularnewline
PMV* & Predicted Mean Vote modified by ET* or SET* & - & -4\textbackslash\~{}4 & PMVET PMVSET \tabularnewline
P & Water vapor pressure at SET* & °C & ~ & StdVapPressSET \tabularnewline
P & Saturated water vapor pressure at required skin temperature & Torr & - & SatSkinVapPress \tabularnewline
Q & The rate of convective heat loss & W/m & - & ConvHeatLoss \tabularnewline
Q & Heat flow from core to skin & W/m & ~ & HeatFlow \tabularnewline
Q & Sensible heat flow from skin & W/m & ~ & DryHeatLoss \tabularnewline
Q & The rate of radiative heat loss & W/m & - & RadHeatLoss \tabularnewline
Q & The rate of respiratory heat loss & W/m & - & RespHeatLoss \tabularnewline
S & Heat storage in core compartment & W/m & ~ & CoreheatStorage \tabularnewline
SET* & Standard Effective Temperature & °C & - & SET \tabularnewline
SIG & Thermal signal of body & °C & ~ & BodyThermSigCold BodyThermSigWarm \tabularnewline
SIG & Thermal signal of core & °C & ~ & CoreThermSigCold CoreThermSigWarm \tabularnewline
SIG & Thermal signal of skin & °C & ~ & SkinThermSigCold SkinThermSigWarm \tabularnewline
SKBF & Skin blood flow & L/m  hr & ~ & SkinBloodFlow \tabularnewline
S & Heat storage in skin compartment & W/m & ~ & SkinHeatStorage \tabularnewline
S & Constriction constant of skin blood flow for average person & ~ & ~ & Str \tabularnewline
SW & The rate of regulatory sweating & g/m  hr & ~ & RegSweat \tabularnewline
T & Air temperature & °C & - & AirTemp \tabularnewline
T & Mean body temperature & ~ & ~ & AvgBodyTemp \tabularnewline
T & Mean body temperature when DISC is zero (lower limit) & °C & ~ & AvgBodyTempLow \tabularnewline
T & Mean body temperature when HSI is 100 (upper limit) & °C & ~ & AvgBodyTempHigh \tabularnewline
T & Clothing surface temperature & °C & - & CloSurfTemp \tabularnewline
T & Core or internal temperature & °C & - & CoreTemp \tabularnewline
T & Mean radiant temperature & °C & - & RadTemp \tabularnewline
TSENS & Thermal sensation vote & - & -5\textbackslash\~{}5 & TSENS \tabularnewline
T & Skin temperature & °C & ~ & SkinTemp \tabularnewline
W & The rate of heat loss due to the performance of work & W/m & - & WorkEff \tabularnewline
w & Skin wettedness due to diffusion trough the skin & ~ & ~ & SkinWetDiff \tabularnewline
...
Mathematical variable & Description & Units ~ & Range & FORTRAN variable \tabularnewline \midrule
\endhead
C & Specific heat of body core & Whr/kg°C & ~ & ~ \tabularnewline
C & Specific heat of skin & Whr/kg°C & ~ & ~ \tabularnewline
C & The rate of dry respiratory heat loss & W/m & - & DryRespHeatLoss \tabularnewline
E & The rate of heat loss from the diffusion of water vapor through the skin & W/m & - & EvapHeatLossDiff \tabularnewline
E & Maximum evaporative heat loss & W/m & ~ & EvapHeatLossMax \tabularnewline
E & Total evaporative heat loss from skin & W/m & ~ & EvapHeatLoss \tabularnewline
E & Equivalent evaporation heat loss from the sweat secreted & W/m & ~ & EvapHeatLossSweat \tabularnewline
E & Sweat function for warm and dry skin & W/m & ~ & DrySweatRate \tabularnewline
E & The rate of latent respiratory heat loss & W/m & - & LatRespHeatLoss \tabularnewline
F & The Burton thermal efficiency factor for clothing & ~ & - & CloThermEff \tabularnewline
F & Permeation efficiency factor for clothing & ~ & - & CloPermeatEff \tabularnewline
H & Internal heat production rate of an occupant per unit area = M - W & W/m & - & IntHeatProd \tabularnewline
H & Combined heat transfer coefficient & W/m  °C & ~ & H \tabularnewline
h & Convective heat transfer coefficient & W/m  °C & - & Hc \tabularnewline
h & Radiant heat transfer coefficient & W/m  °C & - & Hr \tabularnewline
KS & Overall skin thermal conductance & W/m  °C & ~ & ThermCndct \tabularnewline
KS & Skin conductance at thermal neutrality & W/m  °C & ~ & ThermCndctNeut \tabularnewline
KS & Skin conductance at thermal sensation very cold & W/m  °C & ~ & ThermCndctMin \tabularnewline
M & Metabolic rate per unit area & W/m & - & ActLevel \tabularnewline
M & Metabolic heat production due to shivering & W/m & ~ & ShivResponse \tabularnewline
P & Water vapor pressure in ambient air & Torr & - & VapPress \tabularnewline
P & Saturated water vapor pressure at required skin temperature & Torr & - & SatSkinVapPress \tabularnewline
PT & The pattern of acclimation & ~ & ~ & AcclPattern \tabularnewline
Q & The rate of convective heat loss & W/m & - & ConvHeatLoss \tabularnewline
Q & Sensible heat flow from skin & W/m & ~ & DryHeatLoss \tabularnewline
Q & The rate of radiative heat loss & W/m & - & RadHeatLoss \tabularnewline
Q & The rate of respiratory heat loss & W/m & - & RespHeatLoss \tabularnewline
