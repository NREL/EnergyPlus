...
1.~~~~\emph{OutdoorAir:Mixer}

2.~~~~\emph{Fan:ConstantVolume}

3.~~~~\emph{Coil:Cooling:Water, Coil:Cooling:Water:DetailedGeometry,} or \emph{CoilSystem:Cooling:Water:HeatExchangerAssisted}

4.~~~~\emph{Coil:Heating:Water or Coil:Heating:Electric}
...
\]\{\dot m\{w\}\} = \{\dot m\_\{w, max\}\} * \{PLR\}\[ \]

where:

\{SR\_\{n\}\} = speed ratio of the fan coil unit at speed n, (-)
...
\{FullLoadOutput\_\{n-1\}\} = fully load fan coil unit output at fan speed level n-1, (W)

\{FullLoadOutput\_\{n\}\} = fully load fan coil unit output at fan speed level n, (W)
...
\emph{E\(_{e}\)} = output variable `Zone Dehumidifier Off Cycle Parasitic Electric Energy {[}J{]}'
...
\toprule 
 & Moisture Content & 5\% & 5\% & 10\% & 10\% & 15\% & 15\% & 20\% & 20\% \tabularnewline \midrule
\endhead
...
\endhead
A & amplitude of the soil surface temperature variation & (°C) \tabularnewline
C & specific heat of air & (J/kg°C) \tabularnewline
h & convective heat transfer coefficient at the inner pipe surface & (W/m  °C) \tabularnewline
h & convective heat transfer coefficient at the soil surface & (W/m  °C) \tabularnewline
k & thermal conductivity of the air & (W/m°C) \tabularnewline
k & pipe thermal conductivity & (W/m°C) \tabularnewline
k & soil thermal conductivity & (W/m°C) \tabularnewline
L & pipe length & (m) \tabularnewline
m & mass flow rate of ambient air through pipe & (kg/s) \tabularnewline
r & relative humidity & ~ \tabularnewline
R & thermal resistance due to convection heat transfer between the air in the pipe and the pipe inner surface & (m-C/W) \tabularnewline
R & thermal resistance due to conduction heat transfer between the pipe inner and outer surface & (m-C/W) \tabularnewline
R & thermal resistance due to conduction heat transfer between the pipe outer surface and undisturbed soil & (m-C/W) \tabularnewline
R & total thermal resistance between pipe air and soil & (m-C/W) \tabularnewline
ΔR & radiation constant & (63W/m  ) \tabularnewline
r & inner pipe radius & (m) \tabularnewline
r & pipe thickness & (m) \tabularnewline
r & distance between the pipe outer surface and undisturbed soil & (m) \tabularnewline
S & average solar radiation & (W/m  ) \tabularnewline
S & amplitude of the solar radiation & (W/m  ) \tabularnewline
t & time elapsed from beginning of calendar year & (days) \tabularnewline
T  (y) & air temperature of the pipe at the distance y from the pipe inlet & (°C) \tabularnewline
T & average soil surface temperature & (°C) \tabularnewline
T & average air temperature & (°C) \tabularnewline
t & phase constant of the soil surface & (sec; days) \tabularnewline
t & phase constant of the air & (sec; days) \tabularnewline
T & amplitude of the air temperature & (°C) \tabularnewline
T & ground temperature at time t and depth z & (°C) \tabularnewline
T & soil profile temperature at time t, averaged over depths between z   and z & (°C) \tabularnewline
u & ~wind velocity above the ground surface & (m/s) \tabularnewline
U & overall heat transfer coefficient of the whole earth tube system & (W/m-C) \tabularnewline
V & average pipe air velocity & (m/s) \tabularnewline
z & depth of the radial center of pipe below soil surface & (m) \tabularnewline
z & upper bounds of some vertical profile in soil & (m) \tabularnewline
z & lower bounds of some vertical profile in soil & (m) \tabularnewline
α & soil thermal diffusivity & (m  /s; m  /days) \tabularnewline
β & soil absorption coefficient ( = 1 – soil albedo) & ~ \tabularnewline
ε & hemispherical emittance of the ground surface & ~ \tabularnewline
φ & phase angle between the insolation and the air temperature & (rad) \tabularnewline
Φ & phase angle difference between the air and soil surface temperature & (rad) \tabularnewline
υ & kinetic viscosity of air & (m  /s) \tabularnewline
w & annual angular frequency ( = 1.992 x 10  rad/s) & ~ \tabularnewline
\bottomrule
\end{longtable}
...
A & cross sectional area of air channel inlet (m 2 ) \tabularnewline
A & cross sectional area of air channel outlet (m 2 ) \tabularnewline
C & discharge coefficient \tabularnewline
C & specific heat of air (J/kg°C) \tabularnewline
E & room air specific enthalpy corresponding to nth inlet (J/kg) \tabularnewline
g & acceleration due to gravity (9.8 m/s 2 ) \tabularnewline
h & convective heat transfer coefficients between the glass and ambient air (W/m 2 °C ) \tabularnewline
h & convective heat transfer coefficients between the glass and the fluid (W/m 2 °C ) \tabularnewline
h & convective heat transfer coefficients between absorber wall inner surface and the room air (W/m 2 °C ) \tabularnewline
h & convective heat transfer coefficients between the absorber wall and the fluid (W/m 2 °C ) \tabularnewline
h & The convective heat transfer coefficient due to the wind (W/m 2 °C ) \tabularnewline
H & incident solar radiation on vertical surface (W/m 2 ) \tabularnewline
k & thermal conductivity of air (W/m°C) \tabularnewline
L & total length of the thermal chimney (m) \tabularnewline
M & mass flow rate of the air (kg/s) \tabularnewline
r & relative ratio of air flow rate passing through nth inlet \tabularnewline
S & solar radiation absorbed by the glass cover (W/m 2 ) \tabularnewline
S & solar radiation absorbed by the absorber wall (W/m 2 ) \tabularnewline
T & ambient air temperature (K) \tabularnewline
T & fluid temperature averaged over the entire length of the thermal chimney (K) \tabularnewline
T & inlet air temperature of the thermal chimney (K) \tabularnewline
T & outlet air temperature of the thermal chimney (K) \tabularnewline
T & glass cover temperature (K) \tabularnewline
T & room air temperature (K) \tabularnewline
T & surface temperature (K) \tabularnewline
T & absorber wall temperature (K) \tabularnewline
T & fluid temperature (K) \tabularnewline
u & wind speed (m/s) \tabularnewline
U & Overall heat transfer coefficient from the room air and the absorber wall (W/m 2 °C ) \tabularnewline
w & width of the absorber wall (m) \tabularnewline
x & elemental length of the absorber wall (m) \tabularnewline
alpha & absorptance of glass cover \tabularnewline
alpha & absorptance of absorber wall \tabularnewline
beta & air volumetric coefficient of expansion (K -1 ) \tabularnewline
epsilon & emissivity of the glass cover \tabularnewline
sigma & Stefan-Boltzmann constant (5.67x10 -8 W/m 2 K 4 ) \tabularnewline
T & transmittance of the glass cover \tabularnewline
nu & kinematic viscosity of air (m 2 /s) \tabularnewline
\bottomrule
\end{longtable}
