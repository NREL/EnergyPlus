...
\begin{equation}
\mathrm{Fuel Use} = \frac{\mathrm{Load} \times \mathrm{EIRFT} \times \mathrm{EIRFPLR} \times \mathrm{EIRDEFROST}}{\mathrm{CRF}}
\end{equation}

\subsubsection{EIR Temperature Correction}
...
\subsubsection{EIR PLR Correction}
...
\subsubsection{Defrost Correction (Heating mode only)}
...
\subsubsection{Cycling Ratio Correction}
