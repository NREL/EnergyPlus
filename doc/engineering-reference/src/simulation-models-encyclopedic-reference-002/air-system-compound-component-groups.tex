...
\begin{equation}
UnitarySystemOutpu{t_{cycling}} = {{\dot{m}_{UnitarySystem}}{\left( {{h_{out}} - {h_{Control~Zone}}} \right)_{HRmin}} - {\Delta_{cycling}}
\end{equation}
...
\begin{equation}
{\Delta_{cycling}} = \frac{\dot{m}_{Zone~Inlet}}{frac}\left( {{h_{Zone~Inlet}} - {h_{Control~Zone}}} \right) + \left( {\mdot{m}_{UnitarySystem}} - \frac{\dot{m}_{Zone~Inlet}}{frac} \right) \left( {{h_{Out}} - {h_{Control~Zone}}} \right)
\end{equation}
