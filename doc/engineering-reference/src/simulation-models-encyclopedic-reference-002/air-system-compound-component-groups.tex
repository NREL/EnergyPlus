...
The cyclying ratio correction is also used for fuel usage calculations. This curve can be inputted by the user. An example correlation for CRF is as follows: 
\begin{equation}
...
\begin{equation}
\mathrm{Electricity usage} = \mathrm{Norminal Auxilary Power} \times \mathrm{EIR}_{\mathrm{auxiliary}} + \mathrm{Electricty}_{\mathrm{Standby}},
\end{equation}
