...
\begin{equation}
{h_f} = 2.53{R_f}{\left( {\frac{{P{V_z}}}{A}} \right)^{{\frac{1}{2}}}}
\end{equation}
...
\begin{equation}
{h_f} = \frac{{2.53}}{2}{R_f}{\left( {\frac{{P{V_z}}}{A}} \right)^{{\frac{1}{2}}}}
\end{equation}
...
\begin{equation}
{h_c} = \sqrt {{{\left[ {0.84{{\left| {\Delta T} \right|}^{{\frac{1}{3}}}}} \right]}^2} + {{\left[ {2.38  V_z^{0.89}} \right]}^2}}
\end{equation}
...
\begin{equation}
{h_c} = \sqrt {{{\left[ {0.84{{\left| {\Delta T} \right|}^{{\frac{1}{3}}}}} \right]}^2} + {{\left[ {2.86  V_z^{0.617}} \right]}^2}}
\end{equation}
...
\begin{equation}
{h_c} = \eta \frac{k}{{{L_n}}}0.15Ra_{{L_n}}^{{\frac{1}{3}}} + \frac{k}{x}{R_f}0.0296\operatorname{Re}_x^{{\frac{4}{5}}}{\Pr ^{{\frac{1}{3}}}}
\end{equation}
...
\item
  \({\operatorname{Re}_x} = \frac{{{V_z}\rho x}}{\mu }\) is the Reynolds number at x
\item
