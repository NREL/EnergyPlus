...
\toprule 
\textbf{Situations} & \textbf{Vert. Ins.} & \textbf{Horiz Ins. (Full)} & \textbf{Horiz Ins. (Perim)} \tabularnewline \midrule
\endhead
In-Grade & 1 & X &  &  \tabularnewline \midrule
2 & X & X &  \tabularnewline \midrule
3 & X &  & X \tabularnewline \midrule
4 &  &  &  \tabularnewline \midrule
5 &  & X &  \tabularnewline \midrule
6 &  &  & X \tabularnewline \midrule
On-Grade & 7 & X &  &  \tabularnewline \midrule
8* & X & X &  \tabularnewline \midrule
9 &  &  &  \tabularnewline \midrule
10* &  & X &  \tabularnewline
\bottomrule
\end{longtable}
