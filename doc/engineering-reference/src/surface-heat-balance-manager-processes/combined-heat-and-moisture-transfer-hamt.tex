...
Surfaces with Ground exterior boundary condition assumes saturated air ( 100% relative humidity) condition to calculate the exterior mass transfer coefficient, which is used to model the mass transport through a ground contact surfaces. 
