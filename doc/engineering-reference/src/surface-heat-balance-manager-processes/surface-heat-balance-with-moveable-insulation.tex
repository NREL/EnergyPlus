...
These C++ code examples, which are translated from the EnergyPlus FORTRAN code, show the implementation of these different cases.  In most cases, variable names have not changed.  For more details, please the current EnergyPlus code.
