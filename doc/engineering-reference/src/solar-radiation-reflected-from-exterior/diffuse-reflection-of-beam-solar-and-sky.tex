...
\begin{equation}
\begin{split}
QRadSWOutIncSkyDiffReflGnd(RecSurfNum) = DifSolarRad * \({\rho_{gnd}}\) \\
* ReflFacSkySolGnd(RecSurfNum)~ (W/m\(^{2}\))
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
QRadSWOutIncBmToDiffReflGnd(RecSurfNum) = BeamSolarRad * \({\rho_{gnd}}\) \\
