...
\begin{equation}
\frac{{{\mathrm{fuel~energy~input~rate}}}}{{{\mathrm{electric~power~output}}}} = \left[ {{a_1} + {a_2}PLR + {a_3}PL{R^2}} \right] * \left[ {{b_1} + {b_2}\Delta T + {b_3}\Delta {T^2}} \right]
\end{equation}

The electrical load and engine generator nominal load capacity are used to compute the part load ratio.

\begin{equation}
PLR = \frac{{{\mathrm{Electric~energy~output}}}}{{{\mathrm{nominal~generating~capacity}}}}
\end{equation}
...
\begin{equation}
{{\mathrm{T}}_{exhaust}} = \left[ {{c_1} + {c_2}PLR + {c_3}PL{R^2}} \right] * \left[ {{d_1} + {d_2}\Delta T + {d_3}\Delta {T^2}} \right]
\end{equation}
...
\begin{equation}
\frac{{{\mathrm{exhaust~gas~flow~rate}}}}{{{\mathrm{Nominal~Generating~Capacity}}}} = \left[ {{f_1} + {f_2}\Delta T + {f_3}\Delta {T^2}} \right]
\end{equation}

Finally, heat recovered from the lube oil is accounted for as follows:

\begin{equation}
\frac{{{\mathrm{Recoverable~lube~oil~heat}}}}{{{\mathrm{electric~power~generated}}}} = {g_1} + {g_2}PLR + {g_3}PL{R^2}
\end{equation}
...
\begin{equation}
T = \left( {{T_o} + {\frac{a}{b}}} \right){e^{bt}} - {\frac{a}{b}}
\end{equation}
...
\begin{equation}
\alpha  = {\tan ^{ - 1}}\left[ {\frac{{\sin \theta }}{{\frac{{\frac{{\omega R}}{{V_{Local}}}}}{{\frac{{V_a}}{{V_{Local}}}}} + \cos \theta }}} \right]
\end{equation}
