...
\begin{equation}
{I_{mp}} = {I_{mpo}} \cdot \left\{ {{C_o} \cdot {E_e} + {C_1} \cdot E_e^2} \right\} \cdot \left\{ {1 + {\alpha_{\operatorname{Im} p}} \cdot ({T_c} - {T_o}} \right\}
\end{equation}
...
\begin{equation}
{I_{xx}} = {I_{xxo}} \cdot \left\{ {{C_6} \cdot {E_e} + {C_7} \cdot E_e^2} \right\} \cdot \left\{ {1 + ({\alpha_{\operatorname{Im} p}}) \cdot ({T_c} - {T_{o)}}} \right\}
\end{equation}
