...
\toprule 
Mathematical variable & Description & Units & FORTRAN \quad variable \tabularnewline \midrule \endhead
...
\begin{equation}
\begin{array}{l}
r = {\left( {\frac{{n - 1}}{{n + 1}}} \right)^2}\\\tau  = \frac{{{{\left[ {{{(1 - r)}^4} + 4{r^2}{T^2}} \right]}^{1/2}} - {{(1 - r)}^2}}}{{2{r^2}T}}\\R = r + \frac{{{{(1 - r)}^2}r{\tau ^2}}}{{1 - {r^2}{\tau ^2}}}
\end{array}
\end{equation}
...
\begin{equation}
\begin{array}{l}
r = {\left( {\frac{{1.526 - 1}}{{1.526 + 1}}} \right)^2}\\\tau  = 0.93974\\R = 0.07846
\end{array}
\end{equation}
...
\begin{equation}
Thickness = 0.002\;;\quad for\;{\frac{1}{R_{l,w}}} > 7.0
\end{equation}

\begin{equation}
Thickness = 0.05914 - \left( {\frac{{0.00714}}{{{R_{l,w}}}}} \right);\;{\frac{1}{R_{l,w}}} \leq 7.0
\end{equation}
...
\begin{equation}
\begin{array}{l}
\tau_{bl,f}^{dir,dif} = {G_2}\\\rho_{bl,f}^{dir,dif} = {G_1}
\end{array}
\end{equation}
