...
% table 28
\begin{longtable}[c]{p{0.8in}p{2.5in}p{1.2in}p{1.5in}}
\caption{  Variables in Window Calculations \label{table:variables-in-window-calculations}}\\
\toprule 
Mathematical variable & Description & Units & FORTRAN variable \tabularnewline \midrule \endhead
T & Transmittance & - & - \tabularnewline
R & Reflectance & - & - \tabularnewline
R  , R & Front reflectance, back reflectance & - & - \tabularnewline
T & Transmittance through glass layers i to j & - & - \tabularnewline
T & Direct transmittance of glazing & - & - \tabularnewline
R   , R & Front reflectance, back reflectance from glass layers i to j & - & - \tabularnewline
R   , R & Direct front and back reflectance of glazing & - & - \tabularnewline
A   , A & Front~ absorptance, back absorptance of layer i & - & - \tabularnewline
...
V(λ) & Photopic response function of the eye & - & y30 \tabularnewline
φ & Angle of incidence (angle between surface normal and direction of incident beam radiation) & Rad & Phi \tabularnewline
τ & Transmittivity or transmittance & - & tf0 \tabularnewline
ρ & Reflectivity or reflectance & - & rf0, rb0 \tabularnewline
...
τ & Shade transmittance & - & Material\%Trans \tabularnewline
ρ & Shade reflectance & - & Material\%ReflectShade \tabularnewline
α & Shade absorptance & - & Material\%AbsorpSolar \tabularnewline
τ  ρ  α & Blind transmittance, reflectance, absorptance & - & - \tabularnewline
Q, G, J & Source, irradiance and radiosity for blind optical properties calculation & W/m & - \tabularnewline
F & View factor between segments i and j & - & - \tabularnewline
f & Switching factor & - & SwitchFac \tabularnewline
T & Transmittance & - & - \tabularnewline
R & Reflectance & - & - \tabularnewline
R  , R & Front reflectance, back reflectance & - & - \tabularnewline
T & Transmittance through glass layers i to j & - & - \tabularnewline
...
% table 32
\begin{longtable}[c]{p{3.65in}p{2.34in}}
