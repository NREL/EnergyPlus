...
Note that the coefficient adjustment ratio, \({r_o}\), accounts for highly conductive simple glazing exterior windows. This adjustment ratio remains 1 for other cases.
