...
r\(_{o}\), r\(_{i}\) & Outside, inside film convective and radiative conductance adjustment ratio & & SurfWinCoeffAdjRatioOut, SurfWinCoeffAdjRatioIn \tabularnewline
...
Note that the coefficient adjustment ratio, \({r_o}\) and \({r_i}\), accounts for highly conductive simple glazing exterior windows. For simple-glazing windows, these adjustment ratios are computed as a ratio between the input U and the initially computed nominal (or effective) U in function CalcNominalWindowCond. They remain 1 for other cases.
...
Note that the coefficient adjustment ratio, \({r_o}\), accounts for highly conductive simple glazing exterior windows. For simple-glazing windows, this adjustment ratio is computed as a ratio between the input U and the initially computed nominal (or effective) U in function CalcNominalWindowCond. It remains 1 for other cases.
...
Note that the coefficient adjustment ratio, \({r_i}\), accounts for highly conductive simple glazing exterior windows. For simple-glazing windows, this adjustment ratio is computed as a ratio between the input U and the initially computed nominal (or effective) U in function CalcNominalWindowCond. It remains 1 for other cases.
