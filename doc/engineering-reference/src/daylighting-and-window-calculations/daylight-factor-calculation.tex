...
\toprule 
						&      &\multicolumn{8}{l}{\textbf{$x_R$: Horizontal Displacement Factor}} \tabularnewline \cmidrule(r){2-9} \endhead
						&      & \textbf{0}     & \textbf{0.5}   & \textbf{1.0}   & \textbf{1.5}   & \textbf{2.0}   & \textbf{2.5}   & \textbf{3.0}   & \textbf{>3.0} \tabularnewline \midrule
