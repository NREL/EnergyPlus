...
\begin{equation}
  {I_{tot}}({i_L}) = \sum\limits_{\substack{\mathrm{windows}\\\mathrm{in~zone}}} {{I_{win}}({i_s},{i_L})}
\end{equation}
...
\begin{equation}
  {B_{tot}}({i_L}) = \sum\limits_{\substack{\mathrm{windows}\\\mathrm{in~zone}}} {{B_{win}}({i_s},{i_L})}
\end{equation}
...
\begin{equation}
  {G_I}({i_L}) = 10{\log_{10}}\sum\limits_{\substack{\mathrm{windows}\\\mathrm{in~zone}}} {\frac{{{S_{win}}{{({i_L},{i_S})}^{1.6}}\Omega {{({i_L})}^{0.8}}}}{{B({i_L}) + 0.07\omega {{({i_L})}^{0.5}}{S_{win}}({i_L},{i_S})}}}
\end{equation}
...
\begin{equation}
{f_L}({i_L}) = {\mathrm{max}}\left[ {0,\frac{{{I_{set}}({i_L}) - {I_{tot}}({i_L})}}{{{I_{set}}({i_L})}}} \right]
\end{equation}
...
\begin{equation}
  f_P = \left\{
          \begin{array}{cl}
            0 & for~f_L = 0 \\
            \frac{\mathop\mathrm{int} (N_L f_L) + 1}{N_L} & for~0 < f_L < 1 \\
            1 & for~f_L = 1
          \end{array}
         \right.
\end{equation}
