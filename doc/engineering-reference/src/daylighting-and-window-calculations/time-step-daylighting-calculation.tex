...
\caption{  Variables in Time-Step Calculations \protect \label{table:variables-in-time-step-calculations}}\\
\toprule 
Mathematical variable & Description & Units & FORTRAN variable \tabularnewline \midrule
\endhead
S & Direct normal solar irradiance & W/m & BeamSolarRad \tabularnewline
S & Exterior diffuse horizontal solar irradiance & W/m & SDIFH, DifSolarRad \tabularnewline
S & Exterior direct horizontal solar irradiance & W/m & SDIRH \tabularnewline
Z & Solar zenith angle & radians & Zeta \tabularnewline
m & Relative optical air mass & - & AirMass \tabularnewline
Δ & Sky brightness & - & SkyBrightness \tabularnewline
ε & Sky clearness & - & SkyClearness \tabularnewline
k, k’ & Sky type index & - & ISky \tabularnewline
s & Interpolation factor for skies k and k’ & - & SkyWeight \tabularnewline
ψ & Sky luminance distribution formed from linear interpolation of skies k and k’ & cd/m & - \tabularnewline
f & Fraction of sky that is type k & - & - \tabularnewline
E & Horizontal illuminance from sky type k & cd/m & HorIllSky \tabularnewline
E & Exterior horizontal illuminance from sky & lux & HISKF \tabularnewline
E & Exterior horizontal illuminance from sun & lux & HISUNF \tabularnewline
η  , η & Luminous efficacy of diffuse and direct solar radiation & lm/W & DiffLumEff, DirLumEff \tabularnewline
I & Interior illuminance from a window & lux & DaylIllum \tabularnewline
S & Window luminance & cd/m & SourceLumFromWinAtRefPt \tabularnewline
B & Window background luminance & cd/m & BACLUM \tabularnewline
d  , d & Interior illuminance factor for sun, for sky of type k & - & DaylIllFacSun, DFSUHR, DaylIllFacSky, DFSUHR \tabularnewline
w  , w & Window luminance factor for sun, for sky of type k & - & DaylSourceFacSun, SFSUHR, DaylSourceFacSky, SFSKHR \tabularnewline
b  , b & Window background luminance factor for sun, for sky of type k & - & DaylBackFacSun, BFSUHR, DaylBackFacSky, BFSKHR \tabularnewline
w & Weighting factor for time step interpolation & - & WeightNow \tabularnewline
i & Reference point index & - & IL \tabularnewline
i & Window shade index & - & IS \tabularnewline
I & Total daylight illuminance at reference point & lux & DaylIllum \tabularnewline
B  , B & Total window background luminance & cd/m & BLUM \tabularnewline
I & Illuminance setpoint & lux & ZoneDaylight\%IllumSetPoint \tabularnewline
f & Fractional electric lighting output & - & FL \tabularnewline
f & Fractional electric lighting input power & - & FP \tabularnewline
N & Number of steps in a stepped control system & - & LightControlSteps \tabularnewline
M & Lighting power multiplier & - & ZonePowerReductionFactor \tabularnewline
\bottomrule
\end{longtable}
...
where \emph{ψ\(_{s}\)} is the clear turbid sky luminance distribution and
...
Similarly, the window source luminance, \emph{S\(_{n}\)}, and window background luminance, \emph{B\(_{n}\)}, for a window are calculated from
...
7)~~~Shades are closed in the order of window input until glare at both points is below \emph{G\(_{x}\)}, or until there are no more windows left to shade.
...
\protect\hyperlink{ux5fftnref4}{{[}4{]}} For the purposes of the surface heat balance calculation, any beam solar radiation absorbed by a surface is assumed to be uniformly distributed over the surface even though in reality it is likely to be concentrated in one or more discrete patches on the surface.
