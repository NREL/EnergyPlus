\subsection{Green Roof Model (EcoRoof)}\label{green-roof-model-ecoroof}

\subsubsection{Overview}\label{overview-018}
...
\subsubsection{Green Roof Model Description}\label{green-roof-model-description}
...
\paragraph{Energy budget in the foliage layer}\label{energy-budget-in-the-foliage-layer}
...
\subparagraph{Sensible heat flux in the foliage layer}\label{sensible-heat-flux-in-the-foliage-layer}
...
\subparagraph{Latent heat flux in the foliage layer}\label{latent-heat-flux-in-the-foliage-layer}
...
\paragraph{Soil Energy budget}\label{soil-energy-budget}
...
\subparagraph{Sensible heat flux in the soil layer}\label{sensible-heat-flux-in-the-soil-layer}
...
\subparagraph{Latent heat flux in the soil layer}\label{latent-heat-flux-in-the-soil-layer}
...
\subsubsection{Final Equations}\label{final-equations}
...
\subsubsection{Green Roof Nomenclature}\label{green-roof-nomenclature}
...
\paragraph{Greek letters}\label{greek-letters-000}
...
\paragraph{Subscripts and superscripts}\label{subscripts-and-superscripts-000}
...
\subsubsection{References}\label{references-025}
