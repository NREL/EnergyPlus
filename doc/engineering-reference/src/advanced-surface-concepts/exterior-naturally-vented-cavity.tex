\subsection{Exterior Naturally Vented~ Cavity}\label{exterior-naturally-vented-cavity}
...
\paragraph{External SW Radiation}\label{external-sw-radiation}
...
\paragraph{Cavity Convection}\label{cavity-convection}
