...
be enhanced or fixed, please also see the \href{https://energyplus.net/contributing}{contribution policy}. 
...
\section{Documentation and Other Resources}
...
\includegraphics[scale=0.75,bb = 0 0 200 100, draft, type=eps]{eplaunch2.png}
...
\includegraphics[width=6in,bb = 0 0 200 100, draft, type=eps]{eplaunch3.png}
...
\includegraphics[width=6in,bb = 0 0 200 100, draft, type=eps]{idfeditor.png}
...
\includegraphics[bb = 0 0 200 100, draft, type=eps]{energyplusfolder.png}
...
document.
\end{itemize}
\includegraphics[width=5in,bb = 0 0 200 100, draft, type=eps]{IDFVersionUpdater.png}
\begin{itemize}
...
\includegraphics[width=6in,bb = 0 0 200 100, draft, type=eps]{coordinatesystem.png}Figure
X. EnergyPlus Coordinate System.
\begin{itemize}
...
\end{itemize}
\includegraphics[width=5in,bb = 0 0 200 100, draft, type=eps]{window_frame_and_divider.png}
...
\end{itemize}
\includegraphics[bb = 0 0 200 100, draft, type=eps]{kiva-2d-elements.png}
...
\includegraphics[width=6in,bb = 0 0 200 100, draft, type=eps]{NodeDiagram.png}
...
\end{itemize}
\includegraphics[width=5in,bb = 0 0 200 100, draft, type=eps]{tariff-charges.png}Figure
