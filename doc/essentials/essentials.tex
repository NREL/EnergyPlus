...
\includegraphics[width=6in]{media/eplaunch2}
...
\includegraphics[width=6in]{media/eplaunch3}
...
\includegraphics[width=6in]{media/idfeditor}
...
\includegraphics{media/energyplusfolder}
...
document.
\end{itemize}
\includegraphics[width=5in]{media/IDFVersionUpdater}
\begin{itemize}
...
\includegraphics[width=6in]{media/coordinatesystem}

Figure X. EnergyPlus Coordinate System.
\begin{itemize}
...
\end{itemize}
\includegraphics[width=5in]{media/window_frame_and_divider}
...
\end{itemize}
\includegraphics{media/kiva-2d-elements}
...
\includegraphics[width=6in]{media/NodeDiagram}
...
\end{itemize}
\includegraphics[width=5in]{media/tariff-charges}
