...
well as entering a window varies by the sun position for each period
...
for the postprocessor result files, a web browser for the tabular
...
simulation and lets you load the most recent version.
