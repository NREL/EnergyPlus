...
<for command line referenced quickstart guide, for this include EP-Launch
and IDF Editor examples>

FROM GETTING STARTED:

EnergyPlus is a simulation program designed for modeling buildings
with all their associated heat- ing, ventilating, and air conditioning
...
user interface to de- scribe the building. However, it can be run
stand alone without such an interface. This document describes how
to run EnergyPlus in such a stand alone fashion. This section will
introduce you to the EP-Launch program, which helps you run EnergyPlus. 
...
<Include EP-Launch 3 screen shot and some explanation on how to use
it>
...
\subsection*{What are All These Files}

<lots of file extensions, maybe just reference a few and move rest
to Aux doc, see list in old getting started>

<maybe include description of all the directories that come with EnergyPlus>
