...
comprehensive list, see the \href{https://www.buildingenergysoftwaretools.com/}{BEST (Building Energy Software Tools) Director}y
...
user interface such as OpenStudio, DesignBuilder, Simergy, Euclid,
Honeybee, Insight, AECOsim, and Sefaira. Other interfaces are also
available.
