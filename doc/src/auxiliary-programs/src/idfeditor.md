...
![Edit or Select Node Name Dialog Box](media/edit-or-select-node-name-dialog-box.png)
...
![Find Class Dialog Box](media/find-class-dialog-box.png)
...
![Search and Replace Diaglog Box](media/search-and-replace-diaglog-box.png)
...
![IDF Editor Layout Options Screen.](media/idf-editor-layout-options-screen..png)
...
![Validity Check Dialog Box](media/validity-check-dialog-box.png)
