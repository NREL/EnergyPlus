...
The D2EP.log file contains a detailed log of the translation process. The D2E_TEMP.txt file contains an intermediate version of the log file. Both of these files are created in the same directory as the DOE2Translator program and can usually be deleted.
