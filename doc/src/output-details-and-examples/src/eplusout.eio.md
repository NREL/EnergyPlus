...
### Field: Nominal Surface Area {m^2^}
...
### Field: Number of Refrigeration Compressor Racks
...
The total number of detailed transcritical CO~2~ refrigeration systems found in the IDF.
...
### Field: Number of Orphaned Walk Ins
...
~~~~~~~~~~~~~~~~~~~~
    ...
    DX Cooling Coil Standard Rating Information, Coil:Cooling:DX:SingleSpeed, PSZ-AC_2:2_COOLC DXCOIL, 17427.1, 3.21, 10.95, 11.04, 11.20
~~~~~~~~~~~~~~~~~~~~
...
~~~~~~~~~~~~~~~~~~~~
    ...
    DX Heating Coil Standard Rating Information, Coil:Heating:DX:SingleSpeed, PSZ-AC_1:1_HEATC DXCOIL, 10476.1, 5833.2, 6.10, 4
~~~~~~~~~~~~~~~~~~~~
...
This field will provide a mean air temperature comparison between the second to last and the last warmup day for the simulation.  In other words, it will provide a T between, for example, 9:10AM on the second to last warmup day and 9:10AM on the last warmup day. The value will be on a zone-by-zone basis for each time step in the simulation.
