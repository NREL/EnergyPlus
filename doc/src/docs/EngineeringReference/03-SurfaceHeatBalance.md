...
<div>$$T(z,t)=\bar{T}_{s} - \Delta\bar{T}_{s} \cdot e^{-z \cdot \sqrt{\frac{\pi}{\alpha\tau}}} \cdot cos\left( \frac{2\pi t}{\alpha t} - \theta \right)$$</div>

Where:
<div>$$T(z,t)$$</div> is the undisturbed ground temperature as a function of time and depth
<div>$$\bar{T}_{s}$$</div> is the average annual soil surface temperature, in deg C
<div>$$\Delta\bar{T}_{s}$$</div> is the amplitude of the soil temperature change throughout the year, in deg C
...
<div>$$\theta_{n}$$</div> is the n-th phase shift, or day of minimum surface temperature
<div>$$\alpha$$</div> is the themal diffusivity of the ground
<div>$$\tau$$</div> is time constant, 365.
