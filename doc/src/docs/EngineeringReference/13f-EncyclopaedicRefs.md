...
<span>$\dot m_{water,avg}$</span>       = average condenser water mass flow rate for the time step (kg/s)

<span>$\dot V_{water}$</span>            = condenser water volumetric flow rate, user input (m<sup>3</sup>/s)

<span>${\rho_{water}}$</span>            = density of condenser inlet water (kg/m<sup>3</sup>)

<span>$\dot m_{air,avg}$</span>         = average evaporator/fan air mass flow rate for the time step (kg/s)

<span>$\dot V_{air}$</span>               = evaporator/fan air volumetric flow rate, user input (m<sup>3</sup>/s)
