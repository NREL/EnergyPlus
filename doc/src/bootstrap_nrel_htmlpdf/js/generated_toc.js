...
generated_toc = {
  generate: function() {
    ...
    headings_to_treat = {"h3":''};
    for (var i=2; i>= parseInt(generate_from); i--) {
    ...
    cur_list_el.style.display = "block"; //display_initially;
    ...
    a.appendChild(document.createTextNode("Table of contents")); //toggle_initially));
    p.appendChild(a);
  ...
  wrapOpenClose: function(a, cur_list_el) {
    ...
    return function(e) {
      ...
      a.firstChild.nodeValue = (d == 'block' ? 'Show' : '') + ' Table of contents';
