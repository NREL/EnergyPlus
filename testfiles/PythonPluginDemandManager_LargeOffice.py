...
class DetermineCurrentDemandManageState(EnergyPlusPlugin):
    ...
    def get_handles(self, state):
        self.sensors['CurntFacilityElectDemand'] = self.api.exchange.get_variable_handle(state, 'Facility Total Electricity Demand Power', 'Whole Building')
...
class DispatchDemandControlsByState(EnergyPlusPlugin):
    ...
    def get_handles(self, state):
        ...
        self.actuators['Set_Perimeter_top_ZN_4_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_top_ZN_4_Lights')
        self.actuators['Set_Basement_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Basement_Lights')
        self.actuators['Set_Perimeter_bot_ZN_4_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_bot_ZN_4_Lights')
        self.actuators['Set_Perimeter_mid_ZN_1_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_mid_ZN_1_Lights')
        self.actuators['Set_Perimeter_mid_ZN_2_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_mid_ZN_2_Lights')
        self.actuators['Set_Perimeter_bot_ZN_1_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_bot_ZN_1_Lights')
        self.actuators['Set_Core_mid_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Core_mid_Lights')
        self.actuators['Set_Perimeter_bot_ZN_3_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_bot_ZN_3_Lights')
        self.actuators['Set_Perimeter_mid_ZN_4_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_mid_ZN_4_Lights')
        self.actuators['Set_Perimeter_bot_ZN_2_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_bot_ZN_2_Lights')
        self.actuators['Set_Perimeter_top_ZN_2_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_top_ZN_2_Lights')
        self.actuators['Set_Perimeter_mid_ZN_3_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_mid_ZN_3_Lights')
        self.actuators['Set_Perimeter_top_ZN_1_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_top_ZN_1_Lights')
        self.actuators['Set_Perimeter_top_ZN_3_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Perimeter_top_ZN_3_Lights')
        self.actuators['Set_Core_top_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Core_top_Lights')
        self.actuators['Set_Core_bottom_Lights'] = self.api.exchange.get_actuator_handle(state, 'Lights', 'Electric Power Level', 'Core_bottom_Lights')
