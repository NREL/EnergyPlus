...
class PythonSetpointManagers(EnergyPlusPlugin):
    ...
    def vav_5_sched_setpoint(self):
        self.values["Seasonal_Reset_SAT_Sched"] = self.e.get_variable_value(self.handles["Seasonal_Reset_SAT_Sched"])
        self.e.set_actuator_value(self.handles["VAV_5_SAT_setpoint"], self.values["Seasonal_Reset_SAT_Sched"])

    def vav_5_mixed_air_managers(self):
        T_VAV5FanOut = self.e.get_variable_value(self.handles["T_VAV5FanOut"])
        T_VAV5FanIn = self.e.get_variable_value(self.handles["T_VAV5FanIn"])
        set_val = self.values["Seasonal_Reset_SAT_Sched"] - (T_VAV5FanOut - T_VAV5FanIn)
        self.e.set_actuator_value(self.handles["VAV_5_CoolC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_5_HeatC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_5_OA_Setpoint"], set_val)

    def vav_1_sched_setpoint(self):
        self.e.set_actuator_value(self.handles["VAV_1_SAT_setpoint"], self.values["Seasonal_Reset_SAT_Sched"])

    def vav_1_mixed_air_managers(self):
        T_VAV1FanOut = self.e.get_variable_value(self.handles["T_VAV1FanOut"])
        T_VAV1FanIn = self.e.get_variable_value(self.handles["T_VAV1FanIn"])
        set_val = self.values["Seasonal_Reset_SAT_Sched"] - (T_VAV1FanOut - T_VAV1FanIn)
        self.e.set_actuator_value(self.handles["VAV_1_CoolC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_1_HeatC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_1_OA_Setpoint"], set_val)

    def vav_3_sched_setpoint(self):
        self.e.set_actuator_value(self.handles["VAV_3_SAT_setpoint"], self.values["Seasonal_Reset_SAT_Sched"])

    def vav_3_mixed_air_managers(self):
        T_VAV3FanOut = self.e.get_variable_value(self.handles["T_VAV3FanOut"])
        T_VAV3FanIn = self.e.get_variable_value(self.handles["T_VAV3FanIn"])
        set_val = self.values["Seasonal_Reset_SAT_Sched"] - (T_VAV3FanOut - T_VAV3FanIn)
        self.e.set_actuator_value(self.handles["VAV_3_CoolC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_3_HeatC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_3_OA_Setpoint"], set_val)

    def vav_2_sched_setpoint(self):
        self.e.set_actuator_value(self.handles["VAV_2_SAT_setpoint"], self.values["Seasonal_Reset_SAT_Sched"])

    def vav_2_mixed_air_managers(self):
        T_VAV2FanOut = self.e.get_variable_value(self.handles["T_VAV2FanOut"])
        T_VAV2FanIn = self.e.get_variable_value(self.handles["T_VAV2FanIn"])
        set_val = self.values["Seasonal_Reset_SAT_Sched"] - (T_VAV2FanOut - T_VAV2FanIn)
        self.e.set_actuator_value(self.handles["VAV_2_CoolC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_2_HeatC_Setpoint"], set_val)
        self.e.set_actuator_value(self.handles["VAV_2_OA_Setpoint"], set_val)

    def cool_sys_1_sched_setpoint(self):
        set_val = self.e.get_variable_value(self.handles["CW_Loop_Temp_Schedule"])
        self.e.set_actuator_value(self.handles["CoolSys1_Loop_Setpoint"], set_val)

    def heat_sys_1_sched_setpoint(self):
        set_val = self.e.get_variable_value(self.handles["HW_Loop_Temp_Schedule"])
        self.e.set_actuator_value(self.handles["HeatSys1_Loop_Setpoint"], set_val)

    def shw_sys_1_sched_setpoint(self):
        set_val = self.e.get_variable_value(self.handles["SHWSys1_Loop_Temp_Schedule"])
        self.e.set_actuator_value(self.handles["SHWSys1_Loop_Setpoint"], set_val)

    def vav_5_night_cycle_mgr(self):
        self.values["heating_setpoint"] = self.e.get_variable_value(self.handles["heating_setpoint"])
        self.values["cooling_setpoint"] = self.e.get_variable_value(self.handles["cooling_setpoint"])
        ...
        TzoneVAV5 = self.e.get_variable_value(self.handles["TzoneVAV5"])
        if TzoneVAV5 < VAV5_heating_TurnOn:
            self.e.set_actuator_value(self.handles["VAV_5_NightCycleStatus"], self.CycleOn)
            return
        else:
            self.e.set_actuator_value(self.handles["VAV_5_NightCycleStatus"], self.NoAction)
    ...
    def vav_1_night_cycle_mgr(self):
        ...
        TzoneVAV1_1 = self.e.get_variable_value(self.handles["TzoneVAV1_1"])
        TzoneVAV1_2 = self.e.get_variable_value(self.handles["TzoneVAV1_2"])
        TzoneVAV1_3 = self.e.get_variable_value(self.handles["TzoneVAV1_3"])
        TzoneVAV1_4 = self.e.get_variable_value(self.handles["TzoneVAV1_4"])
        TzoneVAV1_5 = self.e.get_variable_value(self.handles["TzoneVAV1_5"])
        ...
        if Tmin < VAV1_heating_TurnOn:
            self.e.set_actuator_value(self.handles["VAV_1_NightCycleStatus"], self.CycleOn)
            return
        elif Tmin > VAV1_heating_TurnOff:
            self.e.set_actuator_value(self.handles["VAV_1_NightCycleStatus"], self.NoAction)
    ...
    def vav_2_night_cycle_mgr(self):
        ...
        TzoneVAV2_1 = self.e.get_variable_value(self.handles["TzoneVAV2_1"])
        TzoneVAV2_2 = self.e.get_variable_value(self.handles["TzoneVAV2_2"])
        TzoneVAV2_3 = self.e.get_variable_value(self.handles["TzoneVAV2_3"])
        TzoneVAV2_4 = self.e.get_variable_value(self.handles["TzoneVAV2_4"])
        TzoneVAV2_5 = self.e.get_variable_value(self.handles["TzoneVAV2_5"])
        ...
        if Tmin < VAV2_heating_TurnOn:
            self.e.set_actuator_value(self.handles["VAV_2_NightCycleStatus"], self.CycleOn)
            return
        elif Tmin > VAV2_heating_TurnOff:
            self.e.set_actuator_value(self.handles["VAV_2_NightCycleStatus"], self.NoAction)
    ...
    def vav_3_night_cycle_mgr(self):
        ...
        TzoneVAV3_1 = self.e.get_variable_value(self.handles["TzoneVAV3_1"])
        TzoneVAV3_2 = self.e.get_variable_value(self.handles["TzoneVAV3_2"])
        TzoneVAV3_3 = self.e.get_variable_value(self.handles["TzoneVAV3_3"])
        TzoneVAV3_4 = self.e.get_variable_value(self.handles["TzoneVAV3_4"])
        TzoneVAV3_5 = self.e.get_variable_value(self.handles["TzoneVAV3_5"])
        ...
        if Tmin < VAV3_heating_TurnOn:
            self.e.set_actuator_value(self.handles["VAV_3_NightCycleStatus"], self.CycleOn)
            return
