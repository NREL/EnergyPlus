...
For each exhaust system, the central exhaust flow (design, total, max, and min), temperature and humidity conditions will be added to a table named "Exhaust Systems". For each exhaust system reported, the flow conditions at each individual zone exhaust will also be reported.
