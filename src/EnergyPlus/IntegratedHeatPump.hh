...
namespace IntegratedHeatPumps {
	...
	struct IntegratedHeatPumpData // variable speed coil
	{
		...
		// Member Constructor
			...
			int const ODAirInletNodeNum, // oudoor coil inlet Nod
			int const ODAirOutletNodeNum, // oudoor coil outlet Nod
			...
			ODAirInletNodeNum(ODAirInletNodeNum), // oudoor coil inlet Nod
			ODAirOutletNodeNum(ODAirOutletNodeNum), // oudoor coil inlet Nod
