		...
		if ( WriteTabularFiles ) {
			for ( iStyle = 1; iStyle <= numStyles; ++iStyle ) {
				...
				if ( TableStyle( iStyle ) == tableStyleComma ) {
					...
					tbl_stream.open( outputTblCsvFileName );
					if ( ! tbl_stream ) {
					...
					tbl_stream.open( outputTblTabFileName );
					if ( ! tbl_stream ) {
					...
					tbl_stream.open( outputTblHtmFileName );
					if ( ! tbl_stream ) {
					...
					tbl_stream.open( outputTblXmlFileName );
					if ( ! tbl_stream ) {
					...
					tbl_stream.open( outputTblTxtFileName );
					if ( ! tbl_stream ) {
