...
namespace DataSizing {
	...
	Real64 const ScaleSize( 99999.0 );
	...
	Real64 DataCoolingCapPerFloorArea( 0.0 );  // cooling capacity per floor area
	Real64 DataHeatingCapPerFloorArea( 0.0 );  // heating capacity per floor area
