...
Label1000: ;
	...
	SetupSimpleWindowGlazingSystem( int & MaterNum )
	{
		...
		if ( Material( MaterNum ).SimpleWindowUfactor > 4.5 ) {
			...
			Ris = 1.0 / ( 29.436546 * third_power( DeltaSHGCandTsol ) - 21.943415 * second_power( DeltaSHGCandTsol ) + 9.945872 * DeltaSHGCandTsol + 7.426151 );
			Ros = 1.0 / ( 2.225824 * DeltaSHGCandTsol + 20.577080 );
		} else if ( Material( MaterNum ).SimpleWindowUfactor < 3.4 ) {

			Ris = 1.0 / ( 199.8208128 * third_power( DeltaSHGCandTsol ) - 90.639733 * second_power( DeltaSHGCandTsol ) + 19.737055 * DeltaSHGCandTsol + 6.766575 );
			Ros = 1.0 / ( 5.763355 * DeltaSHGCandTsol + 20.541528 );
		} else { // interpolate. 3.4 <= Ufactor <= 4.5
			//inside first
			RLowSide = 1.0 / ( 199.8208128 * third_power( DeltaSHGCandTsol ) - 90.639733 * second_power( DeltaSHGCandTsol ) + 19.737055 * DeltaSHGCandTsol + 6.766575 );
			RHiSide = 1.0 / ( 29.436546 * third_power( DeltaSHGCandTsol ) - 21.943415 * second_power( DeltaSHGCandTsol ) + 9.945872 * DeltaSHGCandTsol + 7.426151 );
		...
		if ( Material( MaterNum ).SimpleWindowVTinputByUser ) {
			...
			Material( MaterNum ).ReflectVisBeamBack = -0.7409 * third_power( Material( MaterNum ).TransVis ) + 1.6531 * second_power( Material( MaterNum ).TransVis ) - 1.2299 * Material( MaterNum ).TransVis + 0.4545;
			...
			Material( MaterNum ).ReflectVisBeamFront = -0.0622 * third_power( Material( MaterNum ).TransVis ) + 0.4277 * second_power( Material( MaterNum ).TransVis ) - 0.4169 * Material( MaterNum ).TransVis + 0.2399;
