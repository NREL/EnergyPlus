...
namespace DataHVACGlobals {
	...
	Array1D_string const cAllCoilTypes( NumAllCoilTypes, { 
		...
		"Coil:Heating:DX:SingleSpeed", //2
		"Coil:Cooling:DX:TwoSpeed", //3
		"CoilSystem:Cooling:DX:HeatExchangerAssisted", //4
		"Coil:Cooling:DX:TwoStageWithHumidityControlMode", //5
		"Coil:WaterHeating:AirToWaterHeatPump:Pumped", //6
		"Coil:WaterHeating:AirToWaterHeatPump:Wrapped", //7
		"Coil:Cooling:DX:MultiSpeed", //8
		"Coil:Heating:DX:MultiSpeed", //9
		"Coil:Heating:Gas", //10
		"Coil:Heating:Gas:MultiStage", //11
		"Coil:Heating:Electric", //12
		"Coil:Heating:Electric:MultiStage", //13
		"Coil:Heating:Desuperheater", //14
		"Coil:Cooling:Water", //15
		"Coil:Cooling:Water:DetailedGeometry", //16
		"Coil:Heating:Water", //17
		"Coil:Heating:Steam", //18
		"CoilSystem:Cooling:Water:HeatExchangerAssisted", //19
		"Coil:Cooling:WaterToAirHeatPump:ParameterEstimation", //20
		"Coil:Heating:WaterToAirHeatPump:ParameterEstimation", //21
		"Coil:Cooling:WaterToAirHeatPump:EquationFit", //22
		"Coil:Heating:WaterToAirHeatPump:EquationFit", //23
		"Coil:Cooling:DX:VariableRefrigerantFlow", //24
		"Coil:Heating:DX:VariableRefrigerantFlow", //25
		"Coil:UserDefined", //26
		"Coil:Cooling:DX:SingleSpeed:ThermalStorage", //27
		"Coil:Cooling:WaterToAirHeatPump:VariableSpeedEquationFit", //28
		"Coil:Heating:WaterToAirHeatPump:VariableSpeedEquationFit", //29
		"Coil:Cooling:DX:VariableSpeed", //30
		"Coil:Heating:DX:VariableSpeed", //31
		"Coil:WaterHeating:AirToWaterHeatPump:VariableSpeed" //32
		"Coil:Cooling:DX:VariableRefrigerantFlow:FluidTemperatureControl", //33
		"Coil:Heating:DX:VariableRefrigerantFlow:FluidTemperatureControl" //34
	} );
