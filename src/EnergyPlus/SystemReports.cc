...
//		int countloop;
	...
	)
	{
		...
		static std::unordered_map< std::string, ComponentTypes > const component_map = {
			...
			{ "EVAPORATIVECOOLER:DIRECT:RESEARCHESPECIAL", EVAPORATIVECOOLER_DIRECT_RESEARCHSPECIAL },
			{ "EVAPORATIVECOOLER:INDIRECT:CELDEKPAD", EVAPORATIVECOOLER_INDIRECT_CELDEKPAD },
			{ "EVAPORATIVECOOLER:INDIRECT:RESEARCHESPECIAL", EVAPORATIVECOOLER_INDIRECT_RESEARCHSPECIAL },
