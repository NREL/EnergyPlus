...
SUBROUTINE SetThisVersionVariables()
      VerString='Conversion 9.0 => 9.1'
      VersionNum=9.1
      sVersionNum='9.1'
      IDDFileNameWithPath=TRIM(ProgramPath)//'V9-0-0-Energy+.idd'
      NewIDDFileNameWithPath=TRIM(ProgramPath)//'V9-1-0-Energy+.idd'
      RepVarFileNameWithPath=TRIM(ProgramPath)//'Report Variables 9-0-0 to 9-1-0.csv'
END SUBROUTINE
