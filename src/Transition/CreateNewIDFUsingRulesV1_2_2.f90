!SUBROUTINE CreateNewIDFUsingRulesV1_2_2(EndOfFile,DiffOnly,InLfn,AskForInput,InputFileName,ArgFile,ArgIDFExtension)
          ...
          DO Num=1,NumIDFRecords
            ...
            IF (.not. MakingPretty) THEN
              ...
              SELECT CASE (MakeUPPERCase(TRIM(IDFRecords(Num)%Name)))
                ...
                CASE ('VERSION')
                  IF (InArgs(1)(1:5) == '1.2.2' .and. ArgFile) THEN
  ...
  !!!    Changes for this version
                ...
                CASE ('DESICCANT DEHUMIDIFIER:SOLID')
                  ...
                  IF (OutArgs(7) == 'LEAVING HUMRAT:BYPASS') THEN
                    nodiff=.false.
                    OutArgs(7)='FIXED LEAVING HUMRAT SETPOINT:BYPASS'
                  ENDIF

                CASE ('DOMESTIC HOT WATER')
                  CALL GetNewObjectDefInIDD(ObjectName,  &
                                            NwNumArgs,NwAorN,NwReqFld,NwObjMinFlds,NwFldNames,NwFldDefaults,NwFldUnits)
                  nodiff=.false.  ! superfluous
                  OutArgs(1:3)=InArgs(1:3)
                  OutArgs(4)='1.0'
                  OutArgs(5)=InArgs(4)
                  OutArgs(5)=TRIM(InArgs(1))//':FRF Sch'
                  CurArgs=6
                  ...
                  OutArgs(1)=TRIM(InArgs(1))//':FRF Sch'
                  OutArgs(2)=' '
                ...
                CASE ('UNITARYSYSTEM:HEATPUMP:WATERTOAIR')
                  ...
                  OutArgs(12:13)=InArgs(13:14)
                  OutArgs(14)='2.5'
                  OutArgs(15)='60'
                  OutArgs(16)='0.01'
                  OutArgs(17)='60'
                  OutArgs(18:24)=InArgs(16:22)
                  CurArgs=24
                  nodiff=.false.
                ...
                CASE ('COIL:WATERTOAIRHP:COOLING')
                  ...
                  OutArgs(3)='Water'
                  OutArgs(4)='R22'
                  OutArgs(5:6)=InArgs(3:4)
                  OutArgs(7)='0'
                  OutArgs(8)='0'
                  OutArgs(9:14)=InArgs(5:10)
                  OutArgs(15)=InArgs(13)
                  OutArgs(16)=InArgs(12)
                  OutArgs(17:22)=InArgs(14:19)
                  OutArgs(23)=InArgs(11)
                  OutArgs(24)=' '
                  CurArgs=24
                  nodiff=.false.
                ...
                CASE ('COIL:WATERTOAIRHP:HEATING')
                  ...
                  OutArgs(3)='Water'
                  OutArgs(4)='R22'
                  OutArgs(5:12)=InArgs(3:10)
                  OutArgs(13)=InArgs(12)
                  OutArgs(14:19)=InArgs(13:18)
                  OutArgs(20)=InArgs(11)
                  OutArgs(21)=' '
                  CurArgs=21
                  nodiff=.false.
