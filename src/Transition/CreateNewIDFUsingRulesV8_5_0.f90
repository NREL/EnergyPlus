...
SUBROUTINE SetThisVersionVariables()
      VerString='Conversion 8.4 => 8.5'
      VersionNum=8.5
      sVersionNum='8.5'
      IDDFileNameWithPath=TRIM(ProgramPath)//'V8-4-0-Energy+.idd'
      NewIDDFileNameWithPath=TRIM(ProgramPath)//'V8-5-0-Energy+.idd'
      RepVarFileNameWithPath=TRIM(ProgramPath)//'Report Variables 8-4-0 to 8-5-0.csv'
END SUBROUTINE
