!SUBROUTINE CreateNewIDFUsingRulesV4_0_0(EndOfFile,DiffOnly,InLfn,AskForInput,InputFileName,ArgFile,ArgIDFExtension)
...
!END SUBROUTINE CreateNewIDFUsingRulesV4_0_0
