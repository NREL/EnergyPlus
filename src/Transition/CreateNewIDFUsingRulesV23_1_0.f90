...
SUBROUTINE SetThisVersionVariables()
      ...
      VerString='Conversion 22.2 => 23.1'
      VersionNum=23.1
      ...
      sVersionNum = '***'
      sVersionNumFourChars='23.1'
      IDDFileNameWithPath=TRIM(ProgramPath)//'V22-2-0-Energy+.idd'
      NewIDDFileNameWithPath=TRIM(ProgramPath)//'V23-1-0-Energy+.idd'
      RepVarFileNameWithPath=TRIM(ProgramPath)//'Report Variables 22-2-0 to 23-1-0.csv'
END SUBROUTINE
