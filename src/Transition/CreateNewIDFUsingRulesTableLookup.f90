...
SUBROUTINE SetThisVersionVariables()
      VerString='Conversion 9.0 => 9.0 (with Table:Lookup)'
      VersionNum=9.0
      sVersionNum='9.0'
      IDDFileNameWithPath=TRIM(ProgramPath)//'V9-0-0-Energy+.idd'
      NewIDDFileNameWithPath=TRIM(ProgramPath)//'V9-0-0-Energy+.idd'
      RepVarFileNameWithPath=TRIM(ProgramPath)//'Report Variables 9-0-0 to 9-0-0.csv'
END SUBROUTINE
