!SUBROUTINE CreateNewIDFUsingRulesV2_1_0(EndOfFile,DiffOnly,InLfn,AskForInput,InputFileName,ArgFile,ArgIDFExtension)
...
!END SUBROUTINE CreateNewIDFUsingRulesV2_1_0
