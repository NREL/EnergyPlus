...
PUBLIC          ! By definition, all variables which are placed in this data
          ...
          CHARACTER(len=*), PARAMETER :: ProgramName='GroundTempCalc - Slab'
          CHARACTER(len=*), PARAMETER :: VerString=ProgramName//', Version .75'      ! String that represents version information
          CHARACTER(len=*), PARAMETER :: DefaultIDD='SlabGHT.idd'
          CHARACTER(len=*), PARAMETER :: DefaultIDF='GHTIn.idf'
