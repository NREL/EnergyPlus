#ifndef ObjexxFCL_FArray2_Project_MArray_hh_INCLUDED
#define ObjexxFCL_FArray2_Project_MArray_hh_INCLUDED

// FArray2.Project.MArray: Project-Specific MArray Methods
//
...
//  These are convenience methods to provide near-Fortran syntax for MArray usage
	...
	// Types
	template< typename M > using MA2c = MArray2< FArray2 const, M >;
	template< typename M > using MA2  = MArray2< FArray2, M >;
	...
	inline MA2< FArray1D< double > > mnth() { return ma( &T::mnth ); }

#endif // ObjexxFCL_FArray2_Project_MArray_hh_INCLUDED
