...
*
      END
      PROGRAM LAMCHTEST
      REAL BASE, BASE_LA, EMAX, EMAX_LA, EMIN, EMIN_LA, EPS, EPS_LA,
     $     PREC, PREC_LA, RMAX, RMAX_LA, RMIN, RMIN_LA, RND, RND_LA,
     $     SFMIN, SFMIN_LA, T, T_LA
*     ..
*     .. External Functions ..
      REAL SLAMCH, SLAMCH_LA
      EXTERNAL SLAMCH, SLAMCH_LA
*
         T_LA = SLAMCH_LA('Number of mantissa digits');
         T = SLAMCH('Number of mantissa digits');
         WRITE(*,1000) 'Number of mantissa digits', T_LA, T,
     $                 T_LA-T
*
         SFMIN_LA = SLAMCH_LA('Safe minimum');
         SFMIN = SLAMCH('Safe minimum');
         WRITE(*,1000) 'Safe minimum', SFMIN_LA, SFMIN,
     $                 SFMIN_LA-SFMIN
*
         RND_LA = SLAMCH_LA('Rounding mode');
         RND = SLAMCH('Rounding mode');
         WRITE(*,1000) 'Rounding mode', RND_LA, RND,
     $                 RND_LA-RND
*
         RMIN_LA = SLAMCH_LA('Underflow threshold');
         RMIN = SLAMCH('Underflow threshold');
         WRITE(*,1000) 'Underflow threshold', RMIN_LA, RMIN,
     $                 RMIN_LA-RMIN
*
         RMAX_LA = SLAMCH_LA('Overflow threshold');
         RMAX = SLAMCH('Overflow threshold');
         WRITE(*,1000) 'Overflow threshold', RMAX_LA, RMAX,
     $                 RMAX_LA-RMAX
*
         PREC_LA = SLAMCH_LA('Precision');
         PREC = SLAMCH('Precision');
         WRITE(*,1000) 'Precision', PREC_LA, PREC,
     $                 PREC_LA-PREC
*
         EPS_LA = SLAMCH_LA('Epsilon');
         EPS = SLAMCH('Epsilon');
         WRITE(*,1000) 'Epsilon', EPS_LA, EPS,
     $                 EPS_LA-EPS
*
         EMIN_LA = SLAMCH_LA('Minimum exponent');
         EMIN = SLAMCH('Minimum exponent');
         WRITE(*,1000) 'Minimum exponent', EMIN_LA, EMIN,
     $                 EMIN_LA-EMIN
*
         EMAX_LA = SLAMCH_LA('Largest exponent');
         EMAX = SLAMCH('Largest exponent');
         WRITE(*,1000) 'Largest exponent', EMAX_LA, EMAX,
     $                 EMAX_LA-EMAX
*
         BASE_LA = SLAMCH_LA('Base');
         BASE = SLAMCH('Base');
