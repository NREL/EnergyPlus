...
99998 FORMAT ('                                    ----- PASS -----')
      ...
      real function sdottest(n, x, incx, y, incy)
      integer n, incx, incy
      real x(*), y(*)
      external sdottestsub
      real dot

      call sdottestsub(n, x, incx, y, incy, dot)
      sdottest = dot

      return
      end

      real function sasumtest(n, x, incx)
      integer n, incx
      real x(*)
      external sasumtestsub
      real temp

      call sasumtestsub(n, x, incx, temp)
      sasumtest = temp

      return
      end

      real function snrm2test(n, x, incx)
      integer n, incx
      real x(*)
      external snrm2testsub
      real temp

      call snrm2testsub(n, x, incx, temp)
      snrm2test = temp
