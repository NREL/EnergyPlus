...
99998 FORMAT ('                                    ----- PASS -----')
      END
      double precision function dzasumtest(n, x, incx)
      integer n, incx
      double complex x(*)
      external dzasumtestsub
      double complex temp

      call dzasumtestsub(n, x, incx, temp)
      dzasumtest = temp

      return
      end

      double precision function dznrm2test(n, x, incx)
      integer n, incx
      double complex x(*)
      external dznrm2testsub
      double complex temp

      call dznrm2testsub(n, x, incx, temp)
      dznrm2test = temp
