...
99998 FORMAT ('                                    ----- PASS -----')
      ...
      real function scasumtest(n, x, incx)
      integer n, incx
      complex x(*)
      external scasumtestsub
      complex temp

      call scasumtestsub(n, x, incx, temp)
      scasumtest = temp

      return
      end

      real function scnrm2test(n, x, incx)
      integer n, incx
      complex x(*)
      external scnrm2testsub
      complex temp

      call scnrm2testsub(n, x, incx, temp)
      scnrm2test = temp
