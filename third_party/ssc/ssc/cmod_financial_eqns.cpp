...
#pragma warning(disable : 4297) // ignore warning: 'function assumed not to
...
void Financial_Construction_Financing_Equations(ssc_data_t data) {
  ...
  double total_installed_cost, const_per_percent1, const_per_principal1,
      const_per_interest1, const_per_interest_rate1, const_per_months1,
      const_per_upfront_rate1, const_per_total1, const_per_percent2,
      const_per_principal2, const_per_interest2, const_per_interest_rate2,
      const_per_months2, const_per_upfront_rate2, const_per_total2,
      const_per_percent3, const_per_principal3, const_per_interest3,
      const_per_interest_rate3, const_per_months3, const_per_upfront_rate3,
      const_per_total3, const_per_percent4, const_per_principal4,
      const_per_interest4, const_per_interest_rate4, const_per_months4,
      const_per_upfront_rate4, const_per_total4, const_per_percent5,
      const_per_principal5, const_per_interest5, const_per_interest_rate5,
      const_per_months5, const_per_upfront_rate5, const_per_total5,
      const_per_principal_total, const_per_percent_total,
      construction_financing_cost, const_per_interest_total;
  ...
  const_per_principal1 =
      Const_per_principal(const_per_percent1, total_installed_cost);
  const_per_interest1 = Const_per_interest(
      const_per_principal1, const_per_interest_rate1, const_per_months1);
  const_per_total1 = Const_per_total(const_per_interest1, const_per_principal1,
  ...
  const_per_principal2 =
      Const_per_principal(const_per_percent2, total_installed_cost);
  const_per_interest2 = Const_per_interest(
      const_per_principal2, const_per_interest_rate2, const_per_months2);
  const_per_total2 = Const_per_total(const_per_interest2, const_per_principal2,
  ...
  const_per_principal3 =
      Const_per_principal(const_per_percent3, total_installed_cost);
  const_per_interest3 = Const_per_interest(
      const_per_principal3, const_per_interest_rate3, const_per_months3);
  const_per_total3 = Const_per_total(const_per_interest3, const_per_principal3,
  ...
  const_per_principal4 =
      Const_per_principal(const_per_percent4, total_installed_cost);
  const_per_interest4 = Const_per_interest(
      const_per_principal4, const_per_interest_rate4, const_per_months4);
  const_per_total4 = Const_per_total(const_per_interest4, const_per_principal4,
  ...
  const_per_principal5 =
      Const_per_principal(const_per_percent5, total_installed_cost);
  const_per_interest5 = Const_per_interest(
      const_per_principal5, const_per_interest_rate5, const_per_months5);
  const_per_total5 = Const_per_total(const_per_interest5, const_per_principal5,
  ...
  const_per_principal_total = const_per_principal1 + const_per_principal2 +
                              const_per_principal3 + const_per_principal4 +
                              const_per_principal5;
  const_per_percent_total = const_per_percent1 + const_per_percent2 +
                            const_per_percent3 + const_per_percent4 +
                            const_per_percent5;
  construction_financing_cost = const_per_total1 + const_per_total2 +
                                const_per_total3 + const_per_total4 +
                                const_per_total5;
  const_per_interest_total = const_per_interest1 + const_per_interest2 +
                             const_per_interest3 + const_per_interest4 +
                             const_per_interest5;
