...
// in order to get MS V2017 update 2 to build without a bunch of C4996
// "std::tr1:warning..."
...
GTEST_API_ int main(int argc, char **argv) {
  ...
  //"CMPvsamv1PowerIntegration.NoFinancialModelShading";
  //	::testing::GTEST_FLAG(filter) =
  //"CMPvwattsV5Integration.DifferentTechnologyInputs";
  //	::testing::GTEST_FLAG(filter) =
  ...
  //	::testing::GTEST_FLAG(filter) =
  //"CMPvsamv1PowerIntegration_cmod_pvsamv1.DefaultNoFinancialModel";
  //	::testing::GTEST_FLAG(filter) =
  //"CMPvsamv1PowerIntegration_cmod_pvsamv1.NoFinancialModelCustomWeatherFile";
