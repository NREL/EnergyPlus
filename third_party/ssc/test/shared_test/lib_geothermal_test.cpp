...
TEST_F(GeothermalPlantAnalyzer, TestFlashPlant_lib_geothermal) {
  ...
  EXPECT_EQ(geoPlant_outputs.flash_count,
            2); // Dual Flash (Constrained) Plant Type
  EXPECT_NEAR(geoPlant_outputs.md_GrossPlantOutputMW, 33.978,
              1); // Expected value of 33.978 taken from GETEM
