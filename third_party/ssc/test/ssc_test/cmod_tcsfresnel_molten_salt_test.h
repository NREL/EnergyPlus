...
/**
 * CMTcsFresnelMoltenSalt tests the cmod_tcsfesnel_molten_salt using the SAM code generator to generate data
 * Eventually a method can be written to write this data to a vartable so that lower-level methods of
 * tcsfesnel_molten_salt can be tested
 * For now, this uses the SSCAPI interfaces to run the compute module and compare results
 */
class CMTcsFresnelMoltenSalt : public ::testing::Test {
