...
TEST_F(CMBattwatts_cmod_battwatts, ResidentialDefaults) {
  ...
  ssc_number_t peakKwDischarge =
      *std::max_element(batt_power_data.begin(), batt_power_data.end());
  ssc_number_t peakKwCharge =
      *std::min_element(batt_power_data.begin(), batt_power_data.end());
  ...
  ssc_number_t peakVoltage =
      *std::max_element(batt_voltage.begin(), batt_voltage.end());
