...
namespace FenestrationCommon
{
    ...
    // Interpolate - this will create common wavelength set which minimum and maximum values will
    // not exceed
    //               any wavelength set that is interpolated
    // Extrapolate - will create common wavelength set that minimum and maximum will exceed any
    // wavelength set
    ...
    private:
        ...
        std::vector<double> combineWavelegths(std::vector<double> const & t_wv1,
                                              std::vector<double> const & t_wv2,
                                              Combine const t_Combination) const;
