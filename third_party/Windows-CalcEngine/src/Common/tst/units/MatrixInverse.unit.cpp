...
TEST_F(TestMatrixInverse, Test1)
{
    ...
    SquareMatrix inverseCorrect{
      {0.048264485, 1.316176934, -1.243204967}, {0.17492546, 0.105952357, -0.193271643}, {-0.15464132, -1.196521292, 1.320573929}};
...
TEST_F(TestMatrixInverse, Test2)
{
    ...
    SquareMatrix a{{2.59, 1.48, 9.54, 4.16}, {9.45, 7.25, 6.58, 4.95}, {2.12, 5.36, 4.98, 8.23}, {4.89, 1.11, 7.45, 3.26}};
