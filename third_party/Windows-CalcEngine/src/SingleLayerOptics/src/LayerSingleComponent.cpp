...
namespace SingleLayerOptics
{
    ...
    CLayerSingleComponent::CLayerSingleComponent(const double t_Tf,
                                                 const double t_Rf,
                                                 const double t_Tb,
                                                 const double t_Rb)
    {
        m_Surface[Side::Front] = std::make_shared<CSurface>(t_Tf, t_Rf);
        m_Surface[Side::Back] = std::make_shared<CSurface>(t_Tb, t_Rb);
    }
