...
protected:
	virtual void SetUp() {
		...
		// Segment 3
		std::shared_ptr< CPoint2D > aStartPoint3 = std::make_shared< CPoint2D >( 10, 10 );
		std::shared_ptr< CPoint2D > aEndPoint3 = std::make_shared< CPoint2D >( 20, 10 );
		...
		// Segment 4
		std::shared_ptr< CPoint2D > aStartPoint4 = std::make_shared< CPoint2D >( 20, 10 );
