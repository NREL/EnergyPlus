...
GLFWbool _glfwInitVulkan(int mode) {
  ...
  _glfw.vk.GetInstanceProcAddr =
      (PFN_vkGetInstanceProcAddr)_glfw_dlsym(_glfw.vk.handle, "vkGetInstanceProcAddr");
...
GLFWAPI VkResult glfwCreateWindowSurface(VkInstance instance, GLFWwindow *handle,
  ...
  *surface = VK_NULL_HANDLE;
  ...
  if (window->context.client != GLFW_NO_API) {
    _glfwInputError(GLFW_INVALID_VALUE, "Vulkan: Window surface creation requires the window to "
