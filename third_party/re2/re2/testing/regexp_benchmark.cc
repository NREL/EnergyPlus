...
void Test() {
  ...
  StringPiece sp[4];
  CHECK(prog->SearchOnePass(text, text, Prog::kAnchored, Prog::kFullMatch, sp,
                            4));
...
void MemoryUsage() {
  ...
  fprintf(stderr, "sizeof: PCRE=%zd RE2=%zd Prog=%zd Inst=%zd\n", sizeof(PCRE),
          sizeof(RE2), sizeof(Prog), sizeof(Prog::Inst));
}
...
void Search_Easy0_CachedDFA(int i, int n) {
  Search(i, n, EASY0, SearchCachedDFA);
}
void Search_Easy0_CachedNFA(int i, int n) {
  Search(i, n, EASY0, SearchCachedNFA);
}
void Search_Easy0_CachedPCRE(int i, int n) {
  Search(i, n, EASY0, SearchCachedPCRE);
}
void Search_Easy0_CachedRE2(int i, int n) {
  Search(i, n, EASY0, SearchCachedRE2);
}

BENCHMARK_RANGE(Search_Easy0_CachedDFA, 8, 16 << 20)->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Easy0_CachedNFA, 8, 256 << 10)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_Easy0_CachedPCRE, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_Easy0_CachedRE2, 8, 16 << 20)->ThreadRange(1, NumCPUs());

void Search_Easy1_CachedDFA(int i, int n) {
  Search(i, n, EASY1, SearchCachedDFA);
}
void Search_Easy1_CachedNFA(int i, int n) {
  Search(i, n, EASY1, SearchCachedNFA);
}
void Search_Easy1_CachedPCRE(int i, int n) {
  Search(i, n, EASY1, SearchCachedPCRE);
}
void Search_Easy1_CachedRE2(int i, int n) {
  Search(i, n, EASY1, SearchCachedRE2);
}

BENCHMARK_RANGE(Search_Easy1_CachedDFA, 8, 16 << 20)->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Easy1_CachedNFA, 8, 256 << 10)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_Easy1_CachedPCRE, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_Easy1_CachedRE2, 8, 16 << 20)->ThreadRange(1, NumCPUs());

void Search_Medium_CachedDFA(int i, int n) {
  Search(i, n, MEDIUM, SearchCachedDFA);
}
void Search_Medium_CachedNFA(int i, int n) {
  Search(i, n, MEDIUM, SearchCachedNFA);
}
void Search_Medium_CachedPCRE(int i, int n) {
  Search(i, n, MEDIUM, SearchCachedPCRE);
}
void Search_Medium_CachedRE2(int i, int n) {
  Search(i, n, MEDIUM, SearchCachedRE2);
}

BENCHMARK_RANGE(Search_Medium_CachedDFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Medium_CachedNFA, 8, 256 << 10)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_Medium_CachedPCRE, 8, 256 << 10)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_Medium_CachedRE2, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());

void Search_Hard_CachedDFA(int i, int n) {
  Search(i, n, HARD, SearchCachedDFA);
}
void Search_Hard_CachedNFA(int i, int n) {
  Search(i, n, HARD, SearchCachedNFA);
}
void Search_Hard_CachedPCRE(int i, int n) {
  Search(i, n, HARD, SearchCachedPCRE);
}
void Search_Hard_CachedRE2(int i, int n) {
  Search(i, n, HARD, SearchCachedRE2);
}
...
void Search_Fanout_CachedDFA(int i, int n) {
  Search(i, n, FANOUT, SearchCachedDFA);
}
void Search_Fanout_CachedNFA(int i, int n) {
  Search(i, n, FANOUT, SearchCachedNFA);
}
void Search_Fanout_CachedPCRE(int i, int n) {
  Search(i, n, FANOUT, SearchCachedPCRE);
}
void Search_Fanout_CachedRE2(int i, int n) {
  Search(i, n, FANOUT, SearchCachedRE2);
}

BENCHMARK_RANGE(Search_Fanout_CachedDFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Fanout_CachedNFA, 8, 256 << 10)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_Fanout_CachedPCRE, 8, 4 << 10)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_Fanout_CachedRE2, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());

void Search_Parens_CachedDFA(int i, int n) {
  Search(i, n, PARENS, SearchCachedDFA);
}
void Search_Parens_CachedNFA(int i, int n) {
  Search(i, n, PARENS, SearchCachedNFA);
}
void Search_Parens_CachedPCRE(int i, int n) {
  Search(i, n, PARENS, SearchCachedPCRE);
}
void Search_Parens_CachedRE2(int i, int n) {
  Search(i, n, PARENS, SearchCachedRE2);
}

BENCHMARK_RANGE(Search_Parens_CachedDFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Parens_CachedNFA, 8, 256 << 10)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_Parens_CachedPCRE, 8, 8)->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_Parens_CachedRE2, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
...
void Search_BigFixed_CachedDFA(int i, int n) {
  SearchBigFixed(i, n, SearchCachedDFA);
}
void Search_BigFixed_CachedNFA(int i, int n) {
  SearchBigFixed(i, n, SearchCachedNFA);
}
void Search_BigFixed_CachedPCRE(int i, int n) {
  SearchBigFixed(i, n, SearchCachedPCRE);
}
void Search_BigFixed_CachedRE2(int i, int n) {
  SearchBigFixed(i, n, SearchCachedRE2);
}

BENCHMARK_RANGE(Search_BigFixed_CachedDFA, 8, 1 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_BigFixed_CachedNFA, 8, 32 << 10)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_BigFixed_CachedPCRE, 8, 32 << 10)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_BigFixed_CachedRE2, 8, 1 << 20)
    ->ThreadRange(1, NumCPUs());
...
void SearchSuccess(int iters, int nbytes, const char *regexp,
                   SearchImpl *search) {
  StopBenchmarkTiming();
  std::string s;
  MakeText(&s, nbytes);
...
void Search_Success_CachedDFA(int i, int n) {
  SearchSuccess(i, n, ".*$", SearchCachedDFA);
}
void Search_Success_CachedNFA(int i, int n) {
  SearchSuccess(i, n, ".*$", SearchCachedNFA);
}
void Search_Success_CachedPCRE(int i, int n) {
  SearchSuccess(i, n, ".*$", SearchCachedPCRE);
}
void Search_Success_CachedRE2(int i, int n) {
  SearchSuccess(i, n, ".*$", SearchCachedRE2);
}
void Search_Success_CachedOnePass(int i, int n) {
  SearchSuccess(i, n, ".*$", SearchCachedOnePass);
}

BENCHMARK_RANGE(Search_Success_CachedDFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Success_CachedNFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_Success_CachedPCRE, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_Success_CachedRE2, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Success_CachedOnePass, 8, 2 << 20)
    ->ThreadRange(1, NumCPUs());
...
void Search_Success1_DFA(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchDFA);
}
void Search_Success1_NFA(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchNFA);
}
void Search_Success1_PCRE(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchPCRE);
}
void Search_Success1_RE2(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchRE2);
}
void Search_Success1_BitState(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchBitState);
}
...
BENCHMARK_RANGE(Search_Success1_BitState, 8, 2 << 20)
    ->ThreadRange(1, NumCPUs());

void Search_Success1_CachedDFA(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchCachedDFA);
}
void Search_Success1_CachedNFA(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchCachedNFA);
}
void Search_Success1_CachedPCRE(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchCachedPCRE);
}
void Search_Success1_CachedRE2(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchCachedRE2);
}
void Search_Success1_CachedBitState(int i, int n) {
  SearchSuccess(i, n, ".*\\C$", SearchCachedBitState);
}

BENCHMARK_RANGE(Search_Success1_CachedDFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Success1_CachedNFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_Success1_CachedPCRE, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_Success1_CachedRE2, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_Success1_CachedBitState, 8, 2 << 20)
    ->ThreadRange(1, NumCPUs());
...
void Search_AltMatch_OnePass(int i, int n) {
  SearchAltMatch(i, n, SearchOnePass);
}
void Search_AltMatch_BitState(int i, int n) {
  SearchAltMatch(i, n, SearchBitState);
}
...
BENCHMARK_RANGE(Search_AltMatch_OnePass, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_AltMatch_BitState, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
...
void Search_AltMatch_CachedDFA(int i, int n) {
  SearchAltMatch(i, n, SearchCachedDFA);
}
void Search_AltMatch_CachedNFA(int i, int n) {
  SearchAltMatch(i, n, SearchCachedNFA);
}
void Search_AltMatch_CachedOnePass(int i, int n) {
  SearchAltMatch(i, n, SearchCachedOnePass);
}
void Search_AltMatch_CachedBitState(int i, int n) {
  SearchAltMatch(i, n, SearchCachedBitState);
}
void Search_AltMatch_CachedPCRE(int i, int n) {
  SearchAltMatch(i, n, SearchCachedPCRE);
}
void Search_AltMatch_CachedRE2(int i, int n) {
  SearchAltMatch(i, n, SearchCachedRE2);
}

BENCHMARK_RANGE(Search_AltMatch_CachedDFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_AltMatch_CachedNFA, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_AltMatch_CachedOnePass, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
BENCHMARK_RANGE(Search_AltMatch_CachedBitState, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#ifdef USEPCRE
BENCHMARK_RANGE(Search_AltMatch_CachedPCRE, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
#endif
BENCHMARK_RANGE(Search_AltMatch_CachedRE2, 8, 16 << 20)
    ->ThreadRange(1, NumCPUs());
...
void Parse_CachedDigits_Backtrack(int i) {
  Parse3Digits(i, Parse3CachedBacktrack);
}
void Parse_CachedDigits_BitState(int i) {
  Parse3Digits(i, Parse3CachedBitState);
}
...
void Parse_CachedDigitDs_OnePass(int i) {
  Parse3DigitDs(i, Parse3CachedOnePass);
}
...
void Parse_CachedDigitDs_Backtrack(int i) {
  Parse3DigitDs(i, Parse3CachedBacktrack);
}
void Parse_CachedDigitDs_BitState(int i) {
  Parse3DigitDs(i, Parse3CachedBitState);
}
...
void Parse_CachedSplitHard_BitState(int i) {
  Parse1SplitHard(i, Parse1CachedBitState);
}
void Parse_CachedSplitHard_Backtrack(int i) {
  Parse1SplitHard(i, Parse1CachedBacktrack);
}
...
void Parse_CachedSplitBig1_PCRE(int i) {
  Parse1SplitBig1(i, SearchParse1CachedPCRE);
}
void Parse_CachedSplitBig1_RE2(int i) {
  Parse1SplitBig1(i, SearchParse1CachedRE2);
}
...
void Parse_CachedSplitBig2_PCRE(int i) {
  Parse1SplitBig2(i, SearchParse1CachedPCRE);
}
void Parse_CachedSplitBig2_RE2(int i) {
  Parse1SplitBig2(i, SearchParse1CachedRE2);
}
...
DEFINE_string(compile_regexp, "(.*)-(\\d+)-of-(\\d+)",
...
void BM_Regexp_Simplify(int i) {
  RunBuild(i, FLAGS_compile_regexp, SimplifyRegexp);
}
void BM_CompileToProg(int i) {
  RunBuild(i, FLAGS_compile_regexp, CompileToProg);
}
void BM_CompileByteMap(int i) {
  RunBuild(i, FLAGS_compile_regexp, CompileByteMap);
}
void BM_Regexp_Compile(int i) {
  RunBuild(i, FLAGS_compile_regexp, CompileRegexp);
}
void BM_Regexp_SimplifyCompile(int i) {
  RunBuild(i, FLAGS_compile_regexp, SimplifyCompileRegexp);
}
void BM_Regexp_NullWalk(int i) {
  RunBuild(i, FLAGS_compile_regexp, NullWalkRegexp);
}
...
#define MY_BENCHMARK_WITH_ARG(n, a) \
  bool __benchmark_ ## n ## a =     \
    (new ::testing::Benchmark(#n, NewPermanentCallback(&n)))->ThreadRange(1,
NumCPUs());
...
void SearchCachedBitState(int iters, const char *regexp,
...
void Parse3BitState(int iters, const char *regexp, const StringPiece &text) {
  for (int i = 0; i < iters; i++) {
    ...
    CHECK(prog->CanBitState());
    StringPiece sp[4]; // 4 because sp[0] is whole match.
    CHECK(prog->SearchBitState(text, text, Prog::kAnchored, Prog::kFullMatch,
                               sp, 4));
    delete prog;
    re->Decref();
  }
...
void Parse3Backtrack(int iters, const char *regexp, const StringPiece &text) {
  for (int i = 0; i < iters; i++) {
    ...
    CHECK(prog);
    StringPiece sp[4]; // 4 because sp[0] is whole match.
    CHECK(prog->UnsafeSearchBacktrack(text, text, Prog::kAnchored,
                                      Prog::kFullMatch, sp, 4));
    delete prog;
    re->Decref();
  }
...
void Parse3CachedOnePass(int iters, const char *regexp,
...
void Parse3CachedBitState(int iters, const char *regexp,
                          const StringPiece &text) {
  Regexp *re = Regexp::Parse(regexp, Regexp::LikePerl, NULL);
  CHECK(re);
  Prog *prog = re->CompileToProg(0);
...
void Parse3CachedBacktrack(int iters, const char *regexp,
                           const StringPiece &text) {
  Regexp *re = Regexp::Parse(regexp, Regexp::LikePerl, NULL);
  CHECK(re);
  Prog *prog = re->CompileToProg(0);
...
void Parse1CachedOnePass(int iters, const char *regexp,
                         const StringPiece &text) {
  Regexp *re = Regexp::Parse(regexp, Regexp::LikePerl, NULL);
  CHECK(re);
  Prog *prog = re->CompileToProg(0);
...
void Parse1CachedBitState(int iters, const char *regexp,
                          const StringPiece &text) {
  Regexp *re = Regexp::Parse(regexp, Regexp::LikePerl, NULL);
  CHECK(re);
  Prog *prog = re->CompileToProg(0);
...
void Parse1CachedBacktrack(int iters, const char *regexp,
                           const StringPiece &text) {
  Regexp *re = Regexp::Parse(regexp, Regexp::LikePerl, NULL);
  CHECK(re);
  Prog *prog = re->CompileToProg(0);
...
static std::string smallhttp_text = "GET /abc HTTP/1.1";
...
void PossibleMatchRange_Trivial(int i) { PossibleMatchRangeCommon(i, ".*"); }
