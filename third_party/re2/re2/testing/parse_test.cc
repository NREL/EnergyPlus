...
static Test tests[] = {
    ...
    {"(?i)\\W", "cc{0-0x2f 0x3a-0x40 0x5b-0x5e 0x60 0x7b-0x17e 0x180-0x2129 "
                "0x212b-0x10ffff}"},
...
void TestParse(const Test *tests, int ntests, Regexp::ParseFlags flags,
  ...
  for (int i = 0; i < ntests; i++) {
    ...
    EXPECT_EQ(std::string(tests[i].parse), s)
        ...
        << "\nparse: " << std::string(tests[i].parse) << " s: " << s
        << " flag=" << f;
  }
...
Test prefix_tests[] = {
    ...
    {"n|r|rs", "alt{lit{n}cat{lit{r}alt{emp{}lit{s}}}}"},
    {"n|rs|r", "alt{lit{n}cat{lit{r}alt{lit{s}emp{}}}}"},
    {"r|rs|n", "alt{cat{lit{r}alt{emp{}lit{s}}}lit{n}}"},
    {"rs|r|n", "alt{cat{lit{r}alt{lit{s}emp{}}}lit{n}}"},
    {"a\\C*?c|a\\C*?b",
     "cat{lit{a}alt{cat{nstar{byte{}}lit{c}}cat{nstar{byte{}}lit{b}}}}"},
    {"^/a/bc|^/a/de", "cat{bol{}cat{str{/a/}alt{str{bc}str{de}}}}"},
...
Test nested_tests[] = {
    {"((((((((((x{2}){2}){2}){2}){2}){2}){2}){2}){2}))",
     "cap{cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 "
     "cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 "
     "lit{x}}}}}}}}}}}}}}}}}}}}"},
    {"((((((((((x{1}){2}){2}){2}){2}){2}){2}){2}){2}){2})",
     "cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 "
     "cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{1,1 "
     "lit{x}}}}}}}}}}}}}}}}}}}}}"},
    {"((((((((((x{0}){2}){2}){2}){2}){2}){2}){2}){2}){2})",
     "cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 "
     "cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 cap{rep{0,0 "
     "lit{x}}}}}}}}}}}}}}}}}}}}}"},
    {"((((((x{2}){2}){2}){5}){5}){5})",
     "cap{rep{5,5 cap{rep{5,5 cap{rep{5,5 cap{rep{2,2 cap{rep{2,2 cap{rep{2,2 "
     "lit{x}}}}}}}}}}}}}"},
};
