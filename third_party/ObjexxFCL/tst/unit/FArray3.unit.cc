...
TEST( FArray3Test, ConstructDefault )
{
	FArray3D_int A;
	EXPECT_EQ( 0u, A.size() );
	...
	EXPECT_EQ( 0, A.u2() );
	EXPECT_EQ( 0, A.u3() );
	EXPECT_EQ( FArray3D_int::IR(), A.I1() );
	EXPECT_EQ( FArray3D_int::IR(), A.I2() );
	EXPECT_EQ( FArray3D_int::IR(), A.I3() );
	EXPECT_TRUE( A.dimensions_initialized() );
	EXPECT_FALSE( A.initializer_active() );
}

TEST( FArray3Test, ConstructCopy )
{
	FArray3D_int A;
	FArray3D_int B( A );
...
TEST( FArray3Test, ConstructOtherData )
{
	FArray3D_double A( 2, 2, 2 );
...
TEST( FArray3Test, ConstructIndexes )
{
	FArray3D_int A( 3, 3, 3 );
	...
	EXPECT_EQ( 3, A.u2() );
	EXPECT_EQ( 3, A.u3() );
	EXPECT_EQ( FArray3D_int::IR( 1, 3 ), A.I1() );
	EXPECT_EQ( FArray3D_int::IR( 1, 3 ), A.I2() );
	EXPECT_EQ( FArray3D_int::IR( 1, 3 ), A.I3() );
	EXPECT_TRUE( A.dimensions_initialized() );
	EXPECT_FALSE( A.initializer_active() );
}

TEST( FArray3Test, Subscript )
{
	FArray3D_int A( 2, 2, 2, { 111, 211, 121, 221, 112, 212, 122, 222 } );
	EXPECT_EQ( 8u, A.size() );
...
TEST( FArray3Test, Predicates )
{
	...
	FArray3D_int A2( 2, 3, 2 ); // Uninitialized
	...
	FArray3D_int A4( 2, 2, 2, { 111, 211, 121, 221, 112, 212, 122, 222 } );
...
TEST( FArray3Test, PredicateComparisonsValues )
{
	FArray3D_int A1;
	...
	FArray3D_int A3( 2, 2, 2, { 111, 211, 121, 221, 112, 212, 122, 222 } );
