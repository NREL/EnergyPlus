#ifndef ObjexxFCL_FArray1S_Project_MArray_hh_INCLUDED
#define ObjexxFCL_FArray1S_Project_MArray_hh_INCLUDED

// FArray1S.Project.MArray: Project-Specific MArray Methods
//
...
template< typename > class FArray1D;
	...
	// Types
	template< typename M > using MA1Sc = MArray1< FArray1S const, M >;
	template< typename M > using MA1S  = MArray1< FArray1S, M >;
...
#endif // ObjexxFCL_FArray1SSS_Project_MArray_hh_INCLUDED
