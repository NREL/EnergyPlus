...
public: // Creation
	...
	inline
	FArray3P( FArray3D< T > const & a, IR const & I1, IR const & I2, IR const & I3 ) :
	 Super( a, ProxySentinel() ),
	 I1_( I1 ),
	 I2_( I2 ),
	 I3_( I3 ),
	...
	inline
	FArray3P( FArray3D< T > & a, IR const & I1, IR const & I2, IR const & I3 ) :
	 Super( a, ProxySentinel() ),
	 I1_( I1 ),
	 I2_( I2 ),
	 I3_( I3 ),
