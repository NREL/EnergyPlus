#ifndef ObjexxFCL_FArray5S_io_hh_INCLUDED
#define ObjexxFCL_FArray5S_io_hh_INCLUDED

// FArray5S Input/Output Functions
//
...
template< typename T >
std::istream &
operator >>( std::istream & stream, FArray5S< T > & a )
{
...
template< typename T >
std::ostream &
operator <<( std::ostream & stream, FArray5S< T > const & a )
{
...
// Read an FArray5S from a Binary File
template< typename T >
std::istream &
read_binary( std::istream & stream, FArray5S< T > & a )
{
...
// Write an FArray5S to a Binary File
template< typename T >
std::ostream &
write_binary( std::ostream & stream, FArray5S< T > const & a )
{
	std::size_t const n( a.size() );
...
// List-Directed Format: FArray5S
template< typename T >
inline
std::string
LD( FArray5S< T > const & a )
{
	std::string s;
	std::size_t const n( a.size() );
	if ( n > 0u ) {
...
#endif // ObjexxFCL_FArray5S_io_hh_INCLUDED
