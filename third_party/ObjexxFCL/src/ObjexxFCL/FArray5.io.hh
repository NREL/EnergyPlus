#ifndef ObjexxFCL_FArray5_io_hh_INCLUDED
#define ObjexxFCL_FArray5_io_hh_INCLUDED
...
template< typename T >
std::istream &
operator >>( std::istream & stream, FArray5< T > & a )
{
...
#endif // ObjexxFCL_FArray5_io_hh_INCLUDED
