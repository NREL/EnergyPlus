#ifndef ObjexxFCL_FArray1_Project_MArray_hh_INCLUDED
#define ObjexxFCL_FArray1_Project_MArray_hh_INCLUDED

// FArray1.Project.MArray: Project-Specific MArray Methods
//
...
//  These are convenience methods to provide near-Fortran syntax for MArray usage
	...
	// Types
	template< typename M > using MA1c = MArray1< FArray1 const, M >;
	template< typename M > using MA1  = MArray1< FArray1, M >;
	...
	inline MA1< FArray1D< double > > InOutProjSLFracMult() { return ma( &T::InOutProjSLFracMult ); }
	inline MA1c< FArray1D< double > > mnth() const { return ma( &T::mnth ); }
	inline MA1< FArray1D< double > > mnth() { return ma( &T::mnth ); }
	inline MA1c< FArray1D< double > > OutProjSLFracMult() const { return ma( &T::OutProjSLFracMult ); }
	inline MA1< FArray1D< double > > OutProjSLFracMult() { return ma( &T::OutProjSLFracMult ); }
	inline MA1c< FArray1D< double > > RatedCOP() const { return ma( &T::RatedCOP ); }
	inline MA1< FArray1D< double > > RatedCOP() { return ma( &T::RatedCOP ); }
	inline MA1c< FArray1D< double > > RatedTotCap() const { return ma( &T::RatedTotCap ); }
	inline MA1< FArray1D< double > > RatedTotCap() { return ma( &T::RatedTotCap ); }
	inline MA1c< FArray1D< double > > ThetaFace() const { return ma( &T::ThetaFace ); }
	inline MA1< FArray1D< double > > ThetaFace() { return ma( &T::ThetaFace ); }

#endif // ObjexxFCL_FArray1_Project_MArray_hh_INCLUDED
