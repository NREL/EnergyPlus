...
#  this library also depends on itself, so we may need to change @rpath/libpythonwrapper to @executable_path/libpythonwrapper
# Python, the actual python library
#  this is the main python dynamic library that we distribute with e+
#  it depends on itself, so we need to convert /some/path/to/Python.framework/Versions/3.7/Python to @executable_path/Python
...
execute_process(COMMAND "install_name_tool" -change "${RESOLVED_PYTHON_LIB}" "@executable_path/${PYTHON_LIB_FILENAME}" "${PYTHON_WRAPPER_PATH}")
