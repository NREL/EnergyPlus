...
function( install_remote TYPE SOURCE DESTINATION )
  ...
  install(CODE "
  file(DOWNLOAD ${SOURCE} \"${OUTPUT_DIR}/${FILENAME}\" STATUS status_var TIMEOUT 30 INACTIVITY_TIMEOUT 30)
  ...
  if( NOT (status EQUAL 0) )
    ...
    file(DOWNLOAD ${SOURCE} \"${OUTPUT_DIR}/${FILENAME}\" STATUS status_var LOG log_var TIMEOUT 60 INACTIVITY_TIMEOUT 60)
    list(GET status_var 0 status)
    list(GET status_var 1 status_msg)
    if( NOT (status EQUAL 0) )
