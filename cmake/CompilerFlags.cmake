...
if (WIN32 AND NOT UNIX)  # UNIX clause required to filter out cygwin installations
    ...
    # C/C++ -> Language -> Disable Language Extensions use drop-down to choose Yes (/Za)
    ...
    if (MSVC)    
        ...
        if (CMAKE_BUILD_TYPE_B MATCHES RELEASE)
            SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -nologo -Za -EHsc -GR -wd4244 -wd4258 -wd4355 -wd4996 -DVC_EXTRALEAN -DWIN32_LEAN_AND_MEAN -DNOMINMAX -D_CRT_SECURE_NO_DEPRECATE -D_SCL_SECURE_NO_DEPRECATE -D_CRT_SECURE_CPP_OVERLOAD_STANDARD_NAMES -TP -O2 -DNDEBUG")
        ...
        if (CMAKE_BUILD_TYPE_B MATCHES DEBUG)
            ...
            SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -nologo -Za -EHsc -GR -wd4244 -wd4258 -wd4355 -wd4996 -DVC_EXTRALEAN -DWIN32_LEAN_AND_MEAN -DNOMINMAX -D_CRT_SECURE_NO_DEPRECATE -D_SCL_SECURE_NO_DEPRECATE -D_CRT_SECURE_CPP_OVERLOAD_STANDARD_NAMES -TP -Z7 -Od -Ob0 -RTCsu")
            SET(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -nologo -F2097152")  # was LDFLAGS
            SET(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -link -NODEFAULTLIB:libcd")  # was LINKFLAGS
        endif ()
    endif ()
