...
IF ( MSVC AND NOT ( "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel" ) ) # Visual C++ (VS 2013)
    ...
    # MAKE SURE WE NEVER DO /Ob2 UNLESS WE WANT A 3 HOUR BUILD TIME
    STRING (REGEX REPLACE "/Ob2" "/Ob1" CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
    STRING (REGEX REPLACE "/Ob2" "/Ob1" CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE}")
    STRING (REGEX REPLACE "/Ob2" "/Ob1" CMAKE_C_FLAGS "${CMAKE_C_FLAGS}")
