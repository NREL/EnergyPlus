...
It requires that this be set: :cmake:variable:`CPACK_CODESIGNING_DEVELOPER_ID_APPLICATION`
...
if(APPLE AND CPACK_GENERATOR STREQUAL "IFW")
  ...
  message("CPACK_CODESIGNING_DEVELOPER_ID_APPLICATION=${CPACK_CODESIGNING_DEVELOPER_ID_APPLICATION}")
  ...
  if(NOT CPACK_CODESIGNING_DEVELOPER_ID_APPLICATION)
    message(FATAL_ERROR "CPACK_CODESIGNING_DEVELOPER_ID_APPLICATION is required, this should not have happened")
  endif()
