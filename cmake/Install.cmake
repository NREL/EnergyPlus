...
if( WIN32 )
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/Windows/EP-Launch.exe" DESTINATION "./")
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/CSVproc.exe" DESTINATION "PostProcess/")
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/src/Basement/GrndTempCalc/RunBasement.bat" DESTINATION "PreProcess/GrndTempCalc/")
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/WeatherConverter/Cal%20Climate%20Zone%20Lat%20Long%20data.csv" DESTINATION "PreProcess/WeatherConverter/" DESTINATION "Cal Climate Zone Lat Long data.csv")
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/Appearance%20Pak.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/" DESTINATION "Appearance Pak.dll")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHInterfaces5001.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHObjectArray5001.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHObjectCollection5001.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHTreeView4301.DLL" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/MBSChartDirector5Plugin16042.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EPDraw/Run-Win/EPDrawGUI%20Libs/Appearance%20Pak.dll" DESTINATION "PreProcess/EPDraw/EPDrawGUI Libs/" DESTINATION "Appearance Pak.dll")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EPDraw/Run-Win/EPDrawGUI%20Libs/Shell.dll" DESTINATION "PreProcess/EPDraw/EPDrawGUI Libs/")
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/Appearance%20Pak.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "Appearance Pak.dll")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/RBGUIFramework.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "RBGUIFramework.dll")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/msvcp120.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "msvcp120.dll")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/msvcr120.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "msvcr120.dll")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/Shell.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  ...
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/ComDlg32.OCX" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/Dforrt.dll" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/Graph32.ocx" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/Gsw32.exe" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/Gswdll32.dll" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/MSCOMCTL.OCX" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/Msflxgrd.ocx" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/MSINET.OCX" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/Msvcrtd.dll" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${CMAKE_SOURCE_DIR}/bin/System/System/Vsflex7L.ocx" DESTINATION "./temp/")
endif()
...
if( UNIX AND NOT APPLE )
  ...
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHInterfaces5001.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHObjectArray5001.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHObjectCollection5001.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHTreeView4301.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/libMBSChartDirector5Plugin16042.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/libRBAppearancePak.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")

  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/libRBAppearancePak.so" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/libRBShell.so" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/RBGUIFramework.so" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(FILES "${CMAKE_SOURCE_DIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/libc++.so.1" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
