...
if( WIN32 )
  ...
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/EP-Launch.exe" DESTINATION "./")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/Epl-run.bat" DESTINATION "./")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/RunDirMulti.bat" DESTINATION "./")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/RunEP.ico" DESTINATION "./")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/RunEPlus.bat" DESTINATION "./")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/RunReadESO.bat" DESTINATION "./")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/Runep.pif" DESTINATION "./")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PostProcess/AppGPostProcess/appgpostprocess.exe" DESTINATION "PostProcess/AppGPostProcess/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PostProcess/CSVproc.exe" DESTINATION "PostProcess/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PostProcess/RunReadESO.bat" DESTINATION "PostProcess/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/CoeffConv/CoeffCheck.exe" DESTINATION "PreProcess/CoeffConv/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/CoeffConv/CoeffCheckExample.cci" DESTINATION "PreProcess/CoeffConv/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/CoeffConv/CoeffConv.exe" DESTINATION "PreProcess/CoeffConv/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/CoeffConv/CoeffConvExample.coi" DESTINATION "PreProcess/CoeffConv/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/CoeffConv/EPL-Check.BAT" DESTINATION "PreProcess/CoeffConv/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/CoeffConv/EPL-Conv.BAT" DESTINATION "PreProcess/CoeffConv/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/CoeffConv/ReadMe.txt" DESTINATION "PreProcess/CoeffConv/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/GrndTempCalc/RunBasement.bat" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/GrndTempCalc/RunSlab.bat" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/HVACCurveFitTool/CurveFitTool.xlsm" DESTINATION "PreProcess/HVACCurveFitTool/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/IDFEditor/IDFEditor.exe" DESTINATION "PreProcess/IDFEditor/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/ParametricPreProcessor/RunParam.bat" DESTINATION "PreProcess/ParametricPreProcessor/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/ViewFactorCalculation/readme.txt" DESTINATION "PreProcess/ViewFactorCalculation/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/ViewFactorCalculation/View3D.exe" DESTINATION "PreProcess/ViewFactorCalculation/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/ViewFactorCalculation/View3D32.pdf" DESTINATION "PreProcess/ViewFactorCalculation/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/ViewFactorCalculation/ViewFactorInterface.xls" DESTINATION "PreProcess/ViewFactorCalculation/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/Abbreviations.csv" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/ASHRAE_2013_Monthly_DesignConditions.csv" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/ASHRAE_2013_OtherMonthly_DesignConditions.csv" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/ASHRAE_2013_Yearly_DesignConditions.csv" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/Cal%20Climate%20Zone%20Lat%20Long%20data.csv" DESTINATION "PreProcess/WeatherConverter/" DESTINATION "Cal Climate Zone Lat Long data.csv")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/CountryCodes.txt" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/EPlusWth.dll" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/libifcoremd.dll" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/libifportmd.dll" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/libmmd.dll" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/svml_dispmd.dll" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/TimeZoneCodes.txt" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/WBANLocations.csv" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/Windows/PreProcess/WeatherConverter/Weather.exe" DESTINATION "PreProcess/WeatherConverter/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/Appearance%20Pak.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/" DESTINATION "Appearance Pak.dll")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHInterfaces5001.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHObjectArray5001.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHObjectCollection5001.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/EHTreeView4301.DLL" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Win/EP-Compare%20Libs/MBSChartDirector5Plugin16042.dll" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Win/EP-Compare.exe" DESTINATION "PostProcess/EP-Compare/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/GraphHints.csv" DESTINATION "PostProcess/EP-Compare/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/EPDrawGUI%20Libs/Appearance%20Pak.dll" DESTINATION "PreProcess/EPDraw/EPDrawGUI Libs/" DESTINATION "Appearance Pak.dll")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/EPDrawGUI%20Libs/Shell.dll" DESTINATION "PreProcess/EPDraw/EPDrawGUI Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/EPDrawGUI.exe" DESTINATION "PreProcess/EPDraw/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/EPlusDrw.dll" DESTINATION "PreProcess/EPDraw/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/libifcoremd.dll" DESTINATION "PreProcess/EPDraw/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/libifportmd.dll" DESTINATION "PreProcess/EPDraw/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/libmmd.dll" DESTINATION "PreProcess/EPDraw/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EPDraw/Run-Win/svml_dispmd.dll" DESTINATION "PreProcess/EPDraw/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/basementexample.audit" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/basementexample.csv" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/BasementExample.idf" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/basementexample.out" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/basementexample_out.idf" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/slabexample.ger" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/slabexample.gtp" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/GrndTempCalc/SlabExample.idf" DESTINATION "PreProcess/GrndTempCalc/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/Appearance%20Pak.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "Appearance Pak.dll")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/RBGUIFramework.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "RBGUIFramework.dll")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/msvcp120.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "msvcp120.dll")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/msvcr120.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/" DESTINATION "msvcr120.dll")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater%20Libs/Shell.dll" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Win/IDFVersionUpdater.exe" DESTINATION "PreProcess/IDFVersionUpdater/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/EPMacro/Windows/EPMacro.exe" DESTINATION "./")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/ComDlg32.OCX" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/Dforrt.dll" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/Graph32.ocx" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/Gsw32.exe" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/Gswdll32.dll" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/MSCOMCTL.OCX" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/Msflxgrd.ocx" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/MSINET.OCX" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/Msvcrtd.dll" DESTINATION "./temp/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/Windows/System/Vsflex7L.ocx" DESTINATION "./temp/")
endif()
...
if( UNIX AND NOT APPLE )
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Linux/EP-Compare" DESTINATION "PostProcess/EP-Compare/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHInterfaces5001.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHObjectArray5001.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHObjectCollection5001.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/EHTreeView4301.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/libMBSChartDirector5Plugin16042.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/EP-Compare/Run-Linux/EP-Compare%20Libs/libRBAppearancePak.so" DESTINATION "PostProcess/EP-Compare/EP-Compare Libs/")

  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/libRBAppearancePak.so" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/libRBShell.so" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/RBGUIFramework.so" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(FILES "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater%20Libs/libc++.so.1" DESTINATION "PreProcess/IDFVersionUpdater/IDFVersionUpdater Libs/")
  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/IDFVersionUpdater/Run-Linux/IDFVersionUpdater" DESTINATION "PreProcess/IDFVersionUpdater/")

  INSTALL(PROGRAMS "${BUILDSUPPORTDIR}/bin/EPMacro/Linux/EPMacro" DESTINATION "./")
