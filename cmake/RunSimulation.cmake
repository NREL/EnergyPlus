...
if (${IDF_NAME} MATCHES "5ZoneTDV")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy_directory "${SOURCE_DIR}/datasets/TDV" "${BINARY_DIR}/${TEST_FILE_FOLDER}/datasets/TDV")
endif()
if (${IDF_NAME} MATCHES "HybridModel_4Zone_Solve_Infiltration_free_floating")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${SOURCE_DIR}/${TEST_FILE_FOLDER}/HybridModel_Measurements_no_HVAC.csv" "${OUTPUT_DIR_PATH}/HybridModel_Measurements_no_HVAC.csv")
endif()
if (${IDF_NAME} MATCHES "HybridModel_4Zone_Solve_PeopleCount_with_HVAC")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${SOURCE_DIR}/${TEST_FILE_FOLDER}/HybridModel_Measurements_with_HVAC.csv" "${OUTPUT_DIR_PATH}/HybridModel_Measurements_with_HVAC.csv")
endif()
if (${IDF_NAME} MATCHES "HybridZoneModel")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${SOURCE_DIR}/${TEST_FILE_FOLDER}/HybridZoneModel_TemperatureData.csv" "${OUTPUT_DIR_PATH}/HybridZoneModel_TemperatureData.csv")
endif()
if (${IDF_NAME} MATCHES "SolarShadingTest_ExternalFraction")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${SOURCE_DIR}/${TEST_FILE_FOLDER}/SolarShadingTest_Shading_Data.csv" "${OUTPUT_DIR_PATH}/SolarShadingTest_Shading_Data.csv")
endif()
if (${IDF_NAME} MATCHES "SolarShadingTest_ImportedShading")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${SOURCE_DIR}/${TEST_FILE_FOLDER}/SolarShadingTest_Shading_Data.csv" "${OUTPUT_DIR_PATH}/SolarShadingTest_Shading_Data.csv")
endif()
if (${IDF_NAME} MATCHES "SurfacePropTest_SurfLWR")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${SOURCE_DIR}/${TEST_FILE_FOLDER}/LocalEnvData.csv" "${OUTPUT_DIR_PATH}/LocalEnvData.csv")
endif()
if (${IDF_NAME} MATCHES "SurfaceZonePropTest_LocalEnv")
  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${SOURCE_DIR}/${TEST_FILE_FOLDER}/LocalEnvData.csv" "${OUTPUT_DIR_PATH}/LocalEnvData.csv")
endif()
