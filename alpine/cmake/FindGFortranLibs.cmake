#https://github.com/Argonne-National-Laboratory/PIPS/blob/master/LICENSE
...
if(CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
  ...
  if(NOT GFORTRAN_LIB_DIR_STR)
    ...
    set(GCC_LIBRARIES_DIR "${GFORTRAN_LIBRARIES_DIR}")
  else()
    ...
    string(CONCAT GCC_LIBRARIES_DIR "${GFORTRAN_LIBRARIES_DIR}" "/gcc/" "${GFORTRAN_ARCH}" "/" "${GFORTRAN_VERSION_STRING}" )
  endif()
  ...
  find_library(LIBGFORTRAN_LIBRARIES NAMES libgfortran.a fortran libgfortran
    HINTS ${GFORTRAN_LIBRARIES_DIR})
  find_library(LIBQUADMATH_LIBRARIES NAMES libquadmath.a quadmath libquadmath
    HINTS ${GFORTRAN_LIBRARIES_DIR})
  find_library(LIBGOMP_LIBRARIES NAMES libgomp.a  gomp libgomp
    HINTS ${GFORTRAN_LIBRARIES_DIR})
  find_library(LIBGCC_LIBRARIES NAMES libgcc.a  gcc libgcc
    HINTS ${GCC_LIBRARIES_DIR})
